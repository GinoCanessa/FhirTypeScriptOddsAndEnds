...
export class FhirUnsignedInt extends fhir.FhirPrimitive {
  readonly __dataType:string = 'UnsignedInt';
  readonly __jsonType:string = 'number';
  // published regex: [0]|([1-9][0-9]*)
  static readonly __regex:RegExp = /^[0]|([1-9][0-9]*)$/
  /**
  ...
  */
  ...
  public override doModelValidation():fhir.OperationOutcome {
    ...
    if ((this.value) && (!FhirUnsignedInt.__regex.test(this.value.toString()))) {
      outcome.issue!.push(new fhir.OperationOutcomeIssue({ severity: IssueSeverityValueSetEnum.Error, code: IssueTypeValueSetEnum.InvalidContent,  diagnostics: "Invalid value in primitive type unsignedInt", }));
    }
    return outcome;
  }
  /**
