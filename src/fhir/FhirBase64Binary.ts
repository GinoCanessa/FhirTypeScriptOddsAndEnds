...
export class FhirBase64Binary extends fhir.FhirPrimitive {
  readonly __dataType:string = 'Base64Binary';
  readonly __jsonType:string = 'string';
  // published regex: (\s*([0-9a-zA-Z\+/=]){4}\s*)+
  static readonly __regex:RegExp = /^(\s*([0-9a-zA-Z\+/=]){4}\s*)+$/
  /**
  ...
  */
  ...
  public override doModelValidation():fhir.OperationOutcome {
    ...
    if ((this.value) && (!FhirBase64Binary.__regex.test(this.value))) {
      outcome.issue!.push(new fhir.OperationOutcomeIssue({ severity: IssueSeverityValueSetEnum.Error, code: IssueTypeValueSetEnum.InvalidContent,  diagnostics: "Invalid value in primitive type base64Binary", }));
    }
    return outcome;
  }
  /**
