...
export class FhirOid extends fhir.FhirPrimitive {
  readonly __dataType:string = 'Oid';
  readonly __jsonType:string = 'string';
  // published regex: urn:oid:[0-2](\.(0|[1-9][0-9]*))+
  static readonly __regex:RegExp = /^urn:oid:[0-2](\.(0|[1-9][0-9]*))+$/
  /**
  ...
  */
  ...
  public override doModelValidation():fhir.OperationOutcome {
    ...
    if ((this.value) && (!FhirOid.__regex.test(this.value))) {
      outcome.issue!.push(new fhir.OperationOutcomeIssue({ severity: IssueSeverityValueSetEnum.Error, code: IssueTypeValueSetEnum.InvalidContent,  diagnostics: "Invalid value in primitive type oid", }));
    }
    return outcome;
  }
  /**
