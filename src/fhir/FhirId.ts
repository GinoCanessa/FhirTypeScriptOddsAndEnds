...
export class FhirId extends fhir.FhirPrimitive {
  readonly __dataType:string = 'Id';
  readonly __jsonType:string = 'string';
  // published regex: [A-Za-z0-9\-\.]{1,64}
  static readonly __regex:RegExp = /^[A-Za-z0-9\-\.]{1,64}$/
  /**
  ...
  */
  ...
  public override doModelValidation():fhir.OperationOutcome {
    ...
    if ((this.value) && (!FhirId.__regex.test(this.value))) {
      outcome.issue!.push(new fhir.OperationOutcomeIssue({ severity: IssueSeverityValueSetEnum.Error, code: IssueTypeValueSetEnum.InvalidContent,  diagnostics: "Invalid value in primitive type id", }));
    }
    return outcome;
  }
  /**
