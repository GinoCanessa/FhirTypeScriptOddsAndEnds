...
import { RelatedpersonRelationshiptypeValueSetEnum } from '../valueSetEnums.js';
...
export class RelatedPersonCommunication extends fhir.BackboneElement {
  readonly __dataType:string = 'RelatedPersonCommunication';
  /**
   * The structure aa-BB with this exact casing is one the most widely used notations for locale. However not all systems actually code this but instead have it as free text. Hence CodeableConcept instead of code as the data type.
   */
...
export class RelatedPerson extends fhir.DomainResource {
  readonly __dataType:string = 'RelatedPerson';
  /**
   * Resource Type Name
   */
