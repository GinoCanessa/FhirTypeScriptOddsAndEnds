...
import { MedicationdispensePerformerFunctionValueSetEnum } from '../valueSetEnums.js';
...
import { V3ActSubstanceAdminSubstitutionCodeValueSetEnum } from '../valueSetEnums.js';
...
import { MedicationdispenseCategoryValueSetEnum } from '../valueSetEnums.js';
...
import { V3ActPharmacySupplyTypeValueSetEnum } from '../valueSetEnums.js';
...
export class MedicationDispensePerformer extends fhir.BackboneElement {
  readonly __dataType:string = 'MedicationDispensePerformer';
  /**
   * Distinguishes the type of performer in the dispense.  For example, date enterer, packager, final checker.
   */
...
export class MedicationDispenseSubstitution extends fhir.BackboneElement {
  readonly __dataType:string = 'MedicationDispenseSubstitution';
  /**
   * True if the dispenser dispensed a different drug or product from what was prescribed.
   */
  ...
  public override doModelValidation():fhir.OperationOutcome {
    ...
    if (this["wasSubstituted"]) { outcome.issue!.push(...this.wasSubstituted.doModelValidation().issue!); }
    if (this["type"]) { outcome.issue!.push(...this.type.doModelValidation().issue!); }
    if (this["reason"]) { this.reason.forEach((x) => { outcome.issue!.push(...x.doModelValidation().issue!); }) }
    if (this["responsibleParty"]) { this.responsibleParty.forEach((x) => { outcome.issue!.push(...x.doModelValidation().issue!); }) }
    return outcome;
  }
  /**
   * Function to strip invalid element values for serialization.
...
export class MedicationDispense extends fhir.DomainResource {
  readonly __dataType:string = 'MedicationDispense';
  /**
   * Resource Type Name
   */
  ...
  readonly __statusReasonIsChoice:true = true;
  /**
   * The category can be used to include where the medication is expected to be consumed or other types of dispenses.  Invariants can be used to bind to different value sets when profiling to bind.
   */
  ...
  public override doModelValidation():fhir.OperationOutcome {
    ...
    if (this["authorizingPrescription"]) { this.authorizingPrescription.forEach((x) => { outcome.issue!.push(...x.doModelValidation().issue!); }) }
    if (this["type"]) { outcome.issue!.push(...this.type.doModelValidation().issue!); }
    if (this["quantity"]) { outcome.issue!.push(...this.quantity.doModelValidation().issue!); }
    if (this["daysSupply"]) { outcome.issue!.push(...this.daysSupply.doModelValidation().issue!); }
    if (this["whenPrepared"]) { outcome.issue!.push(...this.whenPrepared.doModelValidation().issue!); }
    if (this["whenHandedOver"]) { outcome.issue!.push(...this.whenHandedOver.doModelValidation().issue!); }
