...
export class FhirInstant extends fhir.FhirPrimitive {
  readonly __dataType:string = 'Instant';
  ...
  */
  ...
  public override doModelValidation():fhir.OperationOutcome {
    ...
    if ((this.value) && (!FhirInstant.__regex.test(this.value))) {
      outcome.issue!.push(new fhir.OperationOutcomeIssue({ severity: IssueSeverityValueSetEnum.Error, code: IssueTypeValueSetEnum.InvalidContent,  diagnostics: "Invalid value in primitive type instant", }));
    }
    return outcome;
  }
  /**
