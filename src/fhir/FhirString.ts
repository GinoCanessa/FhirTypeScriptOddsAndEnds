...
export class FhirString extends fhir.FhirPrimitive {
  readonly __dataType:string = 'String';
  ...
  */
  ...
  public override doModelValidation():fhir.OperationOutcome {
    ...
    if ((this.value) && (!FhirString.__regex.test(this.value))) {
      outcome.issue!.push(new fhir.OperationOutcomeIssue({ severity: IssueSeverityValueSetEnum.Error, code: IssueTypeValueSetEnum.InvalidContent,  diagnostics: "Invalid value in primitive type string", }));
    }
    return outcome;
  }
  /**
