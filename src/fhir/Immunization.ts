...
import { ImmunizationFunctionValueSetEnum } from '../valueSetEnums.js';
...
import { ImmunizationTargetDiseaseValueSetEnum } from '../valueSetEnums.js';
...
import { ImmunizationStatusReasonValueSetEnum } from '../valueSetEnums.js';
...
import { ImmunizationSubpotentReasonValueSetEnum } from '../valueSetEnums.js';
...
import { ImmunizationProgramEligibilityValueSetEnum } from '../valueSetEnums.js';
...
import { ImmunizationFundingSourceValueSetEnum } from '../valueSetEnums.js';
...
export class ImmunizationPerformer extends fhir.BackboneElement {
  readonly __dataType:string = 'ImmunizationPerformer';
  /**
   * Describes the type of performance (e.g. ordering provider, administering provider, etc.).
   */
...
export class ImmunizationEducation extends fhir.BackboneElement {
  readonly __dataType:string = 'ImmunizationEducation';
  /**
   * Identifier of the material presented to the patient.
   */
...
export class ImmunizationReaction extends fhir.BackboneElement {
  readonly __dataType:string = 'ImmunizationReaction';
  /**
   * Date of reaction to the immunization.
   */
...
export class ImmunizationProtocolApplied extends fhir.BackboneElement {
  readonly __dataType:string = 'ImmunizationProtocolApplied';
  /**
   * One possible path to achieve presumed immunity against a disease - within the context of an authority.
   */
...
export class Immunization extends fhir.DomainResource {
  readonly __dataType:string = 'Immunization';
  /**
   * Resource Type Name
   */
