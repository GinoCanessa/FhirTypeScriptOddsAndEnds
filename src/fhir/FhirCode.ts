...
export class FhirCode extends fhir.FhirPrimitive {
  readonly __dataType:string = 'Code';
  readonly __jsonType:string = 'string';
  // published regex: [^\s]+(\s[^\s]+)*
  static readonly __regex:RegExp = /^[^\s]+(\s[^\s]+)*$/
  /**
  ...
  */
  ...
  public override doModelValidation():fhir.OperationOutcome {
    ...
    if ((this.value) && (!FhirCode.__regex.test(this.value))) {
      outcome.issue!.push(new fhir.OperationOutcomeIssue({ severity: IssueSeverityValueSetEnum.Error, code: IssueTypeValueSetEnum.InvalidContent,  diagnostics: "Invalid value in primitive type code", }));
    }
    return outcome;
  }
  /**
