...
export class EvidenceVariableCharacteristic extends fhirModels.BackboneElement implements fhirInterfaces.IEvidenceVariableCharacteristic {
  ...
  constructor(source:fhirInterfaces.IEvidenceVariableCharacteristic) {
    ...
    if (source["definitionReference"] !== undefined) {
      this.definitionReference = new fhirModels.Reference(source.definitionReference);
    }
    ...
    if (source["definitionTriggerDefinition"] !== undefined) {
      this.definitionTriggerDefinition = new fhirModels.TriggerDefinition(source.definitionTriggerDefinition);
    }
    ...
    if (source["_groupMeasure"] !== undefined) {
      this._groupMeasure = new fhirModels.Element(source._groupMeasure);
    }
    ...
    if (source["timeFromStart"] !== undefined) {
      this.timeFromStart = new fhirModels.Duration(source.timeFromStart);
    }
...
export class EvidenceVariable extends fhirModels.DomainResource implements fhirInterfaces.IEvidenceVariable {
  ...
  constructor(source:fhirInterfaces.IEvidenceVariable) {
    ...
    {
      this.characteristic = source.characteristic.map((x) => new fhirModels.EvidenceVariableCharacteristic(x));
    }
