...
export class BundleEntry<BundleContentType = fhirModels.FhirResource> extends fhirModels.BackboneElement implements fhirInterfaces.IBundleEntry<BundleContentType> {
  ...
  constructor(source:fhirInterfaces.IBundleEntry) {
    ...
    if (source["resource"] !== undefined) {
      this.resource = (fhirModels.FhirResourceFactory(source.resource) ?? undefined) as unknown as BundleContentType|undefined;
    }
...
export class Bundle<BundleContentType = fhirModels.FhirResource> extends fhirModels.Resource implements fhirInterfaces.IBundle<BundleContentType> {
  ...
  constructor(source:fhirInterfaces.IBundle) {
    ...
    if (source["entry"] !== undefined) {
      this.entry = source.entry.map((x) => new BundleEntry<BundleContentType>(x));
    }
