 ...
 * MedicationDispense Status Codes
 */
export type MedicationdispenseStatusReasonValueSetType = typeof MedicationdispenseStatusReasonValueSet;

/**
 * MedicationDispense Status Codes
 */
export enum MedicationdispenseStatusReasonValueSetEnum {
  /**
   * altchoice: This therapy has been ordered as a backup to a preferred therapy. This order will be released when and if the preferred therapy is unsuccessful.
   */
