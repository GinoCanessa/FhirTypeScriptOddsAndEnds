...
export const ChargeitemStatusValueSet = {
   ...
   */
  chargeitem_status_Aborted: Coding.FromStrict({
    code: "aborted",
    display: "Aborted",
   ...
   */
  chargeitem_status_Billable: Coding.FromStrict({
    code: "billable",
    display: "Billable",
    system: "http://hl7.org/fhir/chargeitem-status"
  }),
   ...
   */
  chargeitem_status_Billed: Coding.FromStrict({
    code: "billed",
    display: "Billed",
    system: "http://hl7.org/fhir/chargeitem-status"
  }),
   ...
   */
  chargeitem_status_EnteredInError: Coding.FromStrict({
   ...
   */
  chargeitem_status_NotBillable: Coding.FromStrict({
    code: "not-billable",
   ...
   */
  chargeitem_status_Planned: Coding.FromStrict({
    code: "planned",
    display: "Planned",
    system: "http://hl7.org/fhir/chargeitem-status"
  }),
   ...
   */
  chargeitem_status_Unknown: Coding.FromStrict({
    code: "unknown",
    display: "Unknown",
    system: "http://hl7.org/fhir/chargeitem-status"
  }),
