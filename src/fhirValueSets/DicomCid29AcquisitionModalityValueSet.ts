 ...
 * Transitive closure of CID 29 AcquisitionModality
 */
export type DicomCid29AcquisitionModalityValueSetType = typeof DicomCid29AcquisitionModalityValueSet;

/**
 * Transitive closure of CID 29 AcquisitionModality
 */
export enum DicomCid29AcquisitionModalityValueSetEnum {
  /**
   * AR: Autorefraction device
   */
  Autorefraction = "AR",
