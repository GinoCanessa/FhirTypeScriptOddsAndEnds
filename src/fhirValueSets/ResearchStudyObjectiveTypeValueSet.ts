...
export const ResearchStudyObjectiveTypeValueSet = {
   ...
   */
  research_study_objective_type_Exploratory: new Coding({
    code: "exploratory",
    display: "Exploratory",
   ...
   */
  research_study_objective_type_Primary: new Coding({
    code: "primary",
    display: "Primary",
    system: "http://terminology.hl7.org/CodeSystem/research-study-objective-type"
  }),
   ...
   */
  research_study_objective_type_Secondary: new Coding({
    code: "secondary",
    display: "Secondary",
    system: "http://terminology.hl7.org/CodeSystem/research-study-objective-type"
  }),
