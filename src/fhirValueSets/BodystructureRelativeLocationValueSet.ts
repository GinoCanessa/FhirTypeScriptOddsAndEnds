 ...
 * SNOMED-CT concepts modifying the anatomic location
 */
export type BodystructureRelativeLocationValueSetType = typeof BodystructureRelativeLocationValueSet;

/**
 * SNOMED-CT concepts modifying the anatomic location
 */
export enum BodystructureRelativeLocationValueSetEnum {
  /**
   * Code: 255551008
   */
  Posterior = "255551008",
