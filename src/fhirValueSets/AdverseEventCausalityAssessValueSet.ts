...
export const AdverseEventCausalityAssessValueSet = {
   ...
   */
  adverse_event_causality_assess_Certain: new Coding({
    code: "Certain",
    display: "Certain",
   ...
   */
  adverse_event_causality_assess_ConditionalClassified: new Coding({
   ...
   */
  adverse_event_causality_assess_Possible: new Coding({
    code: "Possible",
    display: "Possible",
    system: "http://terminology.hl7.org/CodeSystem/adverse-event-causality-assess"
  }),
   ...
   */
  adverse_event_causality_assess_ProbablyLikely: new Coding({
   ...
   */
  adverse_event_causality_assess_UnassessableUnclassifiable: new Coding({
   ...
   */
  adverse_event_causality_assess_Unlikely: new Coding({
    code: "Unlikely",
    display: "Unlikely",
    system: "http://terminology.hl7.org/CodeSystem/adverse-event-causality-assess"
  }),
