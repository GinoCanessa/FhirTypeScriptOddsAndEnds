...
export const CodesystemContentModeValueSet = {
   ...
   */
  codesystem_content_mode_Complete: Coding.FromStrict({
    code: "complete",
    display: "Complete",
   ...
   */
  codesystem_content_mode_Example: Coding.FromStrict({
    code: "example",
    display: "Example",
    system: "http://hl7.org/fhir/codesystem-content-mode"
  }),
   ...
   */
  codesystem_content_mode_Fragment: Coding.FromStrict({
    code: "fragment",
    display: "Fragment",
    system: "http://hl7.org/fhir/codesystem-content-mode"
  }),
   ...
   */
  codesystem_content_mode_NotPresent: Coding.FromStrict({
    code: "not-present",
    display: "Not Present",
    system: "http://hl7.org/fhir/codesystem-content-mode"
  }),
   ...
   */
  codesystem_content_mode_Supplement: Coding.FromStrict({
    code: "supplement",
    display: "Supplement",
    system: "http://hl7.org/fhir/codesystem-content-mode"
  }),
