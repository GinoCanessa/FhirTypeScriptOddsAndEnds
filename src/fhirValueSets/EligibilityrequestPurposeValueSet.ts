...
export const EligibilityrequestPurposeValueSet = {
   ...
   */
  eligibilityrequest_purpose_CoverageAuthRequirements: Coding.FromStrict({
   ...
   */
  eligibilityrequest_purpose_CoverageBenefits: Coding.FromStrict({
    code: "benefits",
   ...
   */
  eligibilityrequest_purpose_CoverageDiscovery: Coding.FromStrict({
    code: "discovery",
   ...
   */
  eligibilityrequest_purpose_CoverageValidation: Coding.FromStrict({
    code: "validation",
