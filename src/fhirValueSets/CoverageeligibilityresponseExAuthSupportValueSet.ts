 ...
 * This value set includes CoverageEligibilityResponse Auth Support codes.
 */
export type CoverageeligibilityresponseExAuthSupportValueSetType = typeof CoverageeligibilityresponseExAuthSupportValueSet;

/**
 * This value set includes CoverageEligibilityResponse Auth Support codes.
 */
export enum CoverageeligibilityresponseExAuthSupportValueSetEnum {
  /**
   * accidentreport: A formal accident report as would be filed with police or a simlar official body.
   */
