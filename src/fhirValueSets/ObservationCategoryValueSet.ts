...
export const ObservationCategoryValueSet = {
   ...
   */
  observation_category_Activity: Coding.FromStrict({
    code: "activity",
    display: "Activity",
   ...
   */
  observation_category_Exam: Coding.FromStrict({
    code: "exam",
    display: "Exam",
    system: "http://terminology.hl7.org/CodeSystem/observation-category"
  }),
   ...
   */
  observation_category_Imaging: Coding.FromStrict({
    code: "imaging",
    display: "Imaging",
    system: "http://terminology.hl7.org/CodeSystem/observation-category"
  }),
   ...
   */
  observation_category_Laboratory: Coding.FromStrict({
    code: "laboratory",
    display: "Laboratory",
    system: "http://terminology.hl7.org/CodeSystem/observation-category"
  }),
   ...
   */
  observation_category_Procedure: Coding.FromStrict({
    code: "procedure",
    display: "Procedure",
    system: "http://terminology.hl7.org/CodeSystem/observation-category"
  }),
   ...
   */
  observation_category_SocialHistory: Coding.FromStrict({
    code: "social-history",
   ...
   */
  observation_category_Survey: Coding.FromStrict({
    code: "survey",
    display: "Survey",
    system: "http://terminology.hl7.org/CodeSystem/observation-category"
  }),
   ...
   */
  observation_category_Therapy: Coding.FromStrict({
    code: "therapy",
    display: "Therapy",
    system: "http://terminology.hl7.org/CodeSystem/observation-category"
  }),
   ...
   */
  observation_category_VitalSigns: Coding.FromStrict({
    code: "vital-signs",
    display: "Vital Signs",
    system: "http://terminology.hl7.org/CodeSystem/observation-category"
  }),
