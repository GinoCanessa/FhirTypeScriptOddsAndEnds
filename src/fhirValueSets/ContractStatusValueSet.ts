...
export const ContractStatusValueSet = {
   ...
   */
  contract_status_Amended: Coding.FromStrict({
    code: "amended",
    display: "Amended",
   ...
   */
  contract_status_Appended: Coding.FromStrict({
    code: "appended",
    display: "Appended",
    system: "http://hl7.org/fhir/contract-status"
  }),
   ...
   */
  contract_status_Cancelled: Coding.FromStrict({
    code: "cancelled",
    display: "Cancelled",
    system: "http://hl7.org/fhir/contract-status"
  }),
   ...
   */
  contract_status_Disputed: Coding.FromStrict({
    code: "disputed",
    display: "Disputed",
    system: "http://hl7.org/fhir/contract-status"
  }),
   ...
   */
  contract_status_EnteredInError: Coding.FromStrict({
   ...
   */
  contract_status_Executable: Coding.FromStrict({
    code: "executable",
    display: "Executable",
    system: "http://hl7.org/fhir/contract-status"
  }),
   ...
   */
  contract_status_Executed: Coding.FromStrict({
    code: "executed",
    display: "Executed",
    system: "http://hl7.org/fhir/contract-status"
  }),
   ...
   */
  contract_status_Negotiable: Coding.FromStrict({
    code: "negotiable",
    display: "Negotiable",
    system: "http://hl7.org/fhir/contract-status"
  }),
   ...
   */
  contract_status_Offered: Coding.FromStrict({
    code: "offered",
    display: "Offered",
    system: "http://hl7.org/fhir/contract-status"
  }),
   ...
   */
  contract_status_Policy: Coding.FromStrict({
    code: "policy",
    display: "Policy",
    system: "http://hl7.org/fhir/contract-status"
  }),
   ...
   */
  contract_status_Rejected: Coding.FromStrict({
    code: "rejected",
    display: "Rejected",
    system: "http://hl7.org/fhir/contract-status"
  }),
   ...
   */
  contract_status_Renewed: Coding.FromStrict({
    code: "renewed",
    display: "Renewed",
    system: "http://hl7.org/fhir/contract-status"
  }),
   ...
   */
  contract_status_Resolved: Coding.FromStrict({
    code: "resolved",
    display: "Resolved",
    system: "http://hl7.org/fhir/contract-status"
  }),
   ...
   */
  contract_status_Revoked: Coding.FromStrict({
    code: "revoked",
    display: "Revoked",
    system: "http://hl7.org/fhir/contract-status"
  }),
   ...
   */
  contract_status_Terminated: Coding.FromStrict({
    code: "terminated",
    display: "Terminated",
    system: "http://hl7.org/fhir/contract-status"
  }),
