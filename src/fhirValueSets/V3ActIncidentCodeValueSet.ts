 ...
 */
export const V3ActIncidentCodeValueSet = {
  /**
 ...
 *  Set of codes indicating the type of incident or accident.
 */
export type V3ActIncidentCodeValueSetType = typeof V3ActIncidentCodeValueSet;

/**
 *  Set of codes indicating the type of incident or accident.
 */
export enum V3ActIncidentCodeValueSetEnum {
  /**
   * MVA: Incident or accident as the result of a motor vehicle accident
   */
