...
export const HistoryAbsentReasonValueSet = {
   ...
   */
  history_absent_reason_Deferred: new Coding({
    code: "deferred",
    display: "Deferred",
   ...
   */
  history_absent_reason_SubjectUnknown: new Coding({
   ...
   */
  history_absent_reason_UnableToObtain: new Coding({
   ...
   */
  history_absent_reason_InformationWithheld: new Coding({
    code: "withheld",
