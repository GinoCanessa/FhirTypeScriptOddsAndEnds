...
export const ListItemFlagValueSet = {
   ...
   */
  list_item_flag_Unchanged: new Coding({
    code: "01",
    display: "Unchanged",
   ...
   */
  list_item_flag_Changed: new Coding({
    code: "02",
    display: "Changed",
    system: "urn:oid:1.2.36.1.2001.1001.101.104.16592"
  }),
   ...
   */
  list_item_flag_Cancelled: new Coding({
    code: "03",
    display: "Cancelled",
    system: "urn:oid:1.2.36.1.2001.1001.101.104.16592"
  }),
   ...
   */
  list_item_flag_Prescribed: new Coding({
    code: "04",
    display: "Prescribed",
    system: "urn:oid:1.2.36.1.2001.1001.101.104.16592"
  }),
   ...
   */
  list_item_flag_Ceased: new Coding({
    code: "05",
    display: "Ceased",
    system: "urn:oid:1.2.36.1.2001.1001.101.104.16592"
  }),
   ...
   */
  list_item_flag_Suspended: new Coding({
    code: "06",
    display: "Suspended",
    system: "urn:oid:1.2.36.1.2001.1001.101.104.16592"
  }),
