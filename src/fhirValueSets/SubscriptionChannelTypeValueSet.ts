...
export const SubscriptionChannelTypeValueSet = {
   ...
   */
  subscription_channel_type_Email: new Coding({
    code: "email",
    display: "Email",
   ...
   */
  subscription_channel_type_Message: new Coding({
    code: "message",
    display: "Message",
    system: "http://hl7.org/fhir/subscription-channel-type"
  }),
   ...
   */
  subscription_channel_type_RestHook: new Coding({
    code: "rest-hook",
    display: "Rest Hook",
    system: "http://hl7.org/fhir/subscription-channel-type"
  }),
   ...
   */
  subscription_channel_type_SMS: new Coding({
    code: "sms",
    display: "SMS",
    system: "http://hl7.org/fhir/subscription-channel-type"
  }),
   ...
   */
  subscription_channel_type_Websocket: new Coding({
    code: "websocket",
    display: "Websocket",
    system: "http://hl7.org/fhir/subscription-channel-type"
  }),
