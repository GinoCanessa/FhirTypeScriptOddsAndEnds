 ...
 * MedicationKnowledge Package Type Codes
 */
export type MedicationknowledgePackageTypeValueSetType = typeof MedicationknowledgePackageTypeValueSet;

/**
 * MedicationKnowledge Package Type Codes
 */
export enum MedicationknowledgePackageTypeValueSetEnum {
  /**
   * Code: amp
   */
  Ampule = "amp",
