 ...
 * MedicationDispense Performer Function Codes
 */
export type MedicationdispensePerformerFunctionValueSetType = typeof MedicationdispensePerformerFunctionValueSet;

/**
 * MedicationDispense Performer Function Codes
 */
export enum MedicationdispensePerformerFunctionValueSetEnum {
  /**
   * checker: Performed initial quality assurance on the prepared medication
   */
  Checker = "checker",
