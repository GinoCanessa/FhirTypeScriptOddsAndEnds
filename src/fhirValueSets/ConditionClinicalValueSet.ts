...
export const ConditionClinicalValueSet = {
   ...
   */
  condition_clinical_Active: Coding.FromStrict({
    code: "active",
    display: "Active",
   ...
   */
  condition_clinical_Inactive: Coding.FromStrict({
    code: "inactive",
    display: "Inactive",
    system: "http://terminology.hl7.org/CodeSystem/condition-clinical"
  }),
   ...
   */
  condition_clinical_Recurrence: Coding.FromStrict({
    code: "recurrence",
    display: "Recurrence",
    system: "http://terminology.hl7.org/CodeSystem/condition-clinical"
  }),
   ...
   */
  condition_clinical_Relapse: Coding.FromStrict({
    code: "relapse",
    display: "Relapse",
    system: "http://terminology.hl7.org/CodeSystem/condition-clinical"
  }),
   ...
   */
  condition_clinical_Remission: Coding.FromStrict({
    code: "remission",
    display: "Remission",
    system: "http://terminology.hl7.org/CodeSystem/condition-clinical"
  }),
   ...
   */
  condition_clinical_Resolved: Coding.FromStrict({
    code: "resolved",
    display: "Resolved",
    system: "http://terminology.hl7.org/CodeSystem/condition-clinical"
  }),
