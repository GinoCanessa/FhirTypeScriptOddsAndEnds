...
export class CapabilityStatementSoftware extends fhirModels.BackboneElement implements fhirInterfaces.ICapabilityStatementSoftware {
  ...
  constructor(source:Partial<fhirInterfaces.ICapabilityStatementSoftware>) {
    ...
    if (source["_releaseDate"] !== undefined) { this._releaseDate = new fhirModels.Element(source._releaseDate); }
...
export class CapabilityStatementRestSecurity extends fhirModels.BackboneElement implements fhirInterfaces.ICapabilityStatementRestSecurity {
  ...
  constructor(source:Partial<fhirInterfaces.ICapabilityStatementRestSecurity>) {
    ...
    if (source["_cors"] !== undefined) { this._cors = new fhirModels.Element(source._cors); }
    if (source["description"] !== undefined) { this.description = source.description; }
    if (source["_description"] !== undefined) { this._description = new fhirModels.Element(source._description); }
    if (source["service"] !== undefined) { this.service = source.service.map((x) => new fhirModels.CodeableConcept(x)); }
  }
  /**
...
export class CapabilityStatementRestResource extends fhirModels.BackboneElement implements fhirInterfaces.ICapabilityStatementRestResource {
  ...
  constructor(source:Partial<fhirInterfaces.ICapabilityStatementRestResource>) {
    ...
    if (source["_conditionalCreate"] !== undefined) { this._conditionalCreate = new fhirModels.Element(source._conditionalCreate); }
    if (source["conditionalDelete"] !== undefined) { this.conditionalDelete = source.conditionalDelete; }
    if (source["_conditionalDelete"] !== undefined) { this._conditionalDelete = new fhirModels.Element(source._conditionalDelete); }
    if (source["conditionalRead"] !== undefined) { this.conditionalRead = source.conditionalRead; }
    if (source["_conditionalRead"] !== undefined) { this._conditionalRead = new fhirModels.Element(source._conditionalRead); }
    if (source["conditionalUpdate"] !== undefined) { this.conditionalUpdate = source.conditionalUpdate; }
    if (source["_conditionalUpdate"] !== undefined) { this._conditionalUpdate = new fhirModels.Element(source._conditionalUpdate); }
    if (source["documentation"] !== undefined) { this.documentation = source.documentation; }
    if (source["_documentation"] !== undefined) { this._documentation = new fhirModels.Element(source._documentation); }
    if (source["interaction"] !== undefined) { this.interaction = source.interaction.map((x) => new fhirModels.CapabilityStatementRestResourceInteraction(x)); }
    if (source["operation"] !== undefined) { this.operation = source.operation.map((x) => new fhirModels.CapabilityStatementRestResourceOperation(x)); }
    ...
    if (source["_readHistory"] !== undefined) { this._readHistory = new fhirModels.Element(source._readHistory); }
    if (source["referencePolicy"] !== undefined) { this.referencePolicy = source.referencePolicy.map((x) => (x)); }
    if (source["_referencePolicy"] !== undefined) { this._referencePolicy = source._referencePolicy.map((x) => new fhirModels.Element(x)); }
    if (source["searchInclude"] !== undefined) { this.searchInclude = source.searchInclude.map((x) => (x)); }
    if (source["_searchInclude"] !== undefined) { this._searchInclude = source._searchInclude.map((x) => new fhirModels.Element(x)); }
    if (source["searchParam"] !== undefined) { this.searchParam = source.searchParam.map((x) => new fhirModels.CapabilityStatementRestResourceSearchParam(x)); }
    if (source["searchRevInclude"] !== undefined) { this.searchRevInclude = source.searchRevInclude.map((x) => (x)); }
    if (source["_searchRevInclude"] !== undefined) { this._searchRevInclude = source._searchRevInclude.map((x) => new fhirModels.Element(x)); }
    if (source["supportedProfile"] !== undefined) { this.supportedProfile = source.supportedProfile.map((x) => (x)); }
    if (source["_supportedProfile"] !== undefined) { this._supportedProfile = source._supportedProfile.map((x) => new fhirModels.Element(x)); }
    if (source["type"] !== undefined) { this.type = source.type; }
    if (source["_type"] !== undefined) { this._type = new fhirModels.Element(source._type); }
    if (source["updateCreate"] !== undefined) { this.updateCreate = source.updateCreate; }
    if (source["_updateCreate"] !== undefined) { this._updateCreate = new fhirModels.Element(source._updateCreate); }
...
export class CapabilityStatementRest extends fhirModels.BackboneElement implements fhirInterfaces.ICapabilityStatementRest {
  ...
  constructor(source:Partial<fhirInterfaces.ICapabilityStatementRest>) {
    super(source);
    if (source["compartment"] !== undefined) { this.compartment = source.compartment.map((x) => (x)); }
    if (source["_compartment"] !== undefined) { this._compartment = source._compartment.map((x) => new fhirModels.Element(x)); }
    if (source["documentation"] !== undefined) { this.documentation = source.documentation; }
    if (source["_documentation"] !== undefined) { this._documentation = new fhirModels.Element(source._documentation); }
    if (source["interaction"] !== undefined) { this.interaction = source.interaction.map((x) => new fhirModels.CapabilityStatementRestInteraction(x)); }
    if (source["mode"] !== undefined) { this.mode = source.mode; }
    if (source["_mode"] !== undefined) { this._mode = new fhirModels.Element(source._mode); }
    if (source["operation"] !== undefined) { this.operation = source.operation.map((x) => new fhirModels.CapabilityStatementRestResourceOperation(x)); }
    if (source["resource"] !== undefined) { this.resource = source.resource.map((x) => new fhirModels.CapabilityStatementRestResource(x)); }
    if (source["searchParam"] !== undefined) { this.searchParam = source.searchParam.map((x) => new fhirModels.CapabilityStatementRestResourceSearchParam(x)); }
    if (source["security"] !== undefined) { this.security = new fhirModels.CapabilityStatementRestSecurity(source.security); }
  }
  /**
...
export class CapabilityStatementMessagingEndpoint extends fhirModels.BackboneElement implements fhirInterfaces.ICapabilityStatementMessagingEndpoint {
  ...
  constructor(source:Partial<fhirInterfaces.ICapabilityStatementMessagingEndpoint>) {
    ...
    if (source["protocol"] !== undefined) { this.protocol = new fhirModels.Coding(source.protocol); }
  }
  /**
...
export class CapabilityStatementMessaging extends fhirModels.BackboneElement implements fhirInterfaces.ICapabilityStatementMessaging {
  ...
  constructor(source:Partial<fhirInterfaces.ICapabilityStatementMessaging>) {
    ...
    if (source["documentation"] !== undefined) { this.documentation = source.documentation; }
    if (source["_documentation"] !== undefined) { this._documentation = new fhirModels.Element(source._documentation); }
    if (source["endpoint"] !== undefined) { this.endpoint = source.endpoint.map((x) => new fhirModels.CapabilityStatementMessagingEndpoint(x)); }
    if (source["reliableCache"] !== undefined) { this.reliableCache = source.reliableCache; }
    if (source["_reliableCache"] !== undefined) { this._reliableCache = new fhirModels.Element(source._reliableCache); }
    if (source["supportedMessage"] !== undefined) { this.supportedMessage = source.supportedMessage.map((x) => new fhirModels.CapabilityStatementMessagingSupportedMessage(x)); }
  }
  /**
...
export class CapabilityStatement extends fhirModels.DomainResource implements fhirInterfaces.ICapabilityStatement {
  ...
  constructor(source:Partial<fhirInterfaces.ICapabilityStatement>) {
    ...
    if (source["description"] !== undefined) { this.description = source.description; }
    if (source["_description"] !== undefined) { this._description = new fhirModels.Element(source._description); }
    if (source["document"] !== undefined) { this.document = source.document.map((x) => new fhirModels.CapabilityStatementDocument(x)); }
    ...
    if (source["format"] !== undefined) { this.format = source.format.map((x) => (x)); }
    if (source["_format"] !== undefined) { this._format = source._format.map((x) => new fhirModels.Element(x)); }
    if (source["implementation"] !== undefined) { this.implementation = new fhirModels.CapabilityStatementImplementation(source.implementation); }
    if (source["implementationGuide"] !== undefined) { this.implementationGuide = source.implementationGuide.map((x) => (x)); }
    if (source["_implementationGuide"] !== undefined) { this._implementationGuide = source._implementationGuide.map((x) => new fhirModels.Element(x)); }
    if (source["imports"] !== undefined) { this.imports = source.imports.map((x) => (x)); }
    if (source["_imports"] !== undefined) { this._imports = source._imports.map((x) => new fhirModels.Element(x)); }
    ...
    if (source["messaging"] !== undefined) { this.messaging = source.messaging.map((x) => new fhirModels.CapabilityStatementMessaging(x)); }
    if (source["name"] !== undefined) { this.name = source.name; }
    if (source["_name"] !== undefined) { this._name = new fhirModels.Element(source._name); }
    if (source["patchFormat"] !== undefined) { this.patchFormat = source.patchFormat.map((x) => (x)); }
    if (source["_patchFormat"] !== undefined) { this._patchFormat = source._patchFormat.map((x) => new fhirModels.Element(x)); }
    ...
    if (source["rest"] !== undefined) { this.rest = source.rest.map((x) => new fhirModels.CapabilityStatementRest(x)); }
    if (source["software"] !== undefined) { this.software = new fhirModels.CapabilityStatementSoftware(source.software); }
  ...
  override checkRequiredElements():string[] {
    ...
    if ((this["format"] === undefined) || (this["format"].length === 0)) { missingElements.push("format"); }
