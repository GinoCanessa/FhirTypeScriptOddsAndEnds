...
export class SpecimenDefinitionTypeTestedContainer extends fhirModels.BackboneElement implements fhirInterfaces.ISpecimenDefinitionTypeTestedContainer {
  ...
  constructor(source:Partial<fhirInterfaces.ISpecimenDefinitionTypeTestedContainer>) {
    super(source);
    if (source["additive"] !== undefined) { this.additive = source.additive.map((x) => new fhirModels.SpecimenDefinitionTypeTestedContainerAdditive(x)); }
    if (source["cap"] !== undefined) { this.cap = new fhirModels.CodeableConcept(source.cap); }
    ...
    if (source["minimumVolumeQuantity"] !== undefined) { this.minimumVolumeQuantity = new fhirModels.Quantity(source.minimumVolumeQuantity); }
    if (source["minimumVolumeString"] !== undefined) { this.minimumVolumeString = source.minimumVolumeString; }
    if (source["_minimumVolumeString"] !== undefined) { this._minimumVolumeString = new fhirModels.Element(source._minimumVolumeString); }
    if (source["preparation"] !== undefined) { this.preparation = source.preparation; }
    if (source["_preparation"] !== undefined) { this._preparation = new fhirModels.Element(source._preparation); }
...
export class SpecimenDefinitionTypeTestedHandling extends fhirModels.BackboneElement implements fhirInterfaces.ISpecimenDefinitionTypeTestedHandling {
  ...
  constructor(source:Partial<fhirInterfaces.ISpecimenDefinitionTypeTestedHandling>) {
    ...
    if (source["maxDuration"] !== undefined) { this.maxDuration = new fhirModels.Duration(source.maxDuration); }
    if (source["temperatureQualifier"] !== undefined) { this.temperatureQualifier = new fhirModels.CodeableConcept(source.temperatureQualifier); }
    if (source["temperatureRange"] !== undefined) { this.temperatureRange = new fhirModels.Range(source.temperatureRange); }
  }
  /**
...
export class SpecimenDefinitionTypeTested extends fhirModels.BackboneElement implements fhirInterfaces.ISpecimenDefinitionTypeTested {
  ...
  constructor(source:Partial<fhirInterfaces.ISpecimenDefinitionTypeTested>) {
    super(source);
    if (source["container"] !== undefined) { this.container = new fhirModels.SpecimenDefinitionTypeTestedContainer(source.container); }
    if (source["handling"] !== undefined) { this.handling = source.handling.map((x) => new fhirModels.SpecimenDefinitionTypeTestedHandling(x)); }
    if (source["isDerived"] !== undefined) { this.isDerived = source.isDerived; }
    if (source["_isDerived"] !== undefined) { this._isDerived = new fhirModels.Element(source._isDerived); }
    if (source["preference"] !== undefined) { this.preference = source.preference; }
    if (source["_preference"] !== undefined) { this._preference = new fhirModels.Element(source._preference); }
    if (source["rejectionCriterion"] !== undefined) { this.rejectionCriterion = source.rejectionCriterion.map((x) => new fhirModels.CodeableConcept(x)); }
    ...
    if (source["retentionTime"] !== undefined) { this.retentionTime = new fhirModels.Duration(source.retentionTime); }
    if (source["type"] !== undefined) { this.type = new fhirModels.CodeableConcept(source.type); }
  }
  /**
...
export class SpecimenDefinition extends fhirModels.DomainResource implements fhirInterfaces.ISpecimenDefinition {
  ...
  constructor(source:Partial<fhirInterfaces.ISpecimenDefinition>) {
    ...
    if (source["collection"] !== undefined) { this.collection = source.collection.map((x) => new fhirModels.CodeableConcept(x)); }
    if (source["identifier"] !== undefined) { this.identifier = new fhirModels.Identifier(source.identifier); }
    if (source["patientPreparation"] !== undefined) { this.patientPreparation = source.patientPreparation.map((x) => new fhirModels.CodeableConcept(x)); }
    if (source["timeAspect"] !== undefined) { this.timeAspect = source.timeAspect; }
    if (source["_timeAspect"] !== undefined) { this._timeAspect = new fhirModels.Element(source._timeAspect); }
    if (source["typeCollected"] !== undefined) { this.typeCollected = new fhirModels.CodeableConcept(source.typeCollected); }
    if (source["typeTested"] !== undefined) { this.typeTested = source.typeTested.map((x) => new fhirModels.SpecimenDefinitionTypeTested(x)); }
  }
  /**
