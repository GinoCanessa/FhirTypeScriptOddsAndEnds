...
export class FamilyMemberHistoryCondition extends fhirModels.BackboneElement implements fhirInterfaces.IFamilyMemberHistoryCondition {
  ...
  constructor(source:Partial<fhirInterfaces.IFamilyMemberHistoryCondition>) {
    ...
    if (source["_contributedToDeath"] !== undefined) { this._contributedToDeath = new fhirModels.Element(source._contributedToDeath); }
...
export class FamilyMemberHistory extends fhirModels.DomainResource implements fhirInterfaces.IFamilyMemberHistory {
  ...
  constructor(source:Partial<fhirInterfaces.IFamilyMemberHistory>) {
    ...
    if (source["ageAge"] !== undefined) { this.ageAge = new fhirModels.Age(source.ageAge); }
    ...
    if (source["_ageString"] !== undefined) { this._ageString = new fhirModels.Element(source._ageString); }
    if (source["bornPeriod"] !== undefined) { this.bornPeriod = new fhirModels.Period(source.bornPeriod); }
    if (source["bornDate"] !== undefined) { this.bornDate = source.bornDate; }
    if (source["_bornDate"] !== undefined) { this._bornDate = new fhirModels.Element(source._bornDate); }
    if (source["bornString"] !== undefined) { this.bornString = source.bornString; }
    if (source["_bornString"] !== undefined) { this._bornString = new fhirModels.Element(source._bornString); }
    if (source["condition"] !== undefined) { this.condition = source.condition.map((x) => new fhirModels.FamilyMemberHistoryCondition(x)); }
    ...
    if (source["deceasedAge"] !== undefined) { this.deceasedAge = new fhirModels.Age(source.deceasedAge); }
    if (source["deceasedRange"] !== undefined) { this.deceasedRange = new fhirModels.Range(source.deceasedRange); }
    if (source["deceasedDate"] !== undefined) { this.deceasedDate = source.deceasedDate; }
    if (source["_deceasedDate"] !== undefined) { this._deceasedDate = new fhirModels.Element(source._deceasedDate); }
    if (source["deceasedString"] !== undefined) { this.deceasedString = source.deceasedString; }
    if (source["_deceasedString"] !== undefined) { this._deceasedString = new fhirModels.Element(source._deceasedString); }
    if (source["estimatedAge"] !== undefined) { this.estimatedAge = source.estimatedAge; }
    if (source["_estimatedAge"] !== undefined) { this._estimatedAge = new fhirModels.Element(source._estimatedAge); }
    ...
    if (source["sex"] !== undefined) { this.sex = new fhirModels.CodeableConcept(source.sex); }
