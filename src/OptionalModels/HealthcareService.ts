...
export class HealthcareService extends fhirModels.DomainResource implements fhirInterfaces.IHealthcareService {
  ...
  constructor(source:Partial<fhirInterfaces.IHealthcareService>) {
    ...
    if (source["_appointmentRequired"] !== undefined) { this._appointmentRequired = new fhirModels.Element(source._appointmentRequired); }
    ...
    if (source["availableTime"] !== undefined) { this.availableTime = source.availableTime.map((x) => new fhirModels.HealthcareServiceAvailableTime(x)); }
    if (source["category"] !== undefined) { this.category = source.category.map((x) => new fhirModels.CodeableConcept(x)); }
    if (source["characteristic"] !== undefined) { this.characteristic = source.characteristic.map((x) => new fhirModels.CodeableConcept(x)); }
    if (source["comment"] !== undefined) { this.comment = source.comment; }
    if (source["_comment"] !== undefined) { this._comment = new fhirModels.Element(source._comment); }
    ...
    if (source["eligibility"] !== undefined) { this.eligibility = source.eligibility.map((x) => new fhirModels.HealthcareServiceEligibility(x)); }
    ...
    if (source["_extraDetails"] !== undefined) { this._extraDetails = new fhirModels.Element(source._extraDetails); }
    ...
    if (source["notAvailable"] !== undefined) { this.notAvailable = source.notAvailable.map((x) => new fhirModels.HealthcareServiceNotAvailable(x)); }
    if (source["photo"] !== undefined) { this.photo = new fhirModels.Attachment(source.photo); }
    if (source["program"] !== undefined) { this.program = source.program.map((x) => new fhirModels.CodeableConcept(x)); }
    if (source["providedBy"] !== undefined) { this.providedBy = new fhirModels.Reference(source.providedBy); }
    if (source["referralMethod"] !== undefined) { this.referralMethod = source.referralMethod.map((x) => new fhirModels.CodeableConcept(x)); }
    if (source["serviceProvisionCode"] !== undefined) { this.serviceProvisionCode = source.serviceProvisionCode.map((x) => new fhirModels.CodeableConcept(x)); }
