...
export class MedicationStatement extends fhirModels.DomainResource implements fhirInterfaces.IMedicationStatement {
  ...
  constructor(source:Partial<fhirInterfaces.IMedicationStatement>) {
    ...
    if (source["_dateAsserted"] !== undefined) { this._dateAsserted = new fhirModels.Element(source._dateAsserted); }
    ...
    if (source["informationSource"] !== undefined) { this.informationSource = new fhirModels.Reference(source.informationSource); }
