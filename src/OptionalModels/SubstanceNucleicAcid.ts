...
export class SubstanceNucleicAcidSubunitLinkage extends fhirModels.BackboneElement implements fhirInterfaces.ISubstanceNucleicAcidSubunitLinkage {
  ...
  constructor(source:Partial<fhirInterfaces.ISubstanceNucleicAcidSubunitLinkage>) {
    ...
    if (source["_connectivity"] !== undefined) { this._connectivity = new fhirModels.Element(source._connectivity); }
    ...
    if (source["_residueSite"] !== undefined) { this._residueSite = new fhirModels.Element(source._residueSite); }
  }
  /**
...
export class SubstanceNucleicAcidSubunit extends fhirModels.BackboneElement implements fhirInterfaces.ISubstanceNucleicAcidSubunit {
  ...
  constructor(source:Partial<fhirInterfaces.ISubstanceNucleicAcidSubunit>) {
    super(source);
    if (source["fivePrime"] !== undefined) { this.fivePrime = new fhirModels.CodeableConcept(source.fivePrime); }
    ...
    if (source["linkage"] !== undefined) { this.linkage = source.linkage.map((x) => new fhirModels.SubstanceNucleicAcidSubunitLinkage(x)); }
    ...
    if (source["sugar"] !== undefined) { this.sugar = source.sugar.map((x) => new fhirModels.SubstanceNucleicAcidSubunitSugar(x)); }
    if (source["threePrime"] !== undefined) { this.threePrime = new fhirModels.CodeableConcept(source.threePrime); }
  }
  /**
...
export class SubstanceNucleicAcid extends fhirModels.DomainResource implements fhirInterfaces.ISubstanceNucleicAcid {
  ...
  constructor(source:Partial<fhirInterfaces.ISubstanceNucleicAcid>) {
    ...
    if (source["_areaOfHybridisation"] !== undefined) { this._areaOfHybridisation = new fhirModels.Element(source._areaOfHybridisation); }
    ...
    if (source["oligoNucleotideType"] !== undefined) { this.oligoNucleotideType = new fhirModels.CodeableConcept(source.oligoNucleotideType); }
    if (source["sequenceType"] !== undefined) { this.sequenceType = new fhirModels.CodeableConcept(source.sequenceType); }
    if (source["subunit"] !== undefined) { this.subunit = source.subunit.map((x) => new fhirModels.SubstanceNucleicAcidSubunit(x)); }
  }
  /**
