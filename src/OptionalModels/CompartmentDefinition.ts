 ...
 */
export class CompartmentDefinitionResource extends fhirModels.BackboneElement implements fhirInterfaces.ICompartmentDefinitionResource {
  /**
  ...
  constructor(source:Partial<fhirInterfaces.ICompartmentDefinitionResource>) {
    ...
    if (source["param"] !== undefined) { this.param = source.param.map((x) => (x)); }
    if (source["_param"] !== undefined) { this._param = source._param.map((x) => new fhirModels.Element(x)); }
  }
  /**
 ...
 */
export class CompartmentDefinition extends fhirModels.DomainResource implements fhirInterfaces.ICompartmentDefinition {
  /**
   * Resource Type Name
   */
  ...
  constructor(source:Partial<fhirInterfaces.ICompartmentDefinition>) {
    ...
    if (source["resource"] !== undefined) { this.resource = source.resource.map((x) => new fhirModels.CompartmentDefinitionResource(x)); }
    if (source["search"] !== undefined) { this.search = source.search; }
    if (source["_search"] !== undefined) { this._search = new fhirModels.Element(source._search); }
