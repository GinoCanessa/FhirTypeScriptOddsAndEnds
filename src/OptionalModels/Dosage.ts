 ...
 */
export class DosageDoseAndRate extends fhirModels.Element implements fhirInterfaces.IDosageDoseAndRate {
  /**
  ...
  constructor(source:Partial<fhirInterfaces.IDosageDoseAndRate>) {
    super(source);
    if (source["doseRange"] !== undefined) { this.doseRange = new fhirModels.Range(source.doseRange); }
    ...
    if (source["rateRange"] !== undefined) { this.rateRange = new fhirModels.Range(source.rateRange); }
 ...
 */
export class Dosage extends fhirModels.BackboneElement implements fhirInterfaces.IDosage {
  /**
  ...
  constructor(source:Partial<fhirInterfaces.IDosage>) {
    super(source);
    if (source["additionalInstruction"] !== undefined) { this.additionalInstruction = source.additionalInstruction.map((x) => new fhirModels.CodeableConcept(x)); }
    ...
    if (source["doseAndRate"] !== undefined) { this.doseAndRate = source.doseAndRate.map((x) => new fhirModels.DosageDoseAndRate(x)); }
    if (source["maxDosePerAdministration"] !== undefined) { this.maxDosePerAdministration = new fhirModels.Quantity(source.maxDosePerAdministration); }
    if (source["maxDosePerLifetime"] !== undefined) { this.maxDosePerLifetime = new fhirModels.Quantity(source.maxDosePerLifetime); }
    if (source["maxDosePerPeriod"] !== undefined) { this.maxDosePerPeriod = new fhirModels.Ratio(source.maxDosePerPeriod); }
    ...
    if (source["timing"] !== undefined) { this.timing = new fhirModels.Timing(source.timing); }
  }
  /**
