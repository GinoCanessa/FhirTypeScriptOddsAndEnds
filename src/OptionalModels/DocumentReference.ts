 ...
 */
export class DocumentReferenceRelatesTo extends fhirModels.BackboneElement implements fhirInterfaces.IDocumentReferenceRelatesTo {
  /**
 ...
 */
export class DocumentReferenceContent extends fhirModels.BackboneElement implements fhirInterfaces.IDocumentReferenceContent {
  /**
  ...
  constructor(source:Partial<fhirInterfaces.IDocumentReferenceContent>) {
    ...
    if (source["format"] !== undefined) { this.format = new fhirModels.Coding(source.format); }
  }
  /**
 ...
 */
export class DocumentReferenceContext extends fhirModels.BackboneElement implements fhirInterfaces.IDocumentReferenceContext {
  /**
  ...
  constructor(source:Partial<fhirInterfaces.IDocumentReferenceContext>) {
    ...
    if (source["event"] !== undefined) { this.event = source.event.map((x) => new fhirModels.CodeableConcept(x)); }
    if (source["facilityType"] !== undefined) { this.facilityType = new fhirModels.CodeableConcept(source.facilityType); }
    if (source["period"] !== undefined) { this.period = new fhirModels.Period(source.period); }
    if (source["practiceSetting"] !== undefined) { this.practiceSetting = new fhirModels.CodeableConcept(source.practiceSetting); }
    if (source["related"] !== undefined) { this.related = source.related.map((x) => new fhirModels.Reference(x)); }
    if (source["sourcePatientInfo"] !== undefined) { this.sourcePatientInfo = new fhirModels.Reference(source.sourcePatientInfo); }
  }
  /**
 ...
 */
export class DocumentReference extends fhirModels.DomainResource implements fhirInterfaces.IDocumentReference {
  /**
   * Resource Type Name
   */
  ...
  constructor(source:Partial<fhirInterfaces.IDocumentReference>) {
    ...
    if (source["authenticator"] !== undefined) { this.authenticator = new fhirModels.Reference(source.authenticator); }
    ...
    if (source["content"] !== undefined) { this.content = source.content.map((x) => new fhirModels.DocumentReferenceContent(x)); }
    if (source["context"] !== undefined) { this.context = new fhirModels.DocumentReferenceContext(source.context); }
    ...
    if (source["_docStatus"] !== undefined) { this._docStatus = new fhirModels.Element(source._docStatus); }
    if (source["identifier"] !== undefined) { this.identifier = source.identifier.map((x) => new fhirModels.Identifier(x)); }
    if (source["masterIdentifier"] !== undefined) { this.masterIdentifier = new fhirModels.Identifier(source.masterIdentifier); }
    if (source["relatesTo"] !== undefined) { this.relatesTo = source.relatesTo.map((x) => new fhirModels.DocumentReferenceRelatesTo(x)); }
    if (source["securityLabel"] !== undefined) { this.securityLabel = source.securityLabel.map((x) => new fhirModels.CodeableConcept(x)); }
  ...
  override checkRequiredElements():string[] {
    var missingElements:string[] = [];
    if ((this["content"] === undefined) || (this["content"].length === 0)) { missingElements.push("content"); }
