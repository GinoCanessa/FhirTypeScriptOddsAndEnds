 ...
 */
export declare const MedicationrequestCourseOfTherapy: {
    /**
     ...
     */
    medicationrequest_course_of_therapy_ShortCourseAcuteTherapy: Coding;
    /**
     ...
     */
    medicationrequest_course_of_therapy_ContinuousLongTermTherapy: Coding;
    /**
     * A medication which is expected to be used on a part time basis at certain times of the year
     */
    medicationrequest_course_of_therapy_Seasonal: Coding;
};
//# sourceMappingURL=MedicationrequestCourseOfTherapy.d.ts.map