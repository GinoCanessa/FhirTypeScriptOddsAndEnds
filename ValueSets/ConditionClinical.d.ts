...
export declare const ConditionClinical: {
     ...
     */
    condition_clinical_Recurrence: Coding;
    /**
     ...
     */
    condition_clinical_Resolved: Coding;
};
//# sourceMappingURL=ConditionClinical.d.ts.map