 ...
 */
export declare const TestscriptProfileDestinationTypes: {
    /**
     * A FHIR server acting as a Structured Data Capture Form Manager.
     */
    testscript_profile_destination_types_FHIRSDCFormManager: Coding;
    /**
     * A FHIR server acting as a Structured Data Capture Form Processor.
     */
    testscript_profile_destination_types_FHIRSDCFormProcessor: Coding;
    /**
     * A FHIR server acting as a Structured Data Capture Form Receiver.
     */
    testscript_profile_destination_types_FHIRSDCFormReceiver: Coding;
    /**
     * General FHIR server used to respond to operations sent from a FHIR client.
     */
    testscript_profile_destination_types_FHIRServer: Coding;
};
//# sourceMappingURL=TestscriptProfileDestinationTypes.d.ts.map