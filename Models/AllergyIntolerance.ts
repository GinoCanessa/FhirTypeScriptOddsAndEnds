 ...
 */
export class AllergyIntoleranceReaction extends fhirModels.BackboneElement {
  /**
   ...
   */
  exposureRoute?: fhirModels.CodeableConcept;
  /**
   ...
   * Default constructor
   */
  constructor(source: AllergyIntoleranceReaction) {
    super(source);
    ...
    if (source["exposureRoute"] !== undefined) { this.exposureRoute = source.exposureRoute; }
    if (source["manifestation"] === undefined) { throw 'Missing required element manifestation';}
    this.manifestation = source.manifestation;
    if (source["note"] !== undefined) { this.note = source.note; }
    if (source["onset"] !== undefined) { this.onset = source.onset; }
    if (source["_onset"] !== undefined) { this._onset = source._onset; }
 ...
 */
export class AllergyIntolerance extends fhirModels.DomainResource {
  /**
   * Resource Type Name
   */
  ...
  _criticality?: fhirModels.Element;
  /**
  ...
  _lastOccurrence?: fhirModels.Element;
  /**
   ...
   * Details about each adverse reaction event linked to exposure to the identified substance.
   */
  reaction?: fhirModels.AllergyIntoleranceReaction[];
  /**
   ...
   * Default constructor
   */
  constructor(source: AllergyIntolerance) {
    super(source);
    ...
    if (source["_criticality"] !== undefined) { this._criticality = source._criticality; }
    ...
    if (source["_lastOccurrence"] !== undefined) { this._lastOccurrence = source._lastOccurrence; }
    if (source["note"] !== undefined) { this.note = source.note; }
