 ...
 */
export class CarePlanActivityDetail extends fhirModels.BackboneElement {
  /**
   ...
   */
  dailyAmount?: fhirModels.Quantity;
  /**
   ...
   */
  kind?: CarePlanActivityDetailKindEnum;
   ...
   */
  scheduledTiming?: fhirModels.Timing;
  /**
   * The period, timing or frequency upon which the described activity is to occur.
   */
  scheduledPeriod?: fhirModels.Period;
  /**
   * The period, timing or frequency upon which the described activity is to occur.
   */
  scheduledString?: string;
  _scheduledString?: fhirModels.Element;
  /**
   ...
   * Default constructor
   */
  constructor(source: CarePlanActivityDetail) {
    super(source);
    if (source["code"] !== undefined) { this.code = source.code; }
    if (source["dailyAmount"] !== undefined) { this.dailyAmount = source.dailyAmount; }
    ...
    if (source["scheduledTiming"] !== undefined) { this.scheduledTiming = source.scheduledTiming; }
    if (source["scheduledPeriod"] !== undefined) { this.scheduledPeriod = source.scheduledPeriod; }
    if (source["scheduledString"] !== undefined) { this.scheduledString = source.scheduledString; }
    if (source["_scheduledString"] !== undefined) { this._scheduledString = source._scheduledString; }
 ...
 */
export class CarePlanActivity extends fhirModels.BackboneElement {
  /**
   * A simple summary of a planned activity suitable for a general care plan system (e.g. form driven) that doesn't know about specific resources such as procedure etc.
   */
  detail?: fhirModels.CarePlanActivityDetail;
  /**
   * Note that this should not duplicate the activity status (e.g. completed or in progress).
   */
  outcomeCodeableConcept?: fhirModels.CodeableConcept[];
  /**
   ...
   */
  progress?: fhirModels.Annotation[];
  /**
   ...
   * Default constructor
   */
  constructor(source: CarePlanActivity) {
    super(source);
    if (source["detail"] !== undefined) { this.detail = source.detail; }
    if (source["outcomeCodeableConcept"] !== undefined) { this.outcomeCodeableConcept = source.outcomeCodeableConcept; }
    if (source["outcomeReference"] !== undefined) { this.outcomeReference = source.outcomeReference; }
    if (source["progress"] !== undefined) { this.progress = source.progress; }
 ...
 */
export class CarePlan extends fhirModels.DomainResource {
  /**
   * Resource Type Name
   */
  readonly resourceType: string = "CarePlan";
  /**
   * Identifies a planned action to occur as part of the plan.  For example, a medication to be used, lab tests to perform, self-monitoring, education, etc.
   */
  activity?: fhirModels.CarePlanActivity[];
  /**
