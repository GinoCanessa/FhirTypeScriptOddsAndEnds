 ...
 */
export class MedicationIngredient extends fhirModels.BackboneElement {
  /**
   ...
   * Default constructor
   */
  constructor(source: MedicationIngredient) {
    super(source);
 ...
 */
export class MedicationBatch extends fhirModels.BackboneElement {
  /**
   ...
   * Default constructor
   */
  constructor(source: MedicationBatch) {
    super(source);
 ...
 */
export class Medication extends fhirModels.DomainResource {
  /**
   * Resource Type Name
   */
   ...
   */
  amount?: fhirModels.Ratio;
  /**
   * Information that only applies to packages (not products).
   */
  batch?: fhirModels.MedicationBatch;
  /**
   ...
   * The ingredients need not be a complete list.  If an ingredient is not specified, this does not indicate whether an ingredient is present or absent.  If an ingredient is specified it does not mean that all ingredients are specified.  It is possible to specify both inactive and active ingredients.
   */
  ingredient?: fhirModels.MedicationIngredient[];
  /**
  ...
  constructor(source: Medication) {
    ...
    if (source["batch"] !== undefined) { this.batch = source.batch; }
