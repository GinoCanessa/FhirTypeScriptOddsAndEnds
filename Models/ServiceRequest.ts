 ...
 */
export class ServiceRequest extends fhirModels.DomainResource {
  /**
   * Resource Type Name
   */
  readonly resourceType: string = "ServiceRequest";
  /**
   ...
   */
  locationCode?: fhirModels.CodeableConcept[];
  /**
   ...
   */
  orderDetail?: fhirModels.CodeableConcept[];
  /**
   ...
   */
  quantityQuantity?: fhirModels.Quantity;
  /**
   * An amount of service being requested which can be a quantity ( for example $1,500 home modification), a ratio ( for example, 20 half day visits per month), or a range (2.0 to 1.8 Gy per fraction).
   */
  quantityRatio?: fhirModels.Ratio;
  /**
   * An amount of service being requested which can be a quantity ( for example $1,500 home modification), a ratio ( for example, 20 half day visits per month), or a range (2.0 to 1.8 Gy per fraction).
   */
  quantityRange?: fhirModels.Range;
  /**
   ...
   */
  requisition?: fhirModels.Identifier;
  /**
   ...
   * Default constructor
   */
  constructor(source: ServiceRequest) {
    super(source);
    ...
    if (source["locationCode"] !== undefined) { this.locationCode = source.locationCode; }
    ...
    if (source["orderDetail"] !== undefined) { this.orderDetail = source.orderDetail; }
    ...
    if (source["quantityQuantity"] !== undefined) { this.quantityQuantity = source.quantityQuantity; }
    if (source["quantityRatio"] !== undefined) { this.quantityRatio = source.quantityRatio; }
    if (source["quantityRange"] !== undefined) { this.quantityRange = source.quantityRange; }
    ...
    if (source["requisition"] !== undefined) { this.requisition = source.requisition; }
