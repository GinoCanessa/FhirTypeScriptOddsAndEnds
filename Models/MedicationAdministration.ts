 ...
 */
export class MedicationAdministrationPerformer extends fhirModels.BackboneElement {
  /**
   ...
   * Default constructor
   */
  constructor(source: MedicationAdministrationPerformer) {
    super(source);
 ...
 */
export class MedicationAdministrationDosage extends fhirModels.BackboneElement {
  /**
   ...
   * Default constructor
   */
  constructor(source: MedicationAdministrationDosage) {
    super(source);
    if (source["dose"] !== undefined) { this.dose = source.dose; }
 ...
 */
export class MedicationAdministration extends fhirModels.DomainResource {
  /**
   * Resource Type Name
   */
  readonly resourceType: string = "MedicationAdministration";
  /**
   ...
   * Describes the medication dosage information details e.g. dose, rate, site, route, etc.
   */
  dosage?: fhirModels.MedicationAdministrationDosage;
  /**
   ...
   * Indicates who or what performed the medication administration and how they were involved.
   */
  performer?: fhirModels.MedicationAdministrationPerformer[];
  /**
   ...
   * Default constructor
   */
  constructor(source: MedicationAdministration) {
    super(source);
