 ...
 */
export class ObservationReferenceRange extends fhirModels.BackboneElement {
  /**
   ...
   * Default constructor
   */
  constructor(source: ObservationReferenceRange) {
    super(source);
 ...
 */
export class ObservationComponent extends fhirModels.BackboneElement {
  /**
   ...
   */
  interpretation?: fhirModels.CodeableConcept[];
  /**
   * Most observations only have one generic reference range. Systems MAY choose to restrict to only supplying the relevant reference range based on knowledge about the patient (e.g., specific to the patient's age, gender, weight and other factors), but this might not be possible or appropriate. Whenever more than one reference range is supplied, the differences between them SHOULD be provided in the reference range and/or age properties.
   */
  referenceRange?: fhirModels.ObservationReferenceRange[];
  /**
   ...
   * Default constructor
   */
  constructor(source: ObservationComponent) {
    super(source);
    ...
    if (source["interpretation"] !== undefined) { this.interpretation = source.interpretation; }
 ...
 */
export class Observation extends fhirModels.DomainResource {
  /**
   * Resource Type Name
   */
   ...
   * For a discussion on the ways Observations can be assembled in groups together see [Notes](observation.html#notes) below.
   */
  component?: fhirModels.ObservationComponent[];
  /**
   ...
   * At least a date should be present unless this observation is a historical report.  For recording imprecise or "fuzzy" times (For example, a blood glucose measurement taken "after breakfast") use the [Timing](datatypes.html#timing) datatype which allow the measurement to be tied to regular life events.
   */
  effectiveTiming?: fhirModels.Timing;
  /**
   * At least a date should be present unless this observation is a historical report.  For recording imprecise or "fuzzy" times (For example, a blood glucose measurement taken "after breakfast") use the [Timing](datatypes.html#timing) datatype which allow the measurement to be tied to regular life events.
   */
  effectiveInstant?: string;
  _effectiveInstant?: fhirModels.Element;
  /**
   ...
   */
  hasMember?: fhirModels.Reference[];
  /**
  ...
  constructor(source: Observation) {
    ...
    if (source["effectiveTiming"] !== undefined) { this.effectiveTiming = source.effectiveTiming; }
    if (source["effectiveInstant"] !== undefined) { this.effectiveInstant = source.effectiveInstant; }
    if (source["_effectiveInstant"] !== undefined) { this._effectiveInstant = source._effectiveInstant; }
    if (source["encounter"] !== undefined) { this.encounter = source.encounter; }
    if (source["focus"] !== undefined) { this.focus = source.focus; }
    if (source["hasMember"] !== undefined) { this.hasMember = source.hasMember; }
