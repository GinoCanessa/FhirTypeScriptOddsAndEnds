...
export class QuestionnaireResponseItemAnswer extends fhirModels.BackboneElement implements fhirInterfaces.IQuestionnaireResponseItemAnswer {
  ...
  constructor(source:Partial<fhirInterfaces.IQuestionnaireResponseItemAnswer>) {
    super(source);
    if (source["item"] !== undefined) { this.item = source.item.map((x) => new fhirModels.QuestionnaireResponseItem(x)); }
...
export class QuestionnaireResponseItem extends fhirModels.BackboneElement implements fhirInterfaces.IQuestionnaireResponseItem {
  ...
  constructor(source:Partial<fhirInterfaces.IQuestionnaireResponseItem>) {
    super(source);
    if (source["answer"] !== undefined) { this.answer = source.answer.map((x) => new fhirModels.QuestionnaireResponseItemAnswer(x)); }
...
export class QuestionnaireResponse extends fhirModels.DomainResource implements fhirInterfaces.IQuestionnaireResponse {
  ...
  constructor(source:Partial<fhirInterfaces.IQuestionnaireResponse>) {
    ...
    if (source["_authored"] !== undefined) { this._authored = new fhirModels.Element(source._authored); }
    ...
    if (source["_questionnaire"] !== undefined) { this._questionnaire = new fhirModels.Element(source._questionnaire); }
