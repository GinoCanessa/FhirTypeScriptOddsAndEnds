 ...
 */
export class StructureDefinitionMapping extends fhirModels.BackboneElement {
  /**
   ...
   * Default constructor
   */
  constructor(source: StructureDefinitionMapping) {
    super(source);
 ...
 */
export class StructureDefinitionContext extends fhirModels.BackboneElement {
  /**
   ...
   * Default constructor
   */
  constructor(source: StructureDefinitionContext) {
    super(source);
 ...
 */
export class StructureDefinitionSnapshot extends fhirModels.BackboneElement {
  /**
   ...
   * Default constructor
   */
  constructor(source: StructureDefinitionSnapshot) {
    super(source);
 ...
 */
export class StructureDefinitionDifferential extends fhirModels.BackboneElement {
  /**
   * Captures constraints on each element within the resource.
   */
  element: fhirModels.ElementDefinition[];
   ...
   * Default constructor
   */
  constructor(source: StructureDefinitionDifferential) {
    super(source);
    if (source["element"] === undefined) { throw 'Missing required element element';}
    this.element = source.element;
  }
 ...
 */
export class StructureDefinition extends fhirModels.DomainResource {
  /**
   * Resource Type Name
   */
  readonly resourceType: string = "StructureDefinition";
  /**
  ...
  _baseDefinition?: fhirModels.Element;
  /**
   ...
   * Identifies the types of resource or data type elements to which the extension can be applied.
   */
  context?: fhirModels.StructureDefinitionContext[];
  /**
  ...
  _contextInvariant?: fhirModels.Element[];
  /**
   ...
   */
  derivation?: StructureDefinitionDerivationEnum;
  _derivation?: fhirModels.Element;
  /**
   ...
   * A differential view is expressed relative to the base StructureDefinition - a statement of differences that it applies.
   */
  differential?: fhirModels.StructureDefinitionDifferential;
  /**
   ...
   * An external specification that the content is mapped to.
   */
  mapping?: fhirModels.StructureDefinitionMapping[];
  /**
   ...
   * A snapshot view is expressed in a standalone form that can be used and interpreted without considering the base StructureDefinition.
   */
  snapshot?: fhirModels.StructureDefinitionSnapshot;
  /**
   * Allows filtering of structure definitions that are appropriate for use versus not.
   */
   ...
   * Default constructor
   */
  constructor(source: StructureDefinition) {
    super(source);
    ...
    if (source["abstract"] === undefined) { throw 'Missing required element abstract';}
    ...
    if (source["_baseDefinition"] !== undefined) { this._baseDefinition = source._baseDefinition; }
    if (source["contact"] !== undefined) { this.contact = source.contact; }
    if (source["context"] !== undefined) { this.context = source.context; }
    if (source["contextInvariant"] !== undefined) { this.contextInvariant = source.contextInvariant; }
    if (source["_contextInvariant"] !== undefined) { this._contextInvariant = source._contextInvariant; }
    ...
    if (source["_derivation"] !== undefined) { this._derivation = source._derivation; }
    ...
    if (source["differential"] !== undefined) { this.differential = source.differential; }
    ...
    if (source["snapshot"] !== undefined) { this.snapshot = source.snapshot; }
