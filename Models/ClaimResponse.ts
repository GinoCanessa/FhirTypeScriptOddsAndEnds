...
export class ClaimResponseItemDetailSubDetail extends fhirModels.BackboneElement implements fhirInterfaces.IClaimResponseItemDetailSubDetail {
  ...
  constructor(source:Partial<fhirInterfaces.IClaimResponseItemDetailSubDetail>) {
    super(source);
    if (source["adjudication"] !== undefined) { this.adjudication = source.adjudication.map((x) => new fhirModels.ClaimResponseItemAdjudication(x)); }
    ...
    if (source["_subDetailSequence"] !== undefined) { this._subDetailSequence = new fhirModels.Element(source._subDetailSequence); }
  }
  /**
...
export class ClaimResponseItemDetail extends fhirModels.BackboneElement implements fhirInterfaces.IClaimResponseItemDetail {
  ...
  constructor(source:Partial<fhirInterfaces.IClaimResponseItemDetail>) {
    ...
    if (source["_detailSequence"] !== undefined) { this._detailSequence = new fhirModels.Element(source._detailSequence); }
    if (source["noteNumber"] !== undefined) { this.noteNumber = source.noteNumber.map((x) => (x)); }
    if (source["_noteNumber"] !== undefined) { this._noteNumber = source._noteNumber.map((x) => new fhirModels.Element(x)); }
    if (source["subDetail"] !== undefined) { this.subDetail = source.subDetail.map((x) => new fhirModels.ClaimResponseItemDetailSubDetail(x)); }
  }
  /**
  ...
  checkRequiredElements():string[] {
    var missingElements:string[] = [];
    if ((this["adjudication"] === undefined) || (this["adjudication"].length === 0)) { missingElements.push("adjudication"); }
...
export class ClaimResponseItem extends fhirModels.BackboneElement implements fhirInterfaces.IClaimResponseItem {
  ...
  constructor(source:Partial<fhirInterfaces.IClaimResponseItem>) {
    super(source);
    if (source["adjudication"] !== undefined) { this.adjudication = source.adjudication.map((x) => new fhirModels.ClaimResponseItemAdjudication(x)); }
    if (source["detail"] !== undefined) { this.detail = source.detail.map((x) => new fhirModels.ClaimResponseItemDetail(x)); }
    if (source["itemSequence"] !== undefined) { this.itemSequence = source.itemSequence; }
    if (source["_itemSequence"] !== undefined) { this._itemSequence = new fhirModels.Element(source._itemSequence); }
    if (source["noteNumber"] !== undefined) { this.noteNumber = source.noteNumber.map((x) => (x)); }
    if (source["_noteNumber"] !== undefined) { this._noteNumber = source._noteNumber.map((x) => new fhirModels.Element(x)); }
  }
  /**
...
export class ClaimResponseAddItemDetail extends fhirModels.BackboneElement implements fhirInterfaces.IClaimResponseAddItemDetail {
  ...
  constructor(source:Partial<fhirInterfaces.IClaimResponseAddItemDetail>) {
    ...
    if (source["productOrService"] !== undefined) { this.productOrService = new fhirModels.CodeableConcept(source.productOrService); }
    if (source["quantity"] !== undefined) { this.quantity = new fhirModels.Quantity(source.quantity); }
    if (source["subDetail"] !== undefined) { this.subDetail = source.subDetail.map((x) => new fhirModels.ClaimResponseAddItemDetailSubDetail(x)); }
    if (source["unitPrice"] !== undefined) { this.unitPrice = new fhirModels.Money(source.unitPrice); }
  }
  /**
...
export class ClaimResponseAddItem extends fhirModels.BackboneElement implements fhirInterfaces.IClaimResponseAddItem {
  ...
  constructor(source:Partial<fhirInterfaces.IClaimResponseAddItem>) {
    ...
    if (source["detail"] !== undefined) { this.detail = source.detail.map((x) => new fhirModels.ClaimResponseAddItemDetail(x)); }
...
export class ClaimResponse extends fhirModels.DomainResource implements fhirInterfaces.IClaimResponse {
  ...
  constructor(source:Partial<fhirInterfaces.IClaimResponse>) {
    ...
    if (source["addItem"] !== undefined) { this.addItem = source.addItem.map((x) => new fhirModels.ClaimResponseAddItem(x)); }
    if (source["adjudication"] !== undefined) { this.adjudication = source.adjudication.map((x) => new fhirModels.ClaimResponseItemAdjudication(x)); }
    if (source["communicationRequest"] !== undefined) { this.communicationRequest = source.communicationRequest.map((x) => new fhirModels.Reference(x)); }
    ...
    if (source["error"] !== undefined) { this.error = source.error.map((x) => new fhirModels.ClaimResponseError(x)); }
    ...
    if (source["insurance"] !== undefined) { this.insurance = source.insurance.map((x) => new fhirModels.ClaimResponseInsurance(x)); }
    if (source["insurer"] !== undefined) { this.insurer = new fhirModels.Reference(source.insurer); }
    if (source["item"] !== undefined) { this.item = source.item.map((x) => new fhirModels.ClaimResponseItem(x)); }
    ...
    if (source["payeeType"] !== undefined) { this.payeeType = new fhirModels.CodeableConcept(source.payeeType); }
    if (source["payment"] !== undefined) { this.payment = new fhirModels.ClaimResponsePayment(source.payment); }
    if (source["preAuthPeriod"] !== undefined) { this.preAuthPeriod = new fhirModels.Period(source.preAuthPeriod); }
    ...
    if (source["processNote"] !== undefined) { this.processNote = source.processNote.map((x) => new fhirModels.ClaimResponseProcessNote(x)); }
    ...
    if (source["total"] !== undefined) { this.total = source.total.map((x) => new fhirModels.ClaimResponseTotal(x)); }
    if (source["type"] !== undefined) { this.type = new fhirModels.CodeableConcept(source.type); }
