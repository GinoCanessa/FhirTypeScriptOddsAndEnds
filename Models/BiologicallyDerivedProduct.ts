...
export class BiologicallyDerivedProductProcessing extends fhirModels.BackboneElement implements fhirInterfaces.IBiologicallyDerivedProductProcessing {
  ...
  constructor(source:Partial<fhirInterfaces.IBiologicallyDerivedProductProcessing>) {
    super(source);
    if (source["additive"] !== undefined) { this.additive = new fhirModels.Reference(source.additive); }
...
export class BiologicallyDerivedProductStorage extends fhirModels.BackboneElement implements fhirInterfaces.IBiologicallyDerivedProductStorage {
  ...
  constructor(source:Partial<fhirInterfaces.IBiologicallyDerivedProductStorage>) {
    ...
    if (source["description"] !== undefined) { this.description = source.description; }
    if (source["_description"] !== undefined) { this._description = new fhirModels.Element(source._description); }
    if (source["duration"] !== undefined) { this.duration = new fhirModels.Period(source.duration); }
    if (source["scale"] !== undefined) { this.scale = source.scale; }
    if (source["_scale"] !== undefined) { this._scale = new fhirModels.Element(source._scale); }
    if (source["temperature"] !== undefined) { this.temperature = source.temperature; }
    if (source["_temperature"] !== undefined) { this._temperature = new fhirModels.Element(source._temperature); }
  }
  /**
...
export class BiologicallyDerivedProduct extends fhirModels.DomainResource implements fhirInterfaces.IBiologicallyDerivedProduct {
  ...
  constructor(source:Partial<fhirInterfaces.IBiologicallyDerivedProduct>) {
    ...
    if (source["collection"] !== undefined) { this.collection = new fhirModels.BiologicallyDerivedProductCollection(source.collection); }
    if (source["identifier"] !== undefined) { this.identifier = source.identifier.map((x) => new fhirModels.Identifier(x)); }
    if (source["manipulation"] !== undefined) { this.manipulation = new fhirModels.BiologicallyDerivedProductManipulation(source.manipulation); }
    if (source["parent"] !== undefined) { this.parent = source.parent.map((x) => new fhirModels.Reference(x)); }
    if (source["processing"] !== undefined) { this.processing = source.processing.map((x) => new fhirModels.BiologicallyDerivedProductProcessing(x)); }
    if (source["productCategory"] !== undefined) { this.productCategory = source.productCategory; }
    if (source["_productCategory"] !== undefined) { this._productCategory = new fhirModels.Element(source._productCategory); }
    if (source["productCode"] !== undefined) { this.productCode = new fhirModels.CodeableConcept(source.productCode); }
    ...
    if (source["storage"] !== undefined) { this.storage = source.storage.map((x) => new fhirModels.BiologicallyDerivedProductStorage(x)); }
  }
  /**
