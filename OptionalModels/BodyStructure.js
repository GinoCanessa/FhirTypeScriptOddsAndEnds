...
var BodyStructure = /** @class */ (function (_super) {
     ...
     */
    BodyStructure.CreateStrict = function (source) {
        var dest = new BodyStructure(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "BodyStructure is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    BodyStructure.prototype.checkRequiredElements = function () {
        var missingElements = [];
