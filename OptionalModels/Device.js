...
var DeviceUdiCarrier = /** @class */ (function (_super) {
     ...
     */
    DeviceUdiCarrier.CreateStrict = function (source) {
        var dest = new DeviceUdiCarrier(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "DeviceUdiCarrier is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    DeviceUdiCarrier.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var DeviceDeviceName = /** @class */ (function (_super) {
     ...
     */
    DeviceDeviceName.CreateStrict = function (source) {
        var dest = new DeviceDeviceName(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "DeviceDeviceName is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    DeviceDeviceName.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var DeviceSpecialization = /** @class */ (function (_super) {
     ...
     */
    DeviceSpecialization.CreateStrict = function (source) {
        var dest = new DeviceSpecialization(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "DeviceSpecialization is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    DeviceSpecialization.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var DeviceVersion = /** @class */ (function (_super) {
     ...
     */
    DeviceVersion.CreateStrict = function (source) {
        var dest = new DeviceVersion(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "DeviceVersion is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    DeviceVersion.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var DeviceProperty = /** @class */ (function (_super) {
     ...
     */
    DeviceProperty.CreateStrict = function (source) {
        var dest = new DeviceProperty(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "DeviceProperty is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    DeviceProperty.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if (this["type"] === undefined) {
            missingElements.push("type");
        }
...
var Device = /** @class */ (function (_super) {
     ...
     */
    Device.CreateStrict = function (source) {
        var dest = new Device(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Device is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Device.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
