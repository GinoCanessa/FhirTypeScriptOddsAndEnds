...
var EffectEvidenceSynthesisSampleSize = /** @class */ (function (_super) {
     ...
     */
    EffectEvidenceSynthesisSampleSize.CreateStrict = function (source) {
        var dest = new EffectEvidenceSynthesisSampleSize(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "EffectEvidenceSynthesisSampleSize is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    EffectEvidenceSynthesisSampleSize.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var EffectEvidenceSynthesisResultsByExposure = /** @class */ (function (_super) {
    ...
    function EffectEvidenceSynthesisResultsByExposure(source) {
        ...
        if (source["riskEvidenceSynthesis"] !== undefined) {
     ...
     */
    EffectEvidenceSynthesisResultsByExposure.CreateStrict = function (source) {
        var dest = new EffectEvidenceSynthesisResultsByExposure(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "EffectEvidenceSynthesisResultsByExposure is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    EffectEvidenceSynthesisResultsByExposure.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var EffectEvidenceSynthesisEffectEstimatePrecisionEstimate = /** @class */ (function (_super) {
     ...
     */
    EffectEvidenceSynthesisEffectEstimatePrecisionEstimate.CreateStrict = function (source) {
        var dest = new EffectEvidenceSynthesisEffectEstimatePrecisionEstimate(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "EffectEvidenceSynthesisEffectEstimatePrecisionEstimate is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    EffectEvidenceSynthesisEffectEstimatePrecisionEstimate.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var EffectEvidenceSynthesisEffectEstimate = /** @class */ (function (_super) {
     ...
     */
    EffectEvidenceSynthesisEffectEstimate.CreateStrict = function (source) {
        var dest = new EffectEvidenceSynthesisEffectEstimate(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "EffectEvidenceSynthesisEffectEstimate is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    EffectEvidenceSynthesisEffectEstimate.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var EffectEvidenceSynthesisCertaintyCertaintySubcomponent = /** @class */ (function (_super) {
     ...
     */
    EffectEvidenceSynthesisCertaintyCertaintySubcomponent.CreateStrict = function (source) {
        var dest = new EffectEvidenceSynthesisCertaintyCertaintySubcomponent(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "EffectEvidenceSynthesisCertaintyCertaintySubcomponent is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    EffectEvidenceSynthesisCertaintyCertaintySubcomponent.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var EffectEvidenceSynthesisCertainty = /** @class */ (function (_super) {
     ...
     */
    EffectEvidenceSynthesisCertainty.CreateStrict = function (source) {
        var dest = new EffectEvidenceSynthesisCertainty(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "EffectEvidenceSynthesisCertainty is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    EffectEvidenceSynthesisCertainty.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var EffectEvidenceSynthesis = /** @class */ (function (_super) {
     ...
     */
    EffectEvidenceSynthesis.CreateStrict = function (source) {
        var dest = new EffectEvidenceSynthesis(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "EffectEvidenceSynthesis is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    EffectEvidenceSynthesis.prototype.checkRequiredElements = function () {
        var missingElements = [];
