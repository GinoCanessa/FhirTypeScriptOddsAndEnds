...
export declare class QuestionnaireItemEnableWhen extends fhirModels.BackboneElement implements fhirInterfaces.IQuestionnaireItemEnableWhen {
     ...
     */
    operator?: QuestionnaireItemEnableWhenOperatorEnum | undefined;
     ...
     */
    constructor(source: Partial<fhirInterfaces.IQuestionnaireItemEnableWhen>);
    /**
     * Factory function to create a QuestionnaireItemEnableWhen from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IQuestionnaireItemEnableWhen): QuestionnaireItemEnableWhen;
    /**
...
export declare class QuestionnaireItemAnswerOption extends fhirModels.BackboneElement implements fhirInterfaces.IQuestionnaireItemAnswerOption {
     ...
     */
    constructor(source: Partial<fhirInterfaces.IQuestionnaireItemAnswerOption>);
    /**
     * Factory function to create a QuestionnaireItemAnswerOption from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IQuestionnaireItemAnswerOption): QuestionnaireItemAnswerOption;
    /**
...
export declare class QuestionnaireItemInitial extends fhirModels.BackboneElement implements fhirInterfaces.IQuestionnaireItemInitial {
     ...
     */
    constructor(source: Partial<fhirInterfaces.IQuestionnaireItemInitial>);
    /**
     * Factory function to create a QuestionnaireItemInitial from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IQuestionnaireItemInitial): QuestionnaireItemInitial;
    /**
...
export declare class Questionnaire extends fhirModels.DomainResource implements fhirInterfaces.IQuestionnaire {
     ...
     */
    constructor(source: Partial<fhirInterfaces.IQuestionnaire>);
    /**
     * Factory function to create a Questionnaire from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IQuestionnaire): Questionnaire;
    /**
