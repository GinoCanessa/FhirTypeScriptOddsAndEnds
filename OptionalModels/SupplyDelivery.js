...
var SupplyDeliverySuppliedItem = /** @class */ (function (_super) {
     ...
     */
    SupplyDeliverySuppliedItem.CreateStrict = function (source) {
        var dest = new SupplyDeliverySuppliedItem(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SupplyDeliverySuppliedItem is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SupplyDeliverySuppliedItem.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var SupplyDelivery = /** @class */ (function (_super) {
     ...
     */
    SupplyDelivery.CreateStrict = function (source) {
        var dest = new SupplyDelivery(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SupplyDelivery is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SupplyDelivery.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
