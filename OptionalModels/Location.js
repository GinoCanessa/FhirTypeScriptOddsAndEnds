...
var LocationPosition = /** @class */ (function (_super) {
     ...
     */
    LocationPosition.CreateStrict = function (source) {
        var dest = new LocationPosition(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "LocationPosition is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    LocationPosition.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var LocationHoursOfOperation = /** @class */ (function (_super) {
     ...
     */
    LocationHoursOfOperation.CreateStrict = function (source) {
        var dest = new LocationHoursOfOperation(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "LocationHoursOfOperation is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    LocationHoursOfOperation.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var Location = /** @class */ (function (_super) {
     ...
     */
    Location.CreateStrict = function (source) {
        var dest = new Location(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Location is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Location.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
