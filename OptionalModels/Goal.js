...
var GoalTarget = /** @class */ (function (_super) {
     ...
     */
    GoalTarget.CreateStrict = function (source) {
        var dest = new GoalTarget(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "GoalTarget is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    GoalTarget.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var Goal = /** @class */ (function (_super) {
     ...
     */
    Goal.CreateStrict = function (source) {
        var dest = new Goal(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Goal is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Goal.prototype.checkRequiredElements = function () {
        var missingElements = [];
