...
var Signature = /** @class */ (function (_super) {
     ...
     */
    Signature.CreateStrict = function (source) {
        var dest = new Signature(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Signature is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Signature.prototype.checkRequiredElements = function () {
        var missingElements = [];
