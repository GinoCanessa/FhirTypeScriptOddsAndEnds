...
var DetectedIssueEvidence = /** @class */ (function (_super) {
     ...
     */
    DetectedIssueEvidence.CreateStrict = function (source) {
        var dest = new DetectedIssueEvidence(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "DetectedIssueEvidence is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    DetectedIssueEvidence.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var DetectedIssueMitigation = /** @class */ (function (_super) {
     ...
     */
    DetectedIssueMitigation.CreateStrict = function (source) {
        var dest = new DetectedIssueMitigation(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "DetectedIssueMitigation is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    DetectedIssueMitigation.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var DetectedIssue = /** @class */ (function (_super) {
     ...
     */
    DetectedIssue.CreateStrict = function (source) {
        var dest = new DetectedIssue(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "DetectedIssue is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    DetectedIssue.prototype.checkRequiredElements = function () {
        var missingElements = [];
