...
var ChargeItemDefinitionApplicability = /** @class */ (function (_super) {
     ...
     */
    ChargeItemDefinitionApplicability.CreateStrict = function (source) {
        var dest = new ChargeItemDefinitionApplicability(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ChargeItemDefinitionApplicability is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ChargeItemDefinitionApplicability.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ChargeItemDefinitionPropertyGroupPriceComponent = /** @class */ (function (_super) {
     ...
     */
    ChargeItemDefinitionPropertyGroupPriceComponent.CreateStrict = function (source) {
        var dest = new ChargeItemDefinitionPropertyGroupPriceComponent(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ChargeItemDefinitionPropertyGroupPriceComponent is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ChargeItemDefinitionPropertyGroupPriceComponent.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ChargeItemDefinitionPropertyGroup = /** @class */ (function (_super) {
     ...
     */
    ChargeItemDefinitionPropertyGroup.CreateStrict = function (source) {
        var dest = new ChargeItemDefinitionPropertyGroup(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ChargeItemDefinitionPropertyGroup is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ChargeItemDefinitionPropertyGroup.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var ChargeItemDefinition = /** @class */ (function (_super) {
     ...
     */
    ChargeItemDefinition.CreateStrict = function (source) {
        var dest = new ChargeItemDefinition(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ChargeItemDefinition is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ChargeItemDefinition.prototype.checkRequiredElements = function () {
        var missingElements = [];
