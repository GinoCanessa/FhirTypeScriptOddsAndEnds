...
var UsageContext = /** @class */ (function (_super) {
     ...
     */
    UsageContext.CreateStrict = function (source) {
        var dest = new UsageContext(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "UsageContext is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    UsageContext.prototype.checkRequiredElements = function () {
        var missingElements = [];
