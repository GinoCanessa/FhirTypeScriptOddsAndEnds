...
var ParametersParameter = /** @class */ (function (_super) {
    ...
    function ParametersParameter(source) {
        ...
        if (source["part"] !== undefined) {
            _this.part = source.part.map(function (x) { return new fhirModels.ParametersParameter(x); });
        }
     ...
     */
    ParametersParameter.CreateStrict = function (source) {
        var dest = new ParametersParameter(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ParametersParameter is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ParametersParameter.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var Parameters = /** @class */ (function (_super) {
    ...
    function Parameters(source) {
        ...
        if (source["parameter"] !== undefined) {
            _this.parameter = source.parameter.map(function (x) { return new fhirModels.ParametersParameter(x); });
        }
        return _this;
    }
    /**
     ...
     */
    Parameters.CreateStrict = function (source) {
        var dest = new Parameters(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Parameters is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Parameters.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
