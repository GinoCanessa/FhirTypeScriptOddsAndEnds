...
var BundleLink = /** @class */ (function (_super) {
     ...
     */
    BundleLink.CreateStrict = function (source) {
        var dest = new BundleLink(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "BundleLink is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    BundleLink.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var BundleEntrySearch = /** @class */ (function (_super) {
     ...
     */
    BundleEntrySearch.CreateStrict = function (source) {
        var dest = new BundleEntrySearch(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "BundleEntrySearch is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    BundleEntrySearch.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var BundleEntryRequest = /** @class */ (function (_super) {
     ...
     */
    BundleEntryRequest.CreateStrict = function (source) {
        var dest = new BundleEntryRequest(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "BundleEntryRequest is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    BundleEntryRequest.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var BundleEntryResponse = /** @class */ (function (_super) {
     ...
     */
    BundleEntryResponse.CreateStrict = function (source) {
        var dest = new BundleEntryResponse(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "BundleEntryResponse is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    BundleEntryResponse.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var BundleEntry = /** @class */ (function (_super) {
     ...
     */
    BundleEntry.CreateStrict = function (source) {
        var dest = new BundleEntry(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "BundleEntry is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    BundleEntry.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var Bundle = /** @class */ (function (_super) {
     ...
     */
    Bundle.CreateStrict = function (source) {
        var dest = new Bundle(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Bundle is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Bundle.prototype.checkRequiredElements = function () {
        var missingElements = [];
