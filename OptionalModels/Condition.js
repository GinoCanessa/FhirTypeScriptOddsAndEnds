...
var ConditionStage = /** @class */ (function (_super) {
     ...
     */
    ConditionStage.CreateStrict = function (source) {
        var dest = new ConditionStage(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ConditionStage is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ConditionStage.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ConditionEvidence = /** @class */ (function (_super) {
     ...
     */
    ConditionEvidence.CreateStrict = function (source) {
        var dest = new ConditionEvidence(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ConditionEvidence is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ConditionEvidence.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var Condition = /** @class */ (function (_super) {
     ...
     */
    Condition.CreateStrict = function (source) {
        var dest = new Condition(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Condition is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Condition.prototype.checkRequiredElements = function () {
        var missingElements = [];
