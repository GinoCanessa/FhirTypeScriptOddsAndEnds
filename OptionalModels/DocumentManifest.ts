...
export class DocumentManifestRelated extends fhirModels.BackboneElement implements fhirInterfaces.IDocumentManifestRelated {
  ...
  constructor(source:Partial<fhirInterfaces.IDocumentManifestRelated>) {
    ...
    if (source["ref"] !== undefined) { this.ref = new fhirModels.Reference(source.ref); }
  }
  /**
...
export class DocumentManifest extends fhirModels.DomainResource implements fhirInterfaces.IDocumentManifest {
  ...
  constructor(source:Partial<fhirInterfaces.IDocumentManifest>) {
    ...
    if (source["content"] !== undefined) { this.content = source.content.map((x) => new fhirModels.Reference(x)); }
    ...
    if (source["related"] !== undefined) { this.related = source.related.map((x) => new fhirModels.DocumentManifestRelated(x)); }
