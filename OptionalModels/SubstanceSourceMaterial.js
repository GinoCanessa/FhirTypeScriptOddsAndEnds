...
var SubstanceSourceMaterialFractionDescription = /** @class */ (function (_super) {
     ...
     */
    SubstanceSourceMaterialFractionDescription.CreateStrict = function (source) {
        var dest = new SubstanceSourceMaterialFractionDescription(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSourceMaterialFractionDescription is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSourceMaterialFractionDescription.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var SubstanceSourceMaterialOrganismAuthor = /** @class */ (function (_super) {
     ...
     */
    SubstanceSourceMaterialOrganismAuthor.CreateStrict = function (source) {
        var dest = new SubstanceSourceMaterialOrganismAuthor(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSourceMaterialOrganismAuthor is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSourceMaterialOrganismAuthor.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceSourceMaterialOrganismHybrid = /** @class */ (function (_super) {
     ...
     */
    SubstanceSourceMaterialOrganismHybrid.CreateStrict = function (source) {
        var dest = new SubstanceSourceMaterialOrganismHybrid(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSourceMaterialOrganismHybrid is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSourceMaterialOrganismHybrid.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceSourceMaterialOrganismOrganismGeneral = /** @class */ (function (_super) {
     ...
     */
    SubstanceSourceMaterialOrganismOrganismGeneral.CreateStrict = function (source) {
        var dest = new SubstanceSourceMaterialOrganismOrganismGeneral(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSourceMaterialOrganismOrganismGeneral is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSourceMaterialOrganismOrganismGeneral.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceSourceMaterialOrganism = /** @class */ (function (_super) {
     ...
     */
    SubstanceSourceMaterialOrganism.CreateStrict = function (source) {
        var dest = new SubstanceSourceMaterialOrganism(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSourceMaterialOrganism is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSourceMaterialOrganism.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceSourceMaterialPartDescription = /** @class */ (function (_super) {
     ...
     */
    SubstanceSourceMaterialPartDescription.CreateStrict = function (source) {
        var dest = new SubstanceSourceMaterialPartDescription(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSourceMaterialPartDescription is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSourceMaterialPartDescription.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceSourceMaterial = /** @class */ (function (_super) {
     ...
     */
    SubstanceSourceMaterial.CreateStrict = function (source) {
        var dest = new SubstanceSourceMaterial(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSourceMaterial is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSourceMaterial.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
