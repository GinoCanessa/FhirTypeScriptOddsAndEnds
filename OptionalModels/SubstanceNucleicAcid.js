...
var SubstanceNucleicAcidSubunitLinkage = /** @class */ (function (_super) {
     ...
     */
    SubstanceNucleicAcidSubunitLinkage.CreateStrict = function (source) {
        var dest = new SubstanceNucleicAcidSubunitLinkage(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceNucleicAcidSubunitLinkage is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceNucleicAcidSubunitLinkage.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var SubstanceNucleicAcidSubunitSugar = /** @class */ (function (_super) {
     ...
     */
    SubstanceNucleicAcidSubunitSugar.CreateStrict = function (source) {
        var dest = new SubstanceNucleicAcidSubunitSugar(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceNucleicAcidSubunitSugar is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceNucleicAcidSubunitSugar.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceNucleicAcidSubunit = /** @class */ (function (_super) {
     ...
     */
    SubstanceNucleicAcidSubunit.CreateStrict = function (source) {
        var dest = new SubstanceNucleicAcidSubunit(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceNucleicAcidSubunit is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceNucleicAcidSubunit.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceNucleicAcid = /** @class */ (function (_super) {
     ...
     */
    SubstanceNucleicAcid.CreateStrict = function (source) {
        var dest = new SubstanceNucleicAcid(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceNucleicAcid is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceNucleicAcid.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
