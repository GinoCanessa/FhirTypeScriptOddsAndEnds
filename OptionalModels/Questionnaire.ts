...
export class QuestionnaireItemEnableWhen extends fhirModels.BackboneElement implements fhirInterfaces.IQuestionnaireItemEnableWhen {
  ...
  constructor(source:Partial<fhirInterfaces.IQuestionnaireItemEnableWhen>) {
    ...
    if (source["_answerBoolean"] !== undefined) { this._answerBoolean = new fhirModels.Element(source._answerBoolean); }
    if (source["answerDecimal"] !== undefined) { this.answerDecimal = source.answerDecimal; }
    if (source["_answerDecimal"] !== undefined) { this._answerDecimal = new fhirModels.Element(source._answerDecimal); }
    if (source["answerInteger"] !== undefined) { this.answerInteger = source.answerInteger; }
    if (source["_answerInteger"] !== undefined) { this._answerInteger = new fhirModels.Element(source._answerInteger); }
    if (source["answerDate"] !== undefined) { this.answerDate = source.answerDate; }
    if (source["_answerDate"] !== undefined) { this._answerDate = new fhirModels.Element(source._answerDate); }
    if (source["answerDateTime"] !== undefined) { this.answerDateTime = source.answerDateTime; }
    if (source["_answerDateTime"] !== undefined) { this._answerDateTime = new fhirModels.Element(source._answerDateTime); }
    if (source["answerTime"] !== undefined) { this.answerTime = source.answerTime; }
    if (source["_answerTime"] !== undefined) { this._answerTime = new fhirModels.Element(source._answerTime); }
    if (source["answerString"] !== undefined) { this.answerString = source.answerString; }
    if (source["_answerString"] !== undefined) { this._answerString = new fhirModels.Element(source._answerString); }
    if (source["answerCoding"] !== undefined) { this.answerCoding = new fhirModels.Coding(source.answerCoding); }
    if (source["answerQuantity"] !== undefined) { this.answerQuantity = new fhirModels.Quantity(source.answerQuantity); }
    if (source["answerReference"] !== undefined) { this.answerReference = new fhirModels.Reference(source.answerReference); }
    ...
    if (source["question"] !== undefined) { this.question = source.question; }
    if (source["_question"] !== undefined) { this._question = new fhirModels.Element(source._question); }
  }
  /**
...
export class QuestionnaireItemAnswerOption extends fhirModels.BackboneElement implements fhirInterfaces.IQuestionnaireItemAnswerOption {
  ...
  constructor(source:Partial<fhirInterfaces.IQuestionnaireItemAnswerOption>) {
    ...
    if (source["_initialSelected"] !== undefined) { this._initialSelected = new fhirModels.Element(source._initialSelected); }
...
export class QuestionnaireItem extends fhirModels.BackboneElement implements fhirInterfaces.IQuestionnaireItem {
  ...
  constructor(source:Partial<fhirInterfaces.IQuestionnaireItem>) {
    super(source);
    if (source["answerOption"] !== undefined) { this.answerOption = source.answerOption.map((x) => new fhirModels.QuestionnaireItemAnswerOption(x)); }
    if (source["answerValueSet"] !== undefined) { this.answerValueSet = source.answerValueSet; }
    if (source["_answerValueSet"] !== undefined) { this._answerValueSet = new fhirModels.Element(source._answerValueSet); }
    ...
    if (source["_enableBehavior"] !== undefined) { this._enableBehavior = new fhirModels.Element(source._enableBehavior); }
    if (source["enableWhen"] !== undefined) { this.enableWhen = source.enableWhen.map((x) => new fhirModels.QuestionnaireItemEnableWhen(x)); }
    if (source["initial"] !== undefined) { this.initial = source.initial.map((x) => new fhirModels.QuestionnaireItemInitial(x)); }
    if (source["item"] !== undefined) { this.item = source.item.map((x) => new fhirModels.QuestionnaireItem(x)); }
    if (source["linkId"] !== undefined) { this.linkId = source.linkId; }
    if (source["_linkId"] !== undefined) { this._linkId = new fhirModels.Element(source._linkId); }
    ...
    if (source["_readOnly"] !== undefined) { this._readOnly = new fhirModels.Element(source._readOnly); }
    if (source["repeats"] !== undefined) { this.repeats = source.repeats; }
    if (source["_repeats"] !== undefined) { this._repeats = new fhirModels.Element(source._repeats); }
...
export class Questionnaire extends fhirModels.DomainResource implements fhirInterfaces.IQuestionnaire {
  ...
  constructor(source:Partial<fhirInterfaces.IQuestionnaire>) {
    ...
    if (source["derivedFrom"] !== undefined) { this.derivedFrom = source.derivedFrom.map((x) => (x)); }
    if (source["_derivedFrom"] !== undefined) { this._derivedFrom = source._derivedFrom.map((x) => new fhirModels.Element(x)); }
    ...
    if (source["subjectType"] !== undefined) { this.subjectType = source.subjectType.map((x) => (x)); }
    if (source["_subjectType"] !== undefined) { this._subjectType = source._subjectType.map((x) => new fhirModels.Element(x)); }
