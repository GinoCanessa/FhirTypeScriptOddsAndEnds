...
var Library = /** @class */ (function (_super) {
    ...
    function Library(source) {
        ...
        if (source["content"] !== undefined) {
            _this.content = source.content.map(function (x) { return new fhirModels.Attachment(x); });
        }
        ...
        if (source["parameter"] !== undefined) {
            _this.parameter = source.parameter.map(function (x) { return new fhirModels.ParameterDefinition(x); });
        }
     ...
     */
    Library.CreateStrict = function (source) {
        var dest = new Library(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Library is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Library.prototype.checkRequiredElements = function () {
        var missingElements = [];
