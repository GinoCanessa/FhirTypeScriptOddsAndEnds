...
var SpecimenDefinitionTypeTestedContainerAdditive = /** @class */ (function (_super) {
     ...
     */
    SpecimenDefinitionTypeTestedContainerAdditive.CreateStrict = function (source) {
        var dest = new SpecimenDefinitionTypeTestedContainerAdditive(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SpecimenDefinitionTypeTestedContainerAdditive is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SpecimenDefinitionTypeTestedContainerAdditive.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var SpecimenDefinitionTypeTestedContainer = /** @class */ (function (_super) {
     ...
     */
    SpecimenDefinitionTypeTestedContainer.CreateStrict = function (source) {
        var dest = new SpecimenDefinitionTypeTestedContainer(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SpecimenDefinitionTypeTestedContainer is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SpecimenDefinitionTypeTestedContainer.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SpecimenDefinitionTypeTestedHandling = /** @class */ (function (_super) {
     ...
     */
    SpecimenDefinitionTypeTestedHandling.CreateStrict = function (source) {
        var dest = new SpecimenDefinitionTypeTestedHandling(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SpecimenDefinitionTypeTestedHandling is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SpecimenDefinitionTypeTestedHandling.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SpecimenDefinitionTypeTested = /** @class */ (function (_super) {
     ...
     */
    SpecimenDefinitionTypeTested.CreateStrict = function (source) {
        var dest = new SpecimenDefinitionTypeTested(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SpecimenDefinitionTypeTested is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SpecimenDefinitionTypeTested.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var SpecimenDefinition = /** @class */ (function (_super) {
     ...
     */
    SpecimenDefinition.CreateStrict = function (source) {
        var dest = new SpecimenDefinition(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SpecimenDefinition is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SpecimenDefinition.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
