...
var ConceptMapGroupElementTargetDependsOn = /** @class */ (function (_super) {
     ...
     */
    ConceptMapGroupElementTargetDependsOn.CreateStrict = function (source) {
        var dest = new ConceptMapGroupElementTargetDependsOn(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ConceptMapGroupElementTargetDependsOn is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ConceptMapGroupElementTargetDependsOn.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ConceptMapGroupElementTarget = /** @class */ (function (_super) {
     ...
     */
    ConceptMapGroupElementTarget.CreateStrict = function (source) {
        var dest = new ConceptMapGroupElementTarget(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ConceptMapGroupElementTarget is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ConceptMapGroupElementTarget.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ConceptMapGroupElement = /** @class */ (function (_super) {
     ...
     */
    ConceptMapGroupElement.CreateStrict = function (source) {
        var dest = new ConceptMapGroupElement(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ConceptMapGroupElement is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ConceptMapGroupElement.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var ConceptMapGroupUnmapped = /** @class */ (function (_super) {
     ...
     */
    ConceptMapGroupUnmapped.CreateStrict = function (source) {
        var dest = new ConceptMapGroupUnmapped(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ConceptMapGroupUnmapped is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ConceptMapGroupUnmapped.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ConceptMapGroup = /** @class */ (function (_super) {
     ...
     */
    ConceptMapGroup.CreateStrict = function (source) {
        var dest = new ConceptMapGroup(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ConceptMapGroup is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ConceptMapGroup.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ConceptMap = /** @class */ (function (_super) {
     ...
     */
    ConceptMap.CreateStrict = function (source) {
        var dest = new ConceptMap(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ConceptMap is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ConceptMap.prototype.checkRequiredElements = function () {
        var missingElements = [];
