...
var VisionPrescriptionLensSpecificationPrism = /** @class */ (function (_super) {
     ...
     */
    VisionPrescriptionLensSpecificationPrism.CreateStrict = function (source) {
        var dest = new VisionPrescriptionLensSpecificationPrism(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "VisionPrescriptionLensSpecificationPrism is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    VisionPrescriptionLensSpecificationPrism.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var VisionPrescriptionLensSpecification = /** @class */ (function (_super) {
     ...
     */
    VisionPrescriptionLensSpecification.CreateStrict = function (source) {
        var dest = new VisionPrescriptionLensSpecification(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "VisionPrescriptionLensSpecification is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    VisionPrescriptionLensSpecification.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var VisionPrescription = /** @class */ (function (_super) {
    ...
    function VisionPrescription(source) {
        ...
        if (source["lensSpecification"] !== undefined) {
        ...
        if (source["prescriber"] !== undefined) {
     ...
     */
    VisionPrescription.CreateStrict = function (source) {
        var dest = new VisionPrescription(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "VisionPrescription is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    VisionPrescription.prototype.checkRequiredElements = function () {
        var missingElements = [];
        ...
        if ((this["lensSpecification"] === undefined) || (this["lensSpecification"].length === 0)) {
