...
export class TestReportSetupActionOperation extends fhirModels.BackboneElement implements fhirInterfaces.ITestReportSetupActionOperation {
  ...
  constructor(source:Partial<fhirInterfaces.ITestReportSetupActionOperation>) {
    ...
    if (source["_result"] !== undefined) { this._result = new fhirModels.Element(source._result); }
  }
  /**
...
export class TestReportSetupAction extends fhirModels.BackboneElement implements fhirInterfaces.ITestReportSetupAction {
  ...
  constructor(source:Partial<fhirInterfaces.ITestReportSetupAction>) {
    super(source);
    if (source["assert"] !== undefined) { this.assert = new fhirModels.TestReportSetupActionAssert(source.assert); }
    if (source["operation"] !== undefined) { this.operation = new fhirModels.TestReportSetupActionOperation(source.operation); }
  }
  /**
...
export class TestReportSetup extends fhirModels.BackboneElement implements fhirInterfaces.ITestReportSetup {
  ...
  constructor(source:Partial<fhirInterfaces.ITestReportSetup>) {
    super(source);
    if (source["action"] !== undefined) { this.action = source.action.map((x) => new fhirModels.TestReportSetupAction(x)); }
  }
  /**
...
export class TestReportTest extends fhirModels.BackboneElement implements fhirInterfaces.ITestReportTest {
  ...
  constructor(source:Partial<fhirInterfaces.ITestReportTest>) {
    super(source);
    if (source["action"] !== undefined) { this.action = source.action.map((x) => new fhirModels.TestReportTestAction(x)); }
...
export class TestReportTeardown extends fhirModels.BackboneElement implements fhirInterfaces.ITestReportTeardown {
  ...
  constructor(source:Partial<fhirInterfaces.ITestReportTeardown>) {
    super(source);
    if (source["action"] !== undefined) { this.action = source.action.map((x) => new fhirModels.TestReportTeardownAction(x)); }
  }
  /**
...
export class TestReport extends fhirModels.DomainResource implements fhirInterfaces.ITestReport {
  ...
  constructor(source:Partial<fhirInterfaces.ITestReport>) {
    ...
    if (source["name"] !== undefined) { this.name = source.name; }
    if (source["_name"] !== undefined) { this._name = new fhirModels.Element(source._name); }
    if (source["participant"] !== undefined) { this.participant = source.participant.map((x) => new fhirModels.TestReportParticipant(x)); }
    if (source["result"] !== undefined) { this.result = source.result; }
    if (source["_result"] !== undefined) { this._result = new fhirModels.Element(source._result); }
    ...
    if (source["setup"] !== undefined) { this.setup = new fhirModels.TestReportSetup(source.setup); }
    if (source["status"] !== undefined) { this.status = source.status; }
    if (source["_status"] !== undefined) { this._status = new fhirModels.Element(source._status); }
    if (source["teardown"] !== undefined) { this.teardown = new fhirModels.TestReportTeardown(source.teardown); }
    if (source["test"] !== undefined) { this.test = source.test.map((x) => new fhirModels.TestReportTest(x)); }
    if (source["tester"] !== undefined) { this.tester = source.tester; }
    if (source["_tester"] !== undefined) { this._tester = new fhirModels.Element(source._tester); }
    if (source["testScript"] !== undefined) { this.testScript = new fhirModels.Reference(source.testScript); }
  }
  /**
