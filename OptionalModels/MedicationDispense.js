...
var MedicationDispensePerformer = /** @class */ (function (_super) {
     ...
     */
    MedicationDispensePerformer.CreateStrict = function (source) {
        var dest = new MedicationDispensePerformer(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationDispensePerformer is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationDispensePerformer.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var MedicationDispenseSubstitution = /** @class */ (function (_super) {
     ...
     */
    MedicationDispenseSubstitution.CreateStrict = function (source) {
        var dest = new MedicationDispenseSubstitution(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationDispenseSubstitution is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationDispenseSubstitution.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var MedicationDispense = /** @class */ (function (_super) {
     ...
     */
    MedicationDispense.CreateStrict = function (source) {
        var dest = new MedicationDispense(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationDispense is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationDispense.prototype.checkRequiredElements = function () {
        var missingElements = [];
