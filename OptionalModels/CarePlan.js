...
var CarePlanActivityDetail = /** @class */ (function (_super) {
     ...
     */
    CarePlanActivityDetail.CreateStrict = function (source) {
        var dest = new CarePlanActivityDetail(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "CarePlanActivityDetail is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    CarePlanActivityDetail.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var CarePlanActivity = /** @class */ (function (_super) {
     ...
     */
    CarePlanActivity.CreateStrict = function (source) {
        var dest = new CarePlanActivity(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "CarePlanActivity is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    CarePlanActivity.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var CarePlan = /** @class */ (function (_super) {
     ...
     */
    CarePlan.CreateStrict = function (source) {
        var dest = new CarePlan(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "CarePlan is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    CarePlan.prototype.checkRequiredElements = function () {
        var missingElements = [];
