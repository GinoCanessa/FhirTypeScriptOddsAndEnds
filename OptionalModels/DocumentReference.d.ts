 ...
 */
export declare class DocumentReferenceRelatesTo extends fhirModels.BackboneElement implements fhirInterfaces.IDocumentReferenceRelatesTo {
    /**
     * If this document appends another document, then the document cannot be fully understood without also accessing the referenced document.
     */
    code?: DocumentReferenceRelatesToCodeEnum | undefined;
     ...
     */
    constructor(source: Partial<fhirInterfaces.IDocumentReferenceRelatesTo>);
    /**
     * Factory function to create a DocumentReferenceRelatesTo from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IDocumentReferenceRelatesTo): DocumentReferenceRelatesTo;
    /**
 ...
 */
export declare class DocumentReferenceContent extends fhirModels.BackboneElement implements fhirInterfaces.IDocumentReferenceContent {
    /**
 ...
 */
export declare class DocumentReferenceContext extends fhirModels.BackboneElement implements fhirInterfaces.IDocumentReferenceContext {
    /**
     ...
     */
    facilityType?: fhirModels.CodeableConcept | undefined;
    /**
     ...
     */
    practiceSetting?: fhirModels.CodeableConcept | undefined;
    /**
     * May be identifiers or resources that caused the DocumentReference or referenced Document to be created.
     */
    related?: fhirModels.Reference[] | undefined;
    /**
     * The Patient Information as known when the document was published. May be a reference to a version specific, or contained.
     */
    sourcePatientInfo?: fhirModels.Reference | undefined;
    /**
     * Default constructor for DocumentReferenceContext from an object that MAY NOT contain all required elements.
     */
    constructor(source: Partial<fhirInterfaces.IDocumentReferenceContext>);
    /**
     * Factory function to create a DocumentReferenceContext from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IDocumentReferenceContext): DocumentReferenceContext;
    /**
 ...
 */
export declare class DocumentReference extends fhirModels.DomainResource implements fhirInterfaces.IDocumentReference {
    /**
     * Resource Type Name
     */
     ...
     */
    authenticator?: fhirModels.Reference | undefined;
    /**
     ...
     * The document and format referenced. There may be multiple content element repetitions, each with a different format.
     */
    content?: fhirModels.DocumentReferenceContent[] | undefined;
    /**
     * These values are primarily added to help with searching for interesting/relevant documents.
     */
    context?: fhirModels.DocumentReferenceContext | undefined;
    /**
    ...
    _docStatus?: fhirModels.Element | undefined;
    /**
     ...
     * This element is labeled as a modifier because documents that append to other documents are incomplete on their own.
     */
    relatesTo?: fhirModels.DocumentReferenceRelatesTo[] | undefined;
    /**
     ...
     */
    securityLabel?: fhirModels.CodeableConcept[] | undefined;
    /**
     * This is the status of the DocumentReference object, which might be independent from the docStatus element.
     * This element is labeled as a modifier because the status contains the codes that mark the document or reference as not currently valid.
     */
    status?: DocumentReferenceStatusEnum | undefined;
     ...
     */
    constructor(source: Partial<fhirInterfaces.IDocumentReference>);
    /**
     * Factory function to create a DocumentReference from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IDocumentReference): DocumentReference;
    /**
