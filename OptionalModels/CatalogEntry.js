...
var CatalogEntryRelatedEntry = /** @class */ (function (_super) {
     ...
     */
    CatalogEntryRelatedEntry.CreateStrict = function (source) {
        var dest = new CatalogEntryRelatedEntry(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "CatalogEntryRelatedEntry is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    CatalogEntryRelatedEntry.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var CatalogEntry = /** @class */ (function (_super) {
     ...
     */
    CatalogEntry.CreateStrict = function (source) {
        var dest = new CatalogEntry(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "CatalogEntry is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    CatalogEntry.prototype.checkRequiredElements = function () {
        var missingElements = [];
