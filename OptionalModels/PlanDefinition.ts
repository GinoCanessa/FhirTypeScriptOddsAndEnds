...
export class PlanDefinitionGoalTarget extends fhirModels.BackboneElement implements fhirInterfaces.IPlanDefinitionGoalTarget {
  ...
  constructor(source:Partial<fhirInterfaces.IPlanDefinitionGoalTarget>) {
    ...
    if (source["due"] !== undefined) { this.due = new fhirModels.Duration(source.due); }
...
export class PlanDefinitionGoal extends fhirModels.BackboneElement implements fhirInterfaces.IPlanDefinitionGoal {
  ...
  constructor(source:Partial<fhirInterfaces.IPlanDefinitionGoal>) {
    super(source);
    if (source["addresses"] !== undefined) { this.addresses = source.addresses.map((x) => new fhirModels.CodeableConcept(x)); }
    ...
    if (source["start"] !== undefined) { this.start = new fhirModels.CodeableConcept(source.start); }
    if (source["target"] !== undefined) { this.target = source.target.map((x) => new fhirModels.PlanDefinitionGoalTarget(x)); }
  }
  /**
...
export class PlanDefinitionAction extends fhirModels.BackboneElement implements fhirInterfaces.IPlanDefinitionAction {
  ...
  constructor(source:Partial<fhirInterfaces.IPlanDefinitionAction>) {
    super(source);
    if (source["action"] !== undefined) { this.action = source.action.map((x) => new fhirModels.PlanDefinitionAction(x)); }
    ...
    if (source["condition"] !== undefined) { this.condition = source.condition.map((x) => new fhirModels.PlanDefinitionActionCondition(x)); }
    ...
    if (source["_definitionUri"] !== undefined) { this._definitionUri = new fhirModels.Element(source._definitionUri); }
    ...
    if (source["documentation"] !== undefined) { this.documentation = source.documentation.map((x) => new fhirModels.RelatedArtifact(x)); }
    if (source["dynamicValue"] !== undefined) { this.dynamicValue = source.dynamicValue.map((x) => new fhirModels.PlanDefinitionActionDynamicValue(x)); }
    if (source["goalId"] !== undefined) { this.goalId = source.goalId.map((x) => (x)); }
    if (source["_goalId"] !== undefined) { this._goalId = source._goalId.map((x) => new fhirModels.Element(x)); }
    ...
    if (source["input"] !== undefined) { this.input = source.input.map((x) => new fhirModels.DataRequirement(x)); }
    if (source["output"] !== undefined) { this.output = source.output.map((x) => new fhirModels.DataRequirement(x)); }
    if (source["participant"] !== undefined) { this.participant = source.participant.map((x) => new fhirModels.PlanDefinitionActionParticipant(x)); }
    ...
    if (source["relatedAction"] !== undefined) { this.relatedAction = source.relatedAction.map((x) => new fhirModels.PlanDefinitionActionRelatedAction(x)); }
...
export class PlanDefinition extends fhirModels.DomainResource implements fhirInterfaces.IPlanDefinition {
  ...
  constructor(source:Partial<fhirInterfaces.IPlanDefinition>) {
    ...
    if (source["goal"] !== undefined) { this.goal = source.goal.map((x) => new fhirModels.PlanDefinitionGoal(x)); }
