...
var AdverseEventSuspectEntityCausality = /** @class */ (function (_super) {
     ...
     */
    AdverseEventSuspectEntityCausality.CreateStrict = function (source) {
        var dest = new AdverseEventSuspectEntityCausality(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "AdverseEventSuspectEntityCausality is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    AdverseEventSuspectEntityCausality.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var AdverseEventSuspectEntity = /** @class */ (function (_super) {
     ...
     */
    AdverseEventSuspectEntity.CreateStrict = function (source) {
        var dest = new AdverseEventSuspectEntity(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "AdverseEventSuspectEntity is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    AdverseEventSuspectEntity.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var AdverseEvent = /** @class */ (function (_super) {
     ...
     */
    AdverseEvent.CreateStrict = function (source) {
        var dest = new AdverseEvent(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "AdverseEvent is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    AdverseEvent.prototype.checkRequiredElements = function () {
        var missingElements = [];
