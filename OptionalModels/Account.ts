...
export class AccountGuarantor extends fhirModels.BackboneElement implements fhirInterfaces.IAccountGuarantor {
  ...
  constructor(source:Partial<fhirInterfaces.IAccountGuarantor>) {
    ...
    if (source["_onHold"] !== undefined) { this._onHold = new fhirModels.Element(source._onHold); }
...
export class Account extends fhirModels.DomainResource implements fhirInterfaces.IAccount {
  ...
  constructor(source:Partial<fhirInterfaces.IAccount>) {
    ...
    if (source["coverage"] !== undefined) { this.coverage = source.coverage.map((x) => new fhirModels.AccountCoverage(x)); }
    ...
    if (source["guarantor"] !== undefined) { this.guarantor = source.guarantor.map((x) => new fhirModels.AccountGuarantor(x)); }
    ...
    if (source["servicePeriod"] !== undefined) { this.servicePeriod = new fhirModels.Period(source.servicePeriod); }
