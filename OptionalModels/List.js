...
var ListEntry = /** @class */ (function (_super) {
     ...
     */
    ListEntry.CreateStrict = function (source) {
        var dest = new ListEntry(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ListEntry is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ListEntry.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var List = /** @class */ (function (_super) {
     ...
     */
    List.CreateStrict = function (source) {
        var dest = new List(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "List is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    List.prototype.checkRequiredElements = function () {
        var missingElements = [];
