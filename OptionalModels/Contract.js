...
var ContractContentDefinition = /** @class */ (function (_super) {
     ...
     */
    ContractContentDefinition.CreateStrict = function (source) {
        var dest = new ContractContentDefinition(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractContentDefinition is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractContentDefinition.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ContractTermSecurityLabel = /** @class */ (function (_super) {
     ...
     */
    ContractTermSecurityLabel.CreateStrict = function (source) {
        var dest = new ContractTermSecurityLabel(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractTermSecurityLabel is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractTermSecurityLabel.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ContractTermOfferParty = /** @class */ (function (_super) {
     ...
     */
    ContractTermOfferParty.CreateStrict = function (source) {
        var dest = new ContractTermOfferParty(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractTermOfferParty is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractTermOfferParty.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ContractTermOfferAnswer = /** @class */ (function (_super) {
     ...
     */
    ContractTermOfferAnswer.CreateStrict = function (source) {
        var dest = new ContractTermOfferAnswer(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractTermOfferAnswer is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractTermOfferAnswer.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var ContractTermOffer = /** @class */ (function (_super) {
     ...
     */
    ContractTermOffer.CreateStrict = function (source) {
        var dest = new ContractTermOffer(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractTermOffer is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractTermOffer.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var ContractTermAssetContext = /** @class */ (function (_super) {
     ...
     */
    ContractTermAssetContext.CreateStrict = function (source) {
        var dest = new ContractTermAssetContext(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractTermAssetContext is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractTermAssetContext.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var ContractTermAssetValuedItem = /** @class */ (function (_super) {
     ...
     */
    ContractTermAssetValuedItem.CreateStrict = function (source) {
        var dest = new ContractTermAssetValuedItem(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractTermAssetValuedItem is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractTermAssetValuedItem.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var ContractTermAsset = /** @class */ (function (_super) {
     ...
     */
    ContractTermAsset.CreateStrict = function (source) {
        var dest = new ContractTermAsset(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractTermAsset is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractTermAsset.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var ContractTermActionSubject = /** @class */ (function (_super) {
     ...
     */
    ContractTermActionSubject.CreateStrict = function (source) {
        var dest = new ContractTermActionSubject(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractTermActionSubject is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractTermActionSubject.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if ((this["reference"] === undefined) || (this["reference"].length === 0)) {
            missingElements.push("reference");
        }
...
var ContractTermAction = /** @class */ (function (_super) {
     ...
     */
    ContractTermAction.CreateStrict = function (source) {
        var dest = new ContractTermAction(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractTermAction is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractTermAction.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ContractTerm = /** @class */ (function (_super) {
     ...
     */
    ContractTerm.CreateStrict = function (source) {
        var dest = new ContractTerm(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractTerm is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractTerm.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ContractSigner = /** @class */ (function (_super) {
     ...
     */
    ContractSigner.CreateStrict = function (source) {
        var dest = new ContractSigner(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractSigner is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractSigner.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ContractFriendly = /** @class */ (function (_super) {
     ...
     */
    ContractFriendly.CreateStrict = function (source) {
        var dest = new ContractFriendly(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractFriendly is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractFriendly.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var ContractLegal = /** @class */ (function (_super) {
     ...
     */
    ContractLegal.CreateStrict = function (source) {
        var dest = new ContractLegal(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractLegal is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractLegal.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var ContractRule = /** @class */ (function (_super) {
     ...
     */
    ContractRule.CreateStrict = function (source) {
        var dest = new ContractRule(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContractRule is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContractRule.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var Contract = /** @class */ (function (_super) {
     ...
     */
    Contract.CreateStrict = function (source) {
        var dest = new Contract(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Contract is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Contract.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
