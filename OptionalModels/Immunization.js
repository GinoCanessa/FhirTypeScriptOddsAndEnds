...
var ImmunizationPerformer = /** @class */ (function (_super) {
     ...
     */
    ImmunizationPerformer.CreateStrict = function (source) {
        var dest = new ImmunizationPerformer(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ImmunizationPerformer is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ImmunizationPerformer.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ImmunizationEducation = /** @class */ (function (_super) {
     ...
     */
    ImmunizationEducation.CreateStrict = function (source) {
        var dest = new ImmunizationEducation(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ImmunizationEducation is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ImmunizationEducation.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var ImmunizationReaction = /** @class */ (function (_super) {
     ...
     */
    ImmunizationReaction.CreateStrict = function (source) {
        var dest = new ImmunizationReaction(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ImmunizationReaction is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ImmunizationReaction.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var ImmunizationProtocolApplied = /** @class */ (function (_super) {
     ...
     */
    ImmunizationProtocolApplied.CreateStrict = function (source) {
        var dest = new ImmunizationProtocolApplied(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ImmunizationProtocolApplied is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ImmunizationProtocolApplied.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var Immunization = /** @class */ (function (_super) {
     ...
     */
    Immunization.CreateStrict = function (source) {
        var dest = new Immunization(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Immunization is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Immunization.prototype.checkRequiredElements = function () {
        var missingElements = [];
