...
var OrganizationAffiliation = /** @class */ (function (_super) {
     ...
     */
    OrganizationAffiliation.CreateStrict = function (source) {
        var dest = new OrganizationAffiliation(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "OrganizationAffiliation is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    OrganizationAffiliation.prototype.checkRequiredElements = function () {
        var missingElements = [];
