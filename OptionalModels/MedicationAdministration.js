...
var MedicationAdministrationPerformer = /** @class */ (function (_super) {
     ...
     */
    MedicationAdministrationPerformer.CreateStrict = function (source) {
        var dest = new MedicationAdministrationPerformer(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationAdministrationPerformer is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationAdministrationPerformer.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var MedicationAdministrationDosage = /** @class */ (function (_super) {
     ...
     */
    MedicationAdministrationDosage.CreateStrict = function (source) {
        var dest = new MedicationAdministrationDosage(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationAdministrationDosage is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationAdministrationDosage.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var MedicationAdministration = /** @class */ (function (_super) {
     ...
     */
    MedicationAdministration.CreateStrict = function (source) {
        var dest = new MedicationAdministration(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationAdministration is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationAdministration.prototype.checkRequiredElements = function () {
        var missingElements = [];
