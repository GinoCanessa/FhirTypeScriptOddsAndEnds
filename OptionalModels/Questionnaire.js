...
var QuestionnaireItemEnableWhen = /** @class */ (function (_super) {
     ...
     */
    QuestionnaireItemEnableWhen.CreateStrict = function (source) {
        var dest = new QuestionnaireItemEnableWhen(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "QuestionnaireItemEnableWhen is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    QuestionnaireItemEnableWhen.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var QuestionnaireItemAnswerOption = /** @class */ (function (_super) {
     ...
     */
    QuestionnaireItemAnswerOption.CreateStrict = function (source) {
        var dest = new QuestionnaireItemAnswerOption(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "QuestionnaireItemAnswerOption is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    QuestionnaireItemAnswerOption.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var QuestionnaireItemInitial = /** @class */ (function (_super) {
     ...
     */
    QuestionnaireItemInitial.CreateStrict = function (source) {
        var dest = new QuestionnaireItemInitial(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "QuestionnaireItemInitial is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    QuestionnaireItemInitial.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var QuestionnaireItem = /** @class */ (function (_super) {
     ...
     */
    QuestionnaireItem.CreateStrict = function (source) {
        var dest = new QuestionnaireItem(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "QuestionnaireItem is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    QuestionnaireItem.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var Questionnaire = /** @class */ (function (_super) {
     ...
     */
    Questionnaire.CreateStrict = function (source) {
        var dest = new Questionnaire(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Questionnaire is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Questionnaire.prototype.checkRequiredElements = function () {
        var missingElements = [];
