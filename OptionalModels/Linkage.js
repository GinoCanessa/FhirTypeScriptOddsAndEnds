...
var LinkageItem = /** @class */ (function (_super) {
     ...
     */
    LinkageItem.CreateStrict = function (source) {
        var dest = new LinkageItem(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "LinkageItem is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    LinkageItem.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var Linkage = /** @class */ (function (_super) {
     ...
     */
    Linkage.CreateStrict = function (source) {
        var dest = new Linkage(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Linkage is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Linkage.prototype.checkRequiredElements = function () {
        var missingElements = [];
