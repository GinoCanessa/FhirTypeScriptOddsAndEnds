...
var EvidenceVariableCharacteristic = /** @class */ (function (_super) {
     ...
     */
    EvidenceVariableCharacteristic.CreateStrict = function (source) {
        var dest = new EvidenceVariableCharacteristic(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "EvidenceVariableCharacteristic is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    EvidenceVariableCharacteristic.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var EvidenceVariable = /** @class */ (function (_super) {
     ...
     */
    EvidenceVariable.CreateStrict = function (source) {
        var dest = new EvidenceVariable(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "EvidenceVariable is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    EvidenceVariable.prototype.checkRequiredElements = function () {
        var missingElements = [];
