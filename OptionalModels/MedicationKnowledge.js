...
var MedicationKnowledgeRelatedMedicationKnowledge = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeRelatedMedicationKnowledge.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeRelatedMedicationKnowledge(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeRelatedMedicationKnowledge is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeRelatedMedicationKnowledge.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var MedicationKnowledgeMonograph = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeMonograph.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeMonograph(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeMonograph is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeMonograph.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var MedicationKnowledgeIngredient = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeIngredient.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeIngredient(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeIngredient is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeIngredient.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var MedicationKnowledgeCost = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeCost.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeCost(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeCost is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeCost.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var MedicationKnowledgeMonitoringProgram = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeMonitoringProgram.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeMonitoringProgram(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeMonitoringProgram is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeMonitoringProgram.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var MedicationKnowledgeAdministrationGuidelinesDosage = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeAdministrationGuidelinesDosage.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeAdministrationGuidelinesDosage(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeAdministrationGuidelinesDosage is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeAdministrationGuidelinesDosage.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if ((this["dosage"] === undefined) || (this["dosage"].length === 0)) {
...
var MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var MedicationKnowledgeAdministrationGuidelines = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeAdministrationGuidelines.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeAdministrationGuidelines(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeAdministrationGuidelines is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeAdministrationGuidelines.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var MedicationKnowledgeMedicineClassification = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeMedicineClassification.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeMedicineClassification(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeMedicineClassification is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeMedicineClassification.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if (this["type"] === undefined) {
            missingElements.push("type");
        }
...
var MedicationKnowledgePackaging = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgePackaging.CreateStrict = function (source) {
        var dest = new MedicationKnowledgePackaging(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgePackaging is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgePackaging.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var MedicationKnowledgeDrugCharacteristic = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeDrugCharacteristic.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeDrugCharacteristic(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeDrugCharacteristic is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeDrugCharacteristic.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var MedicationKnowledgeRegulatorySubstitution = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeRegulatorySubstitution.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeRegulatorySubstitution(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeRegulatorySubstitution is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeRegulatorySubstitution.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var MedicationKnowledgeRegulatorySchedule = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeRegulatorySchedule.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeRegulatorySchedule(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeRegulatorySchedule is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeRegulatorySchedule.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var MedicationKnowledgeRegulatoryMaxDispense = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeRegulatoryMaxDispense.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeRegulatoryMaxDispense(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeRegulatoryMaxDispense is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeRegulatoryMaxDispense.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var MedicationKnowledgeRegulatory = /** @class */ (function (_super) {
    ...
    function MedicationKnowledgeRegulatory(source) {
        ...
        if (source["regulatoryAuthority"] !== undefined) {
     ...
     */
    MedicationKnowledgeRegulatory.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeRegulatory(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeRegulatory is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeRegulatory.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var MedicationKnowledgeKinetics = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledgeKinetics.CreateStrict = function (source) {
        var dest = new MedicationKnowledgeKinetics(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledgeKinetics is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledgeKinetics.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var MedicationKnowledge = /** @class */ (function (_super) {
     ...
     */
    MedicationKnowledge.CreateStrict = function (source) {
        var dest = new MedicationKnowledge(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MedicationKnowledge is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MedicationKnowledge.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
