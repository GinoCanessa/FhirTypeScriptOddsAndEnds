...
var CompartmentDefinitionResource = /** @class */ (function (_super) {
     ...
     */
    CompartmentDefinitionResource.CreateStrict = function (source) {
        var dest = new CompartmentDefinitionResource(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "CompartmentDefinitionResource is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    CompartmentDefinitionResource.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var CompartmentDefinition = /** @class */ (function (_super) {
     ...
     */
    CompartmentDefinition.CreateStrict = function (source) {
        var dest = new CompartmentDefinition(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "CompartmentDefinition is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    CompartmentDefinition.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if (this["code"] === undefined) {
            missingElements.push("code");
        }
