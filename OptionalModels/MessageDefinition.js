...
var MessageDefinitionFocus = /** @class */ (function (_super) {
     ...
     */
    MessageDefinitionFocus.CreateStrict = function (source) {
        var dest = new MessageDefinitionFocus(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MessageDefinitionFocus is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MessageDefinitionFocus.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var MessageDefinitionAllowedResponse = /** @class */ (function (_super) {
     ...
     */
    MessageDefinitionAllowedResponse.CreateStrict = function (source) {
        var dest = new MessageDefinitionAllowedResponse(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MessageDefinitionAllowedResponse is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MessageDefinitionAllowedResponse.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var MessageDefinition = /** @class */ (function (_super) {
     ...
     */
    MessageDefinition.CreateStrict = function (source) {
        var dest = new MessageDefinition(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MessageDefinition is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MessageDefinition.prototype.checkRequiredElements = function () {
        var missingElements = [];
