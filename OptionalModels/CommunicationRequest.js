...
var CommunicationRequestPayload = /** @class */ (function (_super) {
     ...
     */
    CommunicationRequestPayload.CreateStrict = function (source) {
        var dest = new CommunicationRequestPayload(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "CommunicationRequestPayload is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    CommunicationRequestPayload.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var CommunicationRequest = /** @class */ (function (_super) {
     ...
     */
    CommunicationRequest.CreateStrict = function (source) {
        var dest = new CommunicationRequest(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "CommunicationRequest is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    CommunicationRequest.prototype.checkRequiredElements = function () {
        var missingElements = [];
