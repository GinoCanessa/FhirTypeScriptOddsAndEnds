...
var TestScriptOrigin = /** @class */ (function (_super) {
     ...
     */
    TestScriptOrigin.CreateStrict = function (source) {
        var dest = new TestScriptOrigin(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptOrigin is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptOrigin.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var TestScriptDestination = /** @class */ (function (_super) {
     ...
     */
    TestScriptDestination.CreateStrict = function (source) {
        var dest = new TestScriptDestination(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptDestination is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptDestination.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if (this["index"] === undefined) {
            missingElements.push("index");
        }
...
var TestScriptMetadataLink = /** @class */ (function (_super) {
     ...
     */
    TestScriptMetadataLink.CreateStrict = function (source) {
        var dest = new TestScriptMetadataLink(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptMetadataLink is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptMetadataLink.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var TestScriptMetadataCapability = /** @class */ (function (_super) {
     ...
     */
    TestScriptMetadataCapability.CreateStrict = function (source) {
        var dest = new TestScriptMetadataCapability(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptMetadataCapability is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptMetadataCapability.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var TestScriptMetadata = /** @class */ (function (_super) {
     ...
     */
    TestScriptMetadata.CreateStrict = function (source) {
        var dest = new TestScriptMetadata(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptMetadata is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptMetadata.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var TestScriptFixture = /** @class */ (function (_super) {
     ...
     */
    TestScriptFixture.CreateStrict = function (source) {
        var dest = new TestScriptFixture(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptFixture is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptFixture.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var TestScriptVariable = /** @class */ (function (_super) {
     ...
     */
    TestScriptVariable.CreateStrict = function (source) {
        var dest = new TestScriptVariable(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptVariable is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptVariable.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var TestScriptSetupActionOperationRequestHeader = /** @class */ (function (_super) {
     ...
     */
    TestScriptSetupActionOperationRequestHeader.CreateStrict = function (source) {
        var dest = new TestScriptSetupActionOperationRequestHeader(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptSetupActionOperationRequestHeader is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptSetupActionOperationRequestHeader.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var TestScriptSetupActionOperation = /** @class */ (function (_super) {
     ...
     */
    TestScriptSetupActionOperation.CreateStrict = function (source) {
        var dest = new TestScriptSetupActionOperation(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptSetupActionOperation is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptSetupActionOperation.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var TestScriptSetupActionAssert = /** @class */ (function (_super) {
     ...
     */
    TestScriptSetupActionAssert.CreateStrict = function (source) {
        var dest = new TestScriptSetupActionAssert(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptSetupActionAssert is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptSetupActionAssert.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var TestScriptSetupAction = /** @class */ (function (_super) {
     ...
     */
    TestScriptSetupAction.CreateStrict = function (source) {
        var dest = new TestScriptSetupAction(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptSetupAction is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptSetupAction.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var TestScriptSetup = /** @class */ (function (_super) {
     ...
     */
    TestScriptSetup.CreateStrict = function (source) {
        var dest = new TestScriptSetup(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptSetup is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptSetup.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var TestScriptTestAction = /** @class */ (function (_super) {
     ...
     */
    TestScriptTestAction.CreateStrict = function (source) {
        var dest = new TestScriptTestAction(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptTestAction is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptTestAction.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var TestScriptTest = /** @class */ (function (_super) {
     ...
     */
    TestScriptTest.CreateStrict = function (source) {
        var dest = new TestScriptTest(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptTest is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptTest.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if ((this["action"] === undefined) || (this["action"].length === 0)) {
            missingElements.push("action");
        }
...
var TestScriptTeardownAction = /** @class */ (function (_super) {
     ...
     */
    TestScriptTeardownAction.CreateStrict = function (source) {
        var dest = new TestScriptTeardownAction(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptTeardownAction is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptTeardownAction.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var TestScriptTeardown = /** @class */ (function (_super) {
     ...
     */
    TestScriptTeardown.CreateStrict = function (source) {
        var dest = new TestScriptTeardown(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScriptTeardown is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScriptTeardown.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if ((this["action"] === undefined) || (this["action"].length === 0)) {
            missingElements.push("action");
        }
...
var TestScript = /** @class */ (function (_super) {
     ...
     */
    TestScript.CreateStrict = function (source) {
        var dest = new TestScript(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "TestScript is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    TestScript.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if (this["name"] === undefined) {
            missingElements.push("name");
        }
