...
var StructureMapStructure = /** @class */ (function (_super) {
     ...
     */
    StructureMapStructure.CreateStrict = function (source) {
        var dest = new StructureMapStructure(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "StructureMapStructure is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    StructureMapStructure.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var StructureMapGroupInput = /** @class */ (function (_super) {
     ...
     */
    StructureMapGroupInput.CreateStrict = function (source) {
        var dest = new StructureMapGroupInput(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "StructureMapGroupInput is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    StructureMapGroupInput.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if (this["mode"] === undefined) {
            missingElements.push("mode");
        }
...
var StructureMapGroupRuleSource = /** @class */ (function (_super) {
     ...
     */
    StructureMapGroupRuleSource.CreateStrict = function (source) {
        var dest = new StructureMapGroupRuleSource(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "StructureMapGroupRuleSource is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    StructureMapGroupRuleSource.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var StructureMapGroupRuleTargetParameter = /** @class */ (function (_super) {
     ...
     */
    StructureMapGroupRuleTargetParameter.CreateStrict = function (source) {
        var dest = new StructureMapGroupRuleTargetParameter(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "StructureMapGroupRuleTargetParameter is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    StructureMapGroupRuleTargetParameter.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var StructureMapGroupRuleTarget = /** @class */ (function (_super) {
     ...
     */
    StructureMapGroupRuleTarget.CreateStrict = function (source) {
        var dest = new StructureMapGroupRuleTarget(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "StructureMapGroupRuleTarget is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    StructureMapGroupRuleTarget.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var StructureMapGroupRuleDependent = /** @class */ (function (_super) {
     ...
     */
    StructureMapGroupRuleDependent.CreateStrict = function (source) {
        var dest = new StructureMapGroupRuleDependent(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "StructureMapGroupRuleDependent is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    StructureMapGroupRuleDependent.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if (this["name"] === undefined) {
            missingElements.push("name");
        }
        if ((this["variable"] === undefined) || (this["variable"].length === 0)) {
...
var StructureMapGroupRule = /** @class */ (function (_super) {
     ...
     */
    StructureMapGroupRule.CreateStrict = function (source) {
        var dest = new StructureMapGroupRule(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "StructureMapGroupRule is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    StructureMapGroupRule.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if (this["name"] === undefined) {
            missingElements.push("name");
        }
...
var StructureMapGroup = /** @class */ (function (_super) {
     ...
     */
    StructureMapGroup.CreateStrict = function (source) {
        var dest = new StructureMapGroup(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "StructureMapGroup is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    StructureMapGroup.prototype.checkRequiredElements = function () {
        var missingElements = [];
        ...
        if ((this["rule"] === undefined) || (this["rule"].length === 0)) {
...
var StructureMap = /** @class */ (function (_super) {
     ...
     */
    StructureMap.CreateStrict = function (source) {
        var dest = new StructureMap(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "StructureMap is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    StructureMap.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if ((this["group"] === undefined) || (this["group"].length === 0)) {
