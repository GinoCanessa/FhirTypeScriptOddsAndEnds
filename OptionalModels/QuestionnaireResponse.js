...
var QuestionnaireResponseItemAnswer = /** @class */ (function (_super) {
     ...
     */
    QuestionnaireResponseItemAnswer.CreateStrict = function (source) {
        var dest = new QuestionnaireResponseItemAnswer(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "QuestionnaireResponseItemAnswer is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    QuestionnaireResponseItemAnswer.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var QuestionnaireResponseItem = /** @class */ (function (_super) {
     ...
     */
    QuestionnaireResponseItem.CreateStrict = function (source) {
        var dest = new QuestionnaireResponseItem(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "QuestionnaireResponseItem is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    QuestionnaireResponseItem.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var QuestionnaireResponse = /** @class */ (function (_super) {
     ...
     */
    QuestionnaireResponse.CreateStrict = function (source) {
        var dest = new QuestionnaireResponse(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "QuestionnaireResponse is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    QuestionnaireResponse.prototype.checkRequiredElements = function () {
        var missingElements = [];
