...
export declare class QuestionnaireResponseItemAnswer extends fhirModels.BackboneElement implements fhirInterfaces.IQuestionnaireResponseItemAnswer {
     ...
     */
    constructor(source: Partial<fhirInterfaces.IQuestionnaireResponseItemAnswer>);
    /**
     * Factory function to create a QuestionnaireResponseItemAnswer from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IQuestionnaireResponseItemAnswer): QuestionnaireResponseItemAnswer;
    /**
...
export declare class QuestionnaireResponseItem extends fhirModels.BackboneElement implements fhirInterfaces.IQuestionnaireResponseItem {
     ...
     */
    constructor(source: Partial<fhirInterfaces.IQuestionnaireResponseItem>);
    /**
     * Factory function to create a QuestionnaireResponseItem from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IQuestionnaireResponseItem): QuestionnaireResponseItem;
    /**
...
export declare class QuestionnaireResponse extends fhirModels.DomainResource implements fhirInterfaces.IQuestionnaireResponse {
     ...
     */
    constructor(source: Partial<fhirInterfaces.IQuestionnaireResponse>);
    /**
     * Factory function to create a QuestionnaireResponse from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IQuestionnaireResponse): QuestionnaireResponse;
    /**
