...
var OrganizationContact = /** @class */ (function (_super) {
     ...
     */
    OrganizationContact.CreateStrict = function (source) {
        var dest = new OrganizationContact(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "OrganizationContact is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    OrganizationContact.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var Organization = /** @class */ (function (_super) {
     ...
     */
    Organization.CreateStrict = function (source) {
        var dest = new Organization(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Organization is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Organization.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
