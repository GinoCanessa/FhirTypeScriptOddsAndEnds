...
var AppointmentParticipant = /** @class */ (function (_super) {
     ...
     */
    AppointmentParticipant.CreateStrict = function (source) {
        var dest = new AppointmentParticipant(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "AppointmentParticipant is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    AppointmentParticipant.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var Appointment = /** @class */ (function (_super) {
     ...
     */
    Appointment.CreateStrict = function (source) {
        var dest = new Appointment(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Appointment is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Appointment.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if ((this["participant"] === undefined) || (this["participant"].length === 0)) {
