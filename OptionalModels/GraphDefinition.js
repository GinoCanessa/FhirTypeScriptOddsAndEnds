...
var GraphDefinitionLinkTargetCompartment = /** @class */ (function (_super) {
     ...
     */
    GraphDefinitionLinkTargetCompartment.CreateStrict = function (source) {
        var dest = new GraphDefinitionLinkTargetCompartment(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "GraphDefinitionLinkTargetCompartment is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    GraphDefinitionLinkTargetCompartment.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var GraphDefinitionLinkTarget = /** @class */ (function (_super) {
     ...
     */
    GraphDefinitionLinkTarget.CreateStrict = function (source) {
        var dest = new GraphDefinitionLinkTarget(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "GraphDefinitionLinkTarget is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    GraphDefinitionLinkTarget.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var GraphDefinitionLink = /** @class */ (function (_super) {
     ...
     */
    GraphDefinitionLink.CreateStrict = function (source) {
        var dest = new GraphDefinitionLink(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "GraphDefinitionLink is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    GraphDefinitionLink.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var GraphDefinition = /** @class */ (function (_super) {
     ...
     */
    GraphDefinition.CreateStrict = function (source) {
        var dest = new GraphDefinition(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "GraphDefinition is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    GraphDefinition.prototype.checkRequiredElements = function () {
        var missingElements = [];
