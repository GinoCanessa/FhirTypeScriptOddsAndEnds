...
export class CodeSystemFilter extends fhirModels.BackboneElement implements fhirInterfaces.ICodeSystemFilter {
  ...
  constructor(source:Partial<fhirInterfaces.ICodeSystemFilter>) {
    ...
    if (source["operator"] !== undefined) { this.operator = source.operator.map((x) => (x)); }
    if (source["_operator"] !== undefined) { this._operator = source._operator.map((x) => new fhirModels.Element(x)); }
  ...
  checkRequiredElements():string[] {
    ...
    if ((this["operator"] === undefined) || (this["operator"].length === 0)) { missingElements.push("operator"); }
...
export class CodeSystemConcept extends fhirModels.BackboneElement implements fhirInterfaces.ICodeSystemConcept {
  ...
  constructor(source:Partial<fhirInterfaces.ICodeSystemConcept>) {
    ...
    if (source["code"] !== undefined) { this.code = source.code; }
    if (source["_code"] !== undefined) { this._code = new fhirModels.Element(source._code); }
    if (source["concept"] !== undefined) { this.concept = source.concept.map((x) => new fhirModels.CodeSystemConcept(x)); }
    ...
    if (source["designation"] !== undefined) { this.designation = source.designation.map((x) => new fhirModels.CodeSystemConceptDesignation(x)); }
    ...
    if (source["property"] !== undefined) { this.property = source.property.map((x) => new fhirModels.CodeSystemConceptProperty(x)); }
  }
  /**
...
export class CodeSystem extends fhirModels.DomainResource implements fhirInterfaces.ICodeSystem {
  ...
  constructor(source:Partial<fhirInterfaces.ICodeSystem>) {
    ...
    if (source["caseSensitive"] !== undefined) { this.caseSensitive = source.caseSensitive; }
    if (source["_caseSensitive"] !== undefined) { this._caseSensitive = new fhirModels.Element(source._caseSensitive); }
    ...
    if (source["_content"] !== undefined) { this._content = new fhirModels.Element(source._content); }
    ...
    if (source["filter"] !== undefined) { this.filter = source.filter.map((x) => new fhirModels.CodeSystemFilter(x)); }
    if (source["hierarchyMeaning"] !== undefined) { this.hierarchyMeaning = source.hierarchyMeaning; }
    if (source["_hierarchyMeaning"] !== undefined) { this._hierarchyMeaning = new fhirModels.Element(source._hierarchyMeaning); }
    ...
    if (source["property"] !== undefined) { this.property = source.property.map((x) => new fhirModels.CodeSystemProperty(x)); }
    ...
    if (source["supplements"] !== undefined) { this.supplements = source.supplements; }
    if (source["_supplements"] !== undefined) { this._supplements = new fhirModels.Element(source._supplements); }
    ...
    if (source["versionNeeded"] !== undefined) { this.versionNeeded = source.versionNeeded; }
    if (source["_versionNeeded"] !== undefined) { this._versionNeeded = new fhirModels.Element(source._versionNeeded); }
  }
  /**
