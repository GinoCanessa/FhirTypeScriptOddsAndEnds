...
var SubstanceSpecificationMoiety = /** @class */ (function (_super) {
     ...
     */
    SubstanceSpecificationMoiety.CreateStrict = function (source) {
        var dest = new SubstanceSpecificationMoiety(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSpecificationMoiety is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSpecificationMoiety.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var SubstanceSpecificationProperty = /** @class */ (function (_super) {
     ...
     */
    SubstanceSpecificationProperty.CreateStrict = function (source) {
        var dest = new SubstanceSpecificationProperty(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSpecificationProperty is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSpecificationProperty.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceSpecificationStructureIsotopeMolecularWeight = /** @class */ (function (_super) {
     ...
     */
    SubstanceSpecificationStructureIsotopeMolecularWeight.CreateStrict = function (source) {
        var dest = new SubstanceSpecificationStructureIsotopeMolecularWeight(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSpecificationStructureIsotopeMolecularWeight is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSpecificationStructureIsotopeMolecularWeight.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceSpecificationStructureIsotope = /** @class */ (function (_super) {
     ...
     */
    SubstanceSpecificationStructureIsotope.CreateStrict = function (source) {
        var dest = new SubstanceSpecificationStructureIsotope(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSpecificationStructureIsotope is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSpecificationStructureIsotope.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceSpecificationStructureRepresentation = /** @class */ (function (_super) {
     ...
     */
    SubstanceSpecificationStructureRepresentation.CreateStrict = function (source) {
        var dest = new SubstanceSpecificationStructureRepresentation(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSpecificationStructureRepresentation is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSpecificationStructureRepresentation.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceSpecificationStructure = /** @class */ (function (_super) {
     ...
     */
    SubstanceSpecificationStructure.CreateStrict = function (source) {
        var dest = new SubstanceSpecificationStructure(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSpecificationStructure is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSpecificationStructure.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceSpecificationCode = /** @class */ (function (_super) {
     ...
     */
    SubstanceSpecificationCode.CreateStrict = function (source) {
        var dest = new SubstanceSpecificationCode(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSpecificationCode is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSpecificationCode.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceSpecificationNameOfficial = /** @class */ (function (_super) {
     ...
     */
    SubstanceSpecificationNameOfficial.CreateStrict = function (source) {
        var dest = new SubstanceSpecificationNameOfficial(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSpecificationNameOfficial is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSpecificationNameOfficial.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceSpecificationName = /** @class */ (function (_super) {
     ...
     */
    SubstanceSpecificationName.CreateStrict = function (source) {
        var dest = new SubstanceSpecificationName(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSpecificationName is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSpecificationName.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var SubstanceSpecificationRelationship = /** @class */ (function (_super) {
     ...
     */
    SubstanceSpecificationRelationship.CreateStrict = function (source) {
        var dest = new SubstanceSpecificationRelationship(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSpecificationRelationship is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSpecificationRelationship.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var SubstanceSpecification = /** @class */ (function (_super) {
     ...
     */
    SubstanceSpecification.CreateStrict = function (source) {
        var dest = new SubstanceSpecification(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceSpecification is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceSpecification.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
