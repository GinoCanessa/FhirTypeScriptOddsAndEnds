...
var SubstanceProteinSubunit = /** @class */ (function (_super) {
     ...
     */
    SubstanceProteinSubunit.CreateStrict = function (source) {
        var dest = new SubstanceProteinSubunit(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceProteinSubunit is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceProteinSubunit.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var SubstanceProtein = /** @class */ (function (_super) {
     ...
     */
    SubstanceProtein.CreateStrict = function (source) {
        var dest = new SubstanceProtein(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SubstanceProtein is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SubstanceProtein.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
