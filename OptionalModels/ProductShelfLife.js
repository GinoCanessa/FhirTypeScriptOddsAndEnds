...
var ProductShelfLife = /** @class */ (function (_super) {
     ...
     */
    ProductShelfLife.CreateStrict = function (source) {
        var dest = new ProductShelfLife(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ProductShelfLife is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ProductShelfLife.prototype.checkRequiredElements = function () {
        var missingElements = [];
