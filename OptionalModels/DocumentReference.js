...
var DocumentReferenceRelatesTo = /** @class */ (function (_super) {
     ...
     */
    DocumentReferenceRelatesTo.CreateStrict = function (source) {
        var dest = new DocumentReferenceRelatesTo(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "DocumentReferenceRelatesTo is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    DocumentReferenceRelatesTo.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var DocumentReferenceContent = /** @class */ (function (_super) {
     ...
     */
    DocumentReferenceContent.CreateStrict = function (source) {
        var dest = new DocumentReferenceContent(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "DocumentReferenceContent is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    DocumentReferenceContent.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var DocumentReferenceContext = /** @class */ (function (_super) {
     ...
     */
    DocumentReferenceContext.CreateStrict = function (source) {
        var dest = new DocumentReferenceContext(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "DocumentReferenceContext is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    DocumentReferenceContext.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var DocumentReference = /** @class */ (function (_super) {
     ...
     */
    DocumentReference.CreateStrict = function (source) {
        var dest = new DocumentReference(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "DocumentReference is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    DocumentReference.prototype.checkRequiredElements = function () {
        var missingElements = [];
