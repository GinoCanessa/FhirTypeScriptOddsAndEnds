...
var SearchParameterComponent = /** @class */ (function (_super) {
     ...
     */
    SearchParameterComponent.CreateStrict = function (source) {
        var dest = new SearchParameterComponent(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SearchParameterComponent is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SearchParameterComponent.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var SearchParameter = /** @class */ (function (_super) {
     ...
     */
    SearchParameter.CreateStrict = function (source) {
        var dest = new SearchParameter(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "SearchParameter is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    SearchParameter.prototype.checkRequiredElements = function () {
        var missingElements = [];
