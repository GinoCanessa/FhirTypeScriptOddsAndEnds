...
export declare class CodeSystemFilter extends fhirModels.BackboneElement implements fhirInterfaces.ICodeSystemFilter {
     ...
     */
    constructor(source: Partial<fhirInterfaces.ICodeSystemFilter>);
    /**
     * Factory function to create a CodeSystemFilter from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.ICodeSystemFilter): CodeSystemFilter;
    /**
...
export declare class CodeSystemProperty extends fhirModels.BackboneElement implements fhirInterfaces.ICodeSystemProperty {
     ...
     */
    constructor(source: Partial<fhirInterfaces.ICodeSystemProperty>);
    /**
     * Factory function to create a CodeSystemProperty from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.ICodeSystemProperty): CodeSystemProperty;
    /**
...
export declare class CodeSystemConceptDesignation extends fhirModels.BackboneElement implements fhirInterfaces.ICodeSystemConceptDesignation {
     ...
     */
    constructor(source: Partial<fhirInterfaces.ICodeSystemConceptDesignation>);
    /**
     * Factory function to create a CodeSystemConceptDesignation from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.ICodeSystemConceptDesignation): CodeSystemConceptDesignation;
    /**
...
export declare class CodeSystemConceptProperty extends fhirModels.BackboneElement implements fhirInterfaces.ICodeSystemConceptProperty {
     ...
     */
    constructor(source: Partial<fhirInterfaces.ICodeSystemConceptProperty>);
    /**
     * Factory function to create a CodeSystemConceptProperty from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.ICodeSystemConceptProperty): CodeSystemConceptProperty;
    /**
...
export declare class CodeSystemConcept extends fhirModels.BackboneElement implements fhirInterfaces.ICodeSystemConcept {
     ...
     */
    constructor(source: Partial<fhirInterfaces.ICodeSystemConcept>);
    /**
     * Factory function to create a CodeSystemConcept from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.ICodeSystemConcept): CodeSystemConcept;
    /**
...
export declare class CodeSystem extends fhirModels.DomainResource implements fhirInterfaces.ICodeSystem {
     ...
     */
    constructor(source: Partial<fhirInterfaces.ICodeSystem>);
    /**
     * Factory function to create a CodeSystem from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.ICodeSystem): CodeSystem;
    /**
