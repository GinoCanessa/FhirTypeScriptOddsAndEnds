...
var ResearchDefinition = /** @class */ (function (_super) {
     ...
     */
    ResearchDefinition.CreateStrict = function (source) {
        var dest = new ResearchDefinition(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ResearchDefinition is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ResearchDefinition.prototype.checkRequiredElements = function () {
        var missingElements = [];
