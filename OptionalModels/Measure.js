...
var MeasureGroupPopulation = /** @class */ (function (_super) {
     ...
     */
    MeasureGroupPopulation.CreateStrict = function (source) {
        var dest = new MeasureGroupPopulation(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MeasureGroupPopulation is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MeasureGroupPopulation.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var MeasureGroupStratifierComponent = /** @class */ (function (_super) {
     ...
     */
    MeasureGroupStratifierComponent.CreateStrict = function (source) {
        var dest = new MeasureGroupStratifierComponent(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MeasureGroupStratifierComponent is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MeasureGroupStratifierComponent.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if (this["criteria"] === undefined) {
            missingElements.push("criteria");
        }
...
var MeasureGroupStratifier = /** @class */ (function (_super) {
     ...
     */
    MeasureGroupStratifier.CreateStrict = function (source) {
        var dest = new MeasureGroupStratifier(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MeasureGroupStratifier is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MeasureGroupStratifier.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var MeasureGroup = /** @class */ (function (_super) {
     ...
     */
    MeasureGroup.CreateStrict = function (source) {
        var dest = new MeasureGroup(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MeasureGroup is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MeasureGroup.prototype.checkRequiredElements = function () {
        var missingElements = [];
        var parentMissing = _super.prototype.checkRequiredElements.call(this);
        missingElements.push.apply(missingElements, parentMissing);
        return missingElements;
...
var MeasureSupplementalData = /** @class */ (function (_super) {
     ...
     */
    MeasureSupplementalData.CreateStrict = function (source) {
        var dest = new MeasureSupplementalData(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "MeasureSupplementalData is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    MeasureSupplementalData.prototype.checkRequiredElements = function () {
        var missingElements = [];
        if (this["criteria"] === undefined) {
            missingElements.push("criteria");
        }
...
var Measure = /** @class */ (function (_super) {
     ...
     */
    Measure.CreateStrict = function (source) {
        var dest = new Measure(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Measure is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Measure.prototype.checkRequiredElements = function () {
        var missingElements = [];
