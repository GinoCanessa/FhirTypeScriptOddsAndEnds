...
var ContactDetail = /** @class */ (function (_super) {
     ...
     */
    ContactDetail.CreateStrict = function (source) {
        var dest = new ContactDetail(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ContactDetail is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ContactDetail.prototype.checkRequiredElements = function () {
        var missingElements = [];
