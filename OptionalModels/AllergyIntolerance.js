...
var AllergyIntoleranceReaction = /** @class */ (function (_super) {
     ...
     */
    AllergyIntoleranceReaction.CreateStrict = function (source) {
        var dest = new AllergyIntoleranceReaction(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "AllergyIntoleranceReaction is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    AllergyIntoleranceReaction.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var AllergyIntolerance = /** @class */ (function (_super) {
     ...
     */
    AllergyIntolerance.CreateStrict = function (source) {
        var dest = new AllergyIntolerance(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "AllergyIntolerance is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    AllergyIntolerance.prototype.checkRequiredElements = function () {
        var missingElements = [];
