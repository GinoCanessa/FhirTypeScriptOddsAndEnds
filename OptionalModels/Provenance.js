...
var ProvenanceAgent = /** @class */ (function (_super) {
     ...
     */
    ProvenanceAgent.CreateStrict = function (source) {
        var dest = new ProvenanceAgent(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ProvenanceAgent is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ProvenanceAgent.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var ProvenanceEntity = /** @class */ (function (_super) {
     ...
     */
    ProvenanceEntity.CreateStrict = function (source) {
        var dest = new ProvenanceEntity(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "ProvenanceEntity is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    ProvenanceEntity.prototype.checkRequiredElements = function () {
        var missingElements = [];
...
var Provenance = /** @class */ (function (_super) {
     ...
     */
    Provenance.CreateStrict = function (source) {
        var dest = new Provenance(source);
        var missingElements = dest.checkRequiredElements();
        if (missingElements.length !== 0) {
            throw "Provenance is missing elements: ".concat(missingElements.join(", "));
        }
        return dest;
    };
    /**
     ...
     */
    Provenance.prototype.checkRequiredElements = function () {
        var missingElements = [];
        ...
        if ((this["target"] === undefined) || (this["target"].length === 0)) {
