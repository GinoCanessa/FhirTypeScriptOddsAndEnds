...
// FHIR ValueSet Enum: http://hl7.org/fhir/ValueSet/medication-statement-status|4.0.1
/**
 * Medication Status Codes
 */
export var MedicationStatementStatusValueSetEnum;
(function (MedicationStatementStatusValueSetEnum) {
    /**
     * active: The medication is still being taken.
     */
    MedicationStatementStatusValueSetEnum["Active"] = "active";
    /**
     * completed: The medication is no longer being taken.
     */
    MedicationStatementStatusValueSetEnum["Completed"] = "completed";
    /**
     ...
     */
    MedicationStatementStatusValueSetEnum["EnteredInError"] = "entered-in-error";
    /**
     * intended: The medication may be taken at some time in the future.
     */
    MedicationStatementStatusValueSetEnum["Intended"] = "intended";
    /**
     * not-taken: The medication was not consumed by the patient
     */
    MedicationStatementStatusValueSetEnum["NotTaken"] = "not-taken";
    /**
     ...
     */
    MedicationStatementStatusValueSetEnum["OnHold"] = "on-hold";
    /**
     ...
     */
    MedicationStatementStatusValueSetEnum["Stopped"] = "stopped";
    /**
     * unknown: The state of the medication use is not currently known.
     */
    MedicationStatementStatusValueSetEnum["Unknown"] = "unknown";
})(MedicationStatementStatusValueSetEnum || (MedicationStatementStatusValueSetEnum = {}));
//# sourceMappingURL=MedicationStatementStatusValueSetEnum.js.map