...
export declare const ResearchSubjectStatusValueSet: {
     ...
     */
    research_subject_status_FollowUp: Coding;
    /**
     ...
     */
    research_subject_status_Ineligible: Coding;
    /**
     * A person for whom registration was not completed.
     */
    research_subject_status_NotRegistered: Coding;
    /**
     ...
     */
    research_subject_status_OnStudyObservation: Coding;
    /**
     * A person is pre-registered for a study.
     */
    research_subject_status_PendingOnStudy: Coding;
    /**
     * A person that is potentially eligible for participation in the study.
     */
    research_subject_status_PotentialCandidate: Coding;
    /**
     * A person who is being evaluated for eligibility for a study.
     */
    research_subject_status_Screening: Coding;
    /**
     * The person has withdrawn their participation in the study before registration.
     */
    research_subject_status_Withdrawn: Coding;
};
//# sourceMappingURL=ResearchSubjectStatusValueSet.d.ts.map