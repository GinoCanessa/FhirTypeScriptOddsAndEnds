 ...
 */
export declare const SeriesPerformerFunctionValueSet: {
    /**
 ...
 * Performer function of an agent in an imaging study series
 */
export declare type SeriesPerformerFunctionValueSetType = typeof SeriesPerformerFunctionValueSet;
/**
 * Performer function of an agent in an imaging study series
 */
export declare enum SeriesPerformerFunctionValueSetEnum {
    /**
     * CON: An advisor participating in the service by performing evaluations and making recommendations.
     */
    Consultant = "CON",
...
//# sourceMappingURL=SeriesPerformerFunctionValueSet.d.ts.map