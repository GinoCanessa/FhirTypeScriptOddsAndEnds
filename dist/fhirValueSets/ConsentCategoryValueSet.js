...
export const ConsentCategoryValueSet = {
     ...
     */
    consent_category_AdvanceDirective: Coding.FromStrict({
        code: "acd",
     ...
     */
    consent_category_DoNotResuscitate: Coding.FromStrict({
        code: "dnr",
     ...
     */
    consent_category_EmergencyOnly: Coding.FromStrict({
        code: "emrgonly",
     ...
     */
    consent_category_HealthCareDirective: Coding.FromStrict({
        code: "hcd",
     ...
     */
    v3_ActCode_InformationCollection: Coding.FromStrict({
        code: "ICOL",
     ...
     */
    v3_ActCode_InformationDisclosure: Coding.FromStrict({
        code: "IDSCL",
     ...
     */
    v3_ActCode_InformationAccess: Coding.FromStrict({
        code: "INFA",
     ...
     */
    v3_ActCode_AccessOnly: Coding.FromStrict({
        code: "INFAO",
        display: "access only",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    }),
     ...
     */
    v3_ActCode_AccessAndSaveOnly: Coding.FromStrict({
        code: "INFASO",
     ...
     */
    v3_ActCode_InformationRedisclosure: Coding.FromStrict({
        code: "IRDSCL",
     ...
     */
    consent_category_NoticeOfPrivacyPractices: Coding.FromStrict({
        code: "npp",
     ...
     */
    consent_category_POLST: Coding.FromStrict({
        code: "polst",
        display: "POLST",
        system: "http://terminology.hl7.org/CodeSystem/consentcategorycodes"
    }),
     ...
     */
    consent_category_ResearchInformationAccess: Coding.FromStrict({
        code: "research",
     ...
     */
    v3_ActCode_ResearchInformationAccess: Coding.FromStrict({
        code: "RESEARCH",
        display: "research information access",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    }),
     ...
     */
    consent_category_DeIdentifiedInformationAccess: Coding.FromStrict({
        code: "rsdid",
     ...
     */
    v3_ActCode_DeIdentifiedInformationAccess: Coding.FromStrict({
        code: "RSDID",
        display: "de-identified information access",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    }),
     ...
     */
    consent_category_ReIdentifiableInformationAccess: Coding.FromStrict({
        code: "rsreid",
     ...
     */
    v3_ActCode_ReIdentifiableInformationAccess: Coding.FromStrict({
        code: "RSREID",
        display: "re-identifiable information access",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    }),
