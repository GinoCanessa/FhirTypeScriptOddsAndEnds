 ...
 */
export declare const CarePlanActivityOutcomeValueSet: {
    /**
     * Code: 129862009
     */
 ...
 * Example codes indicating the outcome of a care plan activity. Note that these are in no way complete and might not even be appropriate for some uses.
 */
export declare type CarePlanActivityOutcomeValueSetType = typeof CarePlanActivityOutcomeValueSet;
/**
 * Example codes indicating the outcome of a care plan activity. Note that these are in no way complete and might not even be appropriate for some uses.
 */
//# sourceMappingURL=CarePlanActivityOutcomeValueSet.d.ts.map