 ...
 */
export declare const EndpointConnectionTypeValueSet: {
    /**
 ...
 * This is an example value set defined by the FHIR project, that could be used to represent possible connection type profile values.
 */
export declare type EndpointConnectionTypeValueSetType = typeof EndpointConnectionTypeValueSet;
/**
 * This is an example value set defined by the FHIR project, that could be used to represent possible connection type profile values.
 */
export declare enum EndpointConnectionTypeValueSetEnum {
    /**
     * dicom-qido-rs: DICOMweb RESTful Image query - http://dicom.nema.org/medical/dicom/current/output/chtml/part18/sect_6.7.html
     */
...
//# sourceMappingURL=EndpointConnectionTypeValueSet.d.ts.map