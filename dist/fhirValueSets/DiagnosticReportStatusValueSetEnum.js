...
// FHIR ValueSet Enum: http://hl7.org/fhir/ValueSet/diagnostic-report-status|4.0.1
/**
 * The status of the diagnostic report.
 */
export var DiagnosticReportStatusValueSetEnum;
(function (DiagnosticReportStatusValueSetEnum) {
    /**
     ...
     */
    DiagnosticReportStatusValueSetEnum["EnteredInError"] = "entered-in-error";
    /**
     * final: The report is complete and verified by an authorized person.
     */
    DiagnosticReportStatusValueSetEnum["Final"] = "final";
    /**
     * partial: This is a partial (e.g. initial, interim or preliminary) report: data in the report may be incomplete or unverified.
     */
    DiagnosticReportStatusValueSetEnum["Partial"] = "partial";
    /**
     * preliminary: Verified early results are available, but not all  results are final.
     */
    DiagnosticReportStatusValueSetEnum["Preliminary"] = "preliminary";
    /**
     * registered: The existence of the report is registered, but there is nothing yet available.
     */
    DiagnosticReportStatusValueSetEnum["Registered"] = "registered";
    /**
     * unknown: The authoring/source system does not know which of the status values currently applies for this observation. Note: This concept is not to be used for "other" - one of the listed statuses is presumed to apply, but the authoring/source system does not know which.
     */
    DiagnosticReportStatusValueSetEnum["Unknown"] = "unknown";
})(DiagnosticReportStatusValueSetEnum || (DiagnosticReportStatusValueSetEnum = {}));
//# sourceMappingURL=DiagnosticReportStatusValueSetEnum.js.map