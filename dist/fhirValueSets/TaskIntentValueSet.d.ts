 ...
 */
export declare const TaskIntentValueSet: {
    /**
 ...
 * Distinguishes whether the task is a proposal, plan or full order.
 */
export declare type TaskIntentValueSetType = typeof TaskIntentValueSet;
/**
 * Distinguishes whether the task is a proposal, plan or full order.
 */
export declare enum TaskIntentValueSetEnum {
    /**
     * filler-order: The request represents the view of an authorization instantiated by a fulfilling system representing the details of the fulfiller's intention to act upon a submitted order.
     */
...
//# sourceMappingURL=TaskIntentValueSet.d.ts.map