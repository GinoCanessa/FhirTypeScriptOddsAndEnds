...
export const SignatureTypeValueSet = {
     ...
     */
    signature_type_AuthorQuoteSSignature: new Coding({
     ...
     */
    signature_type_IdentityWitnessSignature: new Coding({
     ...
     */
    signature_type_ConsentWitnessSignature: new Coding({
     ...
     */
    signature_type_InterpreterSignature: new Coding({
     ...
     */
    signature_type_ReviewSignature: new Coding({
     ...
     */
    signature_type_SourceSignature: new Coding({
     ...
     */
    signature_type_AddendumSignature: new Coding({
     ...
     */
    signature_type_ModificationSignature: new Coding({
     ...
     */
    signature_type_AdministrativeErrorEditSignature: new Coding({
     ...
     */
    signature_type_TimestampSignature: new Coding({
     ...
     */
    signature_type_CoauthorQuoteSSignature: new Coding({
     ...
     */
    signature_type_CoParticipantQuoteSSignature: new Coding({
     ...
     */
    signature_type_TranscriptionistRecorderSignature: new Coding({
     ...
     */
    signature_type_VerificationSignature: new Coding({
     ...
     */
    signature_type_ValidationSignature: new Coding({
     ...
     */
    signature_type_ConsentSignature: new Coding({
     ...
     */
    signature_type_SignatureWitnessSignature: new Coding({
     ...
     */
    signature_type_EventWitnessSignature: new Coding({
