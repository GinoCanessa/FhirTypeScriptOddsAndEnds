 ...
 */
export declare const CompositionStatusValueSet: {
    /**
 ...
 * The workflow/clinical status of the composition.
 */
export declare type CompositionStatusValueSetType = typeof CompositionStatusValueSet;
/**
 * The workflow/clinical status of the composition.
 */
//# sourceMappingURL=CompositionStatusValueSet.d.ts.map