...
export const ConsentPolicyValueSet = {
     ...
     */
    consent_policy_ATELGAOptInConsent: Coding.FromStrict({
        code: "at-elga",
     ...
     */
    consent_policy_CommonRuleInformedConsent: Coding.FromStrict({
        code: "cric",
     ...
     */
    consent_policy_MichiganBehaviorAndMentalHealthConsent: Coding.FromStrict({
        code: "dch-3927",
     ...
     */
    consent_policy_PopulationOriginsAndAncestryResearchConsent: Coding.FromStrict({
        code: "ga4gh",
     ...
     */
    consent_policy_HIPAAAuthorization: Coding.FromStrict({
        code: "hipaa-auth",
     ...
     */
    consent_policy_HIPAANoticeOfPrivacyPractices: Coding.FromStrict({
        code: "hipaa-npp",
     ...
     */
    consent_policy_HIPAAResearchAuthorization: Coding.FromStrict({
        code: "hipaa-research",
     ...
     */
    consent_policy_HIPAARestrictions: Coding.FromStrict({
     ...
     */
    consent_policy_HIPAASelfPayRestriction: Coding.FromStrict({
        code: "hipaa-self-pay",
     ...
     */
    consent_policy_IllinoisConsentByMinorsToMedicalProcedures: Coding.FromStrict({
     ...
     */
    consent_policy_MichiganMDHHS5515ConsentToShareBehavioralHealthInformationForCareCoordinationPurposes: Coding.FromStrict({
        code: "mdhhs-5515",
     ...
     */
    consent_policy_NCICancerClinicalTrialConsent: Coding.FromStrict({
        code: "nci",
     ...
     */
    consent_policy_NIHAuthorizationForTheReleaseOfMedicalInformation: Coding.FromStrict({
        code: "nih-527",
     ...
     */
    consent_policy_NIHGlobalRareDiseasePatientRegistryAndDataRepositoryConsent: Coding.FromStrict({
        code: "nih-grdr",
     ...
     */
    consent_policy_HHSNIHHIPAAResearchAuthorization: Coding.FromStrict({
        code: "nih-hipaa",
     ...
     */
    consent_policy_NLLSPPermission: Coding.FromStrict({
        code: "nl-lsp",
     ...
     */
    consent_policy_NewYorkStateSurgicalAndInvasiveProcedureProtocol: Coding.FromStrict({
        code: "nyssipp",
     ...
     */
    consent_policy_SquaxinIndianBehavioralHealthAndHIPAAConsent: Coding.FromStrict({
        code: "squaxin",
     ...
     */
    consent_policy_SSAAuthorizationToDisclose: Coding.FromStrict({
        code: "ssa-827",
     ...
     */
    consent_policy_VAForm100484: Coding.FromStrict({
        code: "va-10-0484",
     ...
     */
    consent_policy_VAForm100485: Coding.FromStrict({
        code: "va-10-0485",
     ...
     */
    consent_policy_VAForm101010116: Coding.FromStrict({
        code: "va-10-10116",
     ...
     */
    consent_policy_VAForm105345: Coding.FromStrict({
        code: "va-10-5345",
     ...
     */
    consent_policy_VAForm105345a: Coding.FromStrict({
        code: "va-10-5345a",
     ...
     */
    consent_policy_VAForm105345aMHV: Coding.FromStrict({
     ...
     */
    consent_policy_VAForm214142: Coding.FromStrict({
        code: "va-21-4142",
