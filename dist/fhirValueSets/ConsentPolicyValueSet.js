...
export const ConsentPolicyValueSet = {
     ...
     */
    consent_policy_ATELGAOptInConsent: new Coding({
        code: "at-elga",
     ...
     */
    consent_policy_CommonRuleInformedConsent: new Coding({
        code: "cric",
     ...
     */
    consent_policy_MichiganBehaviorAndMentalHealthConsent: new Coding({
        code: "dch-3927",
     ...
     */
    consent_policy_PopulationOriginsAndAncestryResearchConsent: new Coding({
        code: "ga4gh",
     ...
     */
    consent_policy_HIPAAAuthorization: new Coding({
        code: "hipaa-auth",
     ...
     */
    consent_policy_HIPAANoticeOfPrivacyPractices: new Coding({
        code: "hipaa-npp",
     ...
     */
    consent_policy_HIPAAResearchAuthorization: new Coding({
        code: "hipaa-research",
     ...
     */
    consent_policy_HIPAARestrictions: new Coding({
     ...
     */
    consent_policy_HIPAASelfPayRestriction: new Coding({
        code: "hipaa-self-pay",
     ...
     */
    consent_policy_IllinoisConsentByMinorsToMedicalProcedures: new Coding({
     ...
     */
    consent_policy_MichiganMDHHS5515ConsentToShareBehavioralHealthInformationForCareCoordinationPurposes: new Coding({
        code: "mdhhs-5515",
     ...
     */
    consent_policy_NCICancerClinicalTrialConsent: new Coding({
        code: "nci",
     ...
     */
    consent_policy_NIHAuthorizationForTheReleaseOfMedicalInformation: new Coding({
        code: "nih-527",
     ...
     */
    consent_policy_NIHGlobalRareDiseasePatientRegistryAndDataRepositoryConsent: new Coding({
        code: "nih-grdr",
     ...
     */
    consent_policy_HHSNIHHIPAAResearchAuthorization: new Coding({
        code: "nih-hipaa",
     ...
     */
    consent_policy_NLLSPPermission: new Coding({
        code: "nl-lsp",
     ...
     */
    consent_policy_NewYorkStateSurgicalAndInvasiveProcedureProtocol: new Coding({
        code: "nyssipp",
     ...
     */
    consent_policy_SquaxinIndianBehavioralHealthAndHIPAAConsent: new Coding({
        code: "squaxin",
     ...
     */
    consent_policy_SSAAuthorizationToDisclose: new Coding({
        code: "ssa-827",
     ...
     */
    consent_policy_VAForm100484: new Coding({
        code: "va-10-0484",
     ...
     */
    consent_policy_VAForm100485: new Coding({
        code: "va-10-0485",
     ...
     */
    consent_policy_VAForm101010116: new Coding({
        code: "va-10-10116",
     ...
     */
    consent_policy_VAForm105345: new Coding({
        code: "va-10-5345",
     ...
     */
    consent_policy_VAForm105345a: new Coding({
        code: "va-10-5345a",
     ...
     */
    consent_policy_VAForm105345aMHV: new Coding({
     ...
     */
    consent_policy_VAForm214142: new Coding({
        code: "va-21-4142",
