 ...
 */
export var V3ActEncounterCodeValueSet = {
    /**
     * An acute inpatient encounter.
     */
    v3_ActCode_InpatientAcute: Coding.FactoryCreateStrict({
        code: "ACUTE",
     ...
     */
    v3_ActCode_Ambulatory: Coding.FactoryCreateStrict({
        code: "AMB",
        display: "ambulatory",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    }),
     ...
     */
    v3_ActCode_Emergency: Coding.FactoryCreateStrict({
        code: "EMER",
        display: "emergency",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    }),
     ...
     */
    v3_ActCode_Field: Coding.FactoryCreateStrict({
        code: "FLD",
        display: "field",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    }),
     ...
     */
    v3_ActCode_HomeHealth: Coding.FactoryCreateStrict({
        code: "HH",
        display: "home health",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    }),
     ...
     */
    v3_ActCode_InpatientEncounter: Coding.FactoryCreateStrict({
        code: "IMP",
     ...
     */
    v3_ActCode_InpatientNonAcute: Coding.FactoryCreateStrict({
        code: "NONAC",
     ...
     */
    v3_ActCode_ObservationEncounter: Coding.FactoryCreateStrict({
        code: "OBSENC",
     ...
     */
    v3_ActCode_PreAdmission: Coding.FactoryCreateStrict({
        code: "PRENC",
     ...
     */
    v3_ActCode_ShortStay: Coding.FactoryCreateStrict({
        code: "SS",
        display: "short stay",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    }),
     ...
     */
    v3_ActCode_Virtual: Coding.FactoryCreateStrict({
        code: "VR",
        display: "virtual",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    }),
