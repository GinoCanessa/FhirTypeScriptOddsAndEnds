 ...
 */
export declare const ContractPublicationstatusValueSet: {
    /**
     ...
     */
    readonly Terminated: Coding;
};
/**
 * This value set contract specific codes for status.
 */
export declare type ContractPublicationstatusValueSetType = typeof ContractPublicationstatusValueSet;
/**
 * This value set contract specific codes for status.
 */
export declare enum ContractPublicationstatusValueSetEnum {
    /**
     * amended: Contract is augmented with additional information to correct errors in a predecessor or to updated values in a predecessor. Usage: Contract altered within effective time. Precedence Order = 9. Comparable FHIR and v.3 status codes: revised; replaced.
     */
    Amended = "amended",
...
//# sourceMappingURL=ContractPublicationstatusValueSet.d.ts.map