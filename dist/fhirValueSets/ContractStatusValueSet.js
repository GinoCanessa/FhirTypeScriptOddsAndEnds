...
export const ContractStatusValueSet = {
     ...
     */
    contract_status_Amended: new Coding({
        code: "amended",
        display: "Amended",
     ...
     */
    contract_status_Appended: new Coding({
        code: "appended",
        display: "Appended",
        system: "http://hl7.org/fhir/contract-status"
    }),
     ...
     */
    contract_status_Cancelled: new Coding({
        code: "cancelled",
        display: "Cancelled",
        system: "http://hl7.org/fhir/contract-status"
    }),
     ...
     */
    contract_status_Disputed: new Coding({
        code: "disputed",
        display: "Disputed",
        system: "http://hl7.org/fhir/contract-status"
    }),
     ...
     */
    contract_status_EnteredInError: new Coding({
     ...
     */
    contract_status_Executable: new Coding({
        code: "executable",
        display: "Executable",
        system: "http://hl7.org/fhir/contract-status"
    }),
     ...
     */
    contract_status_Executed: new Coding({
        code: "executed",
        display: "Executed",
        system: "http://hl7.org/fhir/contract-status"
    }),
     ...
     */
    contract_status_Negotiable: new Coding({
        code: "negotiable",
        display: "Negotiable",
        system: "http://hl7.org/fhir/contract-status"
    }),
     ...
     */
    contract_status_Offered: new Coding({
        code: "offered",
        display: "Offered",
        system: "http://hl7.org/fhir/contract-status"
    }),
     ...
     */
    contract_status_Policy: new Coding({
        code: "policy",
        display: "Policy",
        system: "http://hl7.org/fhir/contract-status"
    }),
     ...
     */
    contract_status_Rejected: new Coding({
        code: "rejected",
        display: "Rejected",
        system: "http://hl7.org/fhir/contract-status"
    }),
     ...
     */
    contract_status_Renewed: new Coding({
        code: "renewed",
        display: "Renewed",
        system: "http://hl7.org/fhir/contract-status"
    }),
     ...
     */
    contract_status_Resolved: new Coding({
        code: "resolved",
        display: "Resolved",
        system: "http://hl7.org/fhir/contract-status"
    }),
     ...
     */
    contract_status_Revoked: new Coding({
        code: "revoked",
        display: "Revoked",
        system: "http://hl7.org/fhir/contract-status"
    }),
     ...
     */
    contract_status_Terminated: new Coding({
        code: "terminated",
        display: "Terminated",
        system: "http://hl7.org/fhir/contract-status"
    }),
