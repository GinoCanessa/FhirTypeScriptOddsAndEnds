 ...
 */
export declare const GoalAchievementValueSet: {
    /**
 ...
 * Describes the progression, or lack thereof, towards the goal against the target.
 */
export declare type GoalAchievementValueSetType = typeof GoalAchievementValueSet;
/**
 * Describes the progression, or lack thereof, towards the goal against the target.
 */
//# sourceMappingURL=GoalAchievementValueSet.d.ts.map