 ...
 * This value set defines a set of codes that can be used to where the patient left the hospital.
 */
export declare type EncounterDischargeDispositionValueSetType = typeof EncounterDischargeDispositionValueSet;
/**
 * This value set defines a set of codes that can be used to where the patient left the hospital.
 */
export declare enum EncounterDischargeDispositionValueSetEnum {
    /**
     * aadvice: The patient self discharged against medical advice.
     */
