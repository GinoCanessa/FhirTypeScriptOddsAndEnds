 ...
 */
export declare const EncounterDischargeDispositionValueSet: {
    /**
     * The patient self discharged against medical advice.
     */
    encounter_discharge_disposition_LeftAgainstAdvice: Coding;
    /**
