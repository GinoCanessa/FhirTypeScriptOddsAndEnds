...
export const SecurityLabelsValueSet = {
     ...
     */
    v3_ObservationValue_Abstracted: new Coding({
        code: "ABSTRED",
        display: "abstracted",
     ...
     *                         &gt;
     */
    v3_ActCode_AccessControlScheme: new Coding({
     ...
     */
    v3_ActCode_AccountableCareOrganizationCompartment: new Coding({
        code: "ACOCOMPT",
     ...
     */
    v3_ActCode_AdolescentInformationSensitivity: new Coding({
        code: "ADOL",
     ...
     */
    v3_ObservationValue_Aggregated: new Coding({
        code: "AGGRED",
        display: "aggregated",
        system: "http://terminology.hl7.org/CodeSystem/v3-ObservationValue"
    }),
     ...
     */
    v3_ObservationValue_Anonymized: new Coding({
        code: "ANONYED",
        display: "anonymized",
        system: "http://terminology.hl7.org/CodeSystem/v3-ObservationValue"
    }),
     ...
     */
    v3_ActCode_AccountingOfDisclosure: new Coding({
        code: "AOD",
     ...
     */
    v3_ActCode_AuditTrail: new Coding({
        code: "AUDTR",
        display: "audit trail",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    }),
     ...
     */
    v3_ActCode_AuthorizationPolicy: new Coding({
        code: "AUTHPOL",
     ...
     */
    v3_ActCode_BusinessInformationSensitivity: new Coding({
        code: "B",
     ...
     */
    v3_ActCode_BehavioralHealthInformationSensitivity: new Coding({
        code: "BH",
     ...
     */
    v3_ActReason_BiomedicalResearch: new Coding({
        code: "BIORCH",
     ...
     */
    v3_ActReason_BreakTheGlass: new Coding({
        code: "BTG",
     ...
     */
    v3_ActReason_CareManagement: new Coding({
        code: "CAREMGT",
     ...
     */
    v3_ActCode_CelebrityInformationSensitivity: new Coding({
        code: "CEL",
     ...
     */
    v3_ObservationValue_ClinicianAsserted: new Coding({
        code: "CLINAST",
     ...
     */
    v3_ObservationValue_ClinicianReported: new Coding({
        code: "CLINRPT",
     ...
     */
    v3_ActReason_ClinicalTrialResearch: new Coding({
        code: "CLINTRCH",
     ...
     */
    v3_ActReason_ClinicalTrialResearchWithoutPatientCare: new Coding({
        code: "CLINTRCHNPC",
     ...
     */
    v3_ActReason_ClinicalTrialResearchWithPatientCare: new Coding({
        code: "CLINTRCHPC",
     ...
     */
    v3_ActReason_ClinicalTrial: new Coding({
        code: "CLINTRL",
     ...
     */
    v3_ActReason_ClaimAttachment: new Coding({
        code: "CLMATTCH",
     ...
     */
    v3_ActReason_CoordinationOfCare: new Coding({
        code: "COC",
     ...
     */
    v3_ActCode_CognitiveDisabilityInformationSensitivity: new Coding({
        code: "COGN",
     ...
     */
    v3_ActCode_Compartment: new Coding({
        code: "COMPT",
        display: "compartment",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    }),
     ...
     */
    v3_ActReason_CoverageAuthorization: new Coding({
        code: "COVAUTH",
     ...
     */
    v3_ActReason_CoverageUnderPolicyOrProgram: new Coding({
        code: "COVERAGE",
     ...
     */
    v3_ActCode_ComplyWithConfidentialityCode: new Coding({
        code: "CPLYCC",
     ...
     */
    v3_ActCode_ComplyWithConsentDirective: new Coding({
        code: "CPLYCD",
     ...
     */
    v3_ActCode_ComplyWithJurisdictionalPrivacyPolicy: new Coding({
        code: "CPLYJPP",
     ...
     */
    v3_ActCode_ComplyWithOrganizationalPrivacyPolicy: new Coding({
        code: "CPLYOPP",
     ...
     */
    v3_ActCode_ComplyWithOrganizationalSecurityPolicy: new Coding({
        code: "CPLYOSP",
     ...
     */
    v3_ActCode_ComplyWithPolicy: new Coding({
        code: "CPLYPOL",
     ...
     */
    v3_ObservationValue_CryptographicHashFunction: new Coding({
        code: "CRYTOHASH",
     ...
     */
    v3_ActCode_CareTeamCompartment: new Coding({
        code: "CTCOMPT",
     ...
     */
    v3_ActCode_DeclassifySecurityLabel: new Coding({
     ...
     */
    v3_ActCode_DeleteAfterUse: new Coding({
        code: "DELAU",
     ...
     */
    v3_ActCode_DelegationPolicy: new Coding({
        code: "DELEPOL",
     ...
     */
    v3_ActCode_AllDemographicInformationSensitivity: new Coding({
        code: "DEMO",
     ...
     */
    v3_ObservationValue_DeviceAsserted: new Coding({
        code: "DEVAST",
     ...
     */
    v3_ObservationValue_DeviceReported: new Coding({
        code: "DEVRPT",
     ...
     */
    v3_ActCode_DiagnosisInformationSensitivity: new Coding({
        code: "DIA",
     ...
     */
    v3_ObservationValue_DigitalSignature: new Coding({
        code: "DIGSIG",
     ...
     */
    v3_ActReason_Disaster: new Coding({
        code: "DISASTER",
        display: "disaster",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    }),
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_DateOfBirthInformationSensitivity: new Coding({
        code: "DOB",
     ...
     */
    v3_ActReason_Donation: new Coding({
        code: "DONAT",
        display: "donation",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    }),
     ...
     */
    v3_ActCode_DowngradeSecurityLabel: new Coding({
        code: "DOWNGRDLABEL",
     ...
     */
    v3_ActCode_DrugInformationSensitivity: new Coding({
        code: "DRGIS",
     ...
     */
    v3_ActCode_DeriveSecurityLabel: new Coding({
        code: "DRIVLABEL",
     ...
     */
    v3_ActReason_DiseaseSpecificHealthcareResearch: new Coding({
        code: "DSRCH",
     ...
     */
    v3_ActCode_DevelopmentalDisabilityInformationSensitivity: new Coding({
        code: "DVD",
     ...
     */
    v3_ActReason_EligibilityDetermination: new Coding({
        code: "ELIGDTRM",
     ...
     */
    v3_ActReason_EligibilityVerification: new Coding({
        code: "ELIGVER",
     ...
     */
    v3_ActCode_EmotionalDisturbanceInformationSensitivity: new Coding({
        code: "EMOTDIS",
     ...
     */
    v3_ActCode_EmployeeInformationSensitivity: new Coding({
        code: "EMP",
     ...
     */
    v3_ActCode_EmployerInformationSensitivity: new Coding({
        code: "EMPL",
     ...
     */
    v3_ActCode_EncryptAtRest: new Coding({
        code: "ENCRYPTR",
     ...
     */
    v3_ActCode_EncryptInTransit: new Coding({
        code: "ENCRYPTT",
     ...
     */
    v3_ActCode_EncryptInUse: new Coding({
        code: "ENCRYPTU",
     ...
     */
    v3_ActReason_Enrollment: new Coding({
        code: "ENROLLM",
        display: "enrollment",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    }),
     ...
     */
    v3_ActReason_EmergencyRoomTreatment: new Coding({
        code: "ERTREAT",
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_SubstanceAbuseInformationSensitivity: new Coding({
        code: "ETH",
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law in addition to this more generic code.
     */
    v3_ActCode_AlcoholUseDisorderInformationSensitivity: new Coding({
        code: "ETHUD",
     ...
     */
    v3_ActReason_EmergencyTreatment: new Coding({
        code: "ETREAT",
     ...
     */
    v3_ActReason_FamilyRequested: new Coding({
        code: "FAMRQT",
     ...
     */
    v3_ActCode_FinancialManagementCompartment: new Coding({
        code: "FMCOMPT",
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_GeneticDiseaseInformationSensitivity: new Coding({
        code: "GDIS",
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_GenderAndSexualOrientationInformationSensitivity: new Coding({
        code: "GENDER",
     ...
     */
    v3_ActReason_Government: new Coding({
        code: "GOV",
        display: "government",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    }),
     ...
     */
    v3_ActReason_HealthAccreditation: new Coding({
        code: "HACCRED",
     ...
     */
    v3_ActReason_HealthCompliance: new Coding({
        code: "HCOMPL",
     ...
     */
    v3_ObservationValue_HealthcareProfessionalAsserted: new Coding({
        code: "HCPAST",
     ...
     */
    v3_ObservationValue_HealthcareProfessionalReported: new Coding({
        code: "HCPRPT",
     ...
     */
    v3_ActReason_Decedent: new Coding({
        code: "HDECD",
        display: "decedent",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    }),
     ...
     */
    v3_ActReason_Directory: new Coding({
        code: "HDIRECT",
        display: "directory",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    }),
     ...
     */
    v3_ActReason_HealthcareDeliveryManagement: new Coding({
        code: "HDM",
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_HIVAIDSInformationSensitivity: new Coding({
        code: "HIV",
     ...
     */
    v3_ActReason_HealthcareMarketing: new Coding({
        code: "HMARKT",
     ...
     */
    v3_ActReason_HealthcareOperations: new Coding({
        code: "HOPERAT",
     ...
     */
    v3_ActReason_HealthOutcomeMeasure: new Coding({
        code: "HOUTCOMS",
     ...
     */
    v3_ActReason_HealthcarePayment: new Coding({
        code: "HPAYMT",
     ...
     */
    v3_ActReason_HealthProgramReporting: new Coding({
        code: "HPRGRP",
     ...
     */
    v3_ActReason_HealthQualityImprovement: new Coding({
        code: "HQUALIMP",
     ...
     */
    v3_ActCode_HumanResourceCompartment: new Coding({
        code: "HRCOMPT",
     ...
     */
    v3_ObservationValue_HighlyReliable: new Coding({
        code: "HRELIABLE",
     ...
     */
    v3_ActReason_HealthcareResearch: new Coding({
        code: "HRESCH",
     ...
     */
    v3_ActReason_HealthSystemAdministration: new Coding({
        code: "HSYSADMIN",
     ...
     */
    v3_ActReason_TestHealthData: new Coding({
        code: "HTEST",
     ...
     */
    v3_ActCode_HumanApproval: new Coding({
        code: "HUAPRV",
     ...
     */
    v3_Confidentiality_Low: new Coding({
        code: "L",
        display: "low",
     ...
     */
    v3_ActReason_Labeling: new Coding({
        code: "LABELING",
        display: "labeling",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    }),
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_LivingArrangementInformationSensitivity: new Coding({
        code: "LIVARG",
     ...
     *                            Usage Notes: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_LocationInformationSensitivity: new Coding({
        code: "LOCIS",
     ...
     */
    v3_ActCode_LegitimateRelationshipCompartment: new Coding({
        code: "LRCOMPT",
     ...
     */
    v3_Confidentiality_Moderate: new Coding({
        code: "M",
        display: "moderate",
        system: "http://terminology.hl7.org/CodeSystem/v3-Confidentiality"
    }),
     ...
     */
    v3_ObservationValue_Mapped: new Coding({
        code: "MAPPED",
        display: "mapped",
        system: "http://terminology.hl7.org/CodeSystem/v3-ObservationValue"
    }),
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_MaritalStatusInformationSensitivity: new Coding({
        code: "MARST",
     ...
     */
    v3_ObservationValue_Masked: new Coding({
        code: "MASKED",
        display: "masked",
        system: "http://terminology.hl7.org/CodeSystem/v3-ObservationValue"
    }),
     ...
     */
    v3_ActReason_MemberAdministration: new Coding({
        code: "MEMADMIN",
     ...
     */
    v3_ActReason_MetadataManagement: new Coding({
        code: "METAMGT",
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law in addition to this more generic code.
     */
    v3_ActCode_MentalHealthInformationSensitivity: new Coding({
        code: "MH",
     ...
     */
    v3_ActReason_MilitaryCommand: new Coding({
        code: "MILCDM",
     ...
     */
    v3_ActReason_MilitaryDischarge: new Coding({
        code: "MILDCRG",
     ...
     */
    v3_ActCode_MinimumNecessary: new Coding({
        code: "MINEC",
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law in addition to this more generic code.
     */
    v3_ActCode_MilitarySexualTraumaInformationSensitivity: new Coding({
        code: "MST",
     ...
     */
    v3_Confidentiality_Normal: new Coding({
        code: "N",
        display: "normal",
        system: "http://terminology.hl7.org/CodeSystem/v3-Confidentiality"
    }),
     ...
     */
    v3_ActCode_NoDisclosureWithoutSubjectAuthorization: new Coding({
        code: "NOAUTH",
     ...
     */
    v3_ActCode_NoCollection: new Coding({
        code: "NOCOLLECT",
     ...
     */
    v3_ActCode_NoDisclosureWithoutConsentDirective: new Coding({
        code: "NODSCLCD",
     ...
     */
    v3_ActCode_NoDisclosureWithoutInformationSubjectQuoteSConsentDirective: new Coding({
        code: "NODSCLCDS",
     ...
     */
    v3_ActCode_NoIntegration: new Coding({
        code: "NOINTEGRATE",
     ...
     */
    v3_ActCode_NoUnlistedEntityDisclosure: new Coding({
        code: "NOLIST",
     ...
     */
    v3_ActCode_NoDisclosureWithoutMOU: new Coding({
        code: "NOMOU",
     ...
     */
    v3_ActCode_NoDisclosureWithoutOrganizationalAuthorization: new Coding({
        code: "NOORGPOL",
     ...
     */
    v3_ActCode_NoDisclosureToPatientFamilyOrCaregiversWithoutAttendingProviderQuoteSAuthorization: new Coding({
        code: "NOPAT",
     ...
     */
    v3_ActCode_NoCollectionBeyondPurposeOfUse: new Coding({
        code: "NOPERSISTP",
     ...
     */
    v3_ActCode_NoRedisclosureWithoutConsentDirective: new Coding({
        code: "NORDSCLCD",
     ...
     */
    v3_ActCode_NoRedisclosureWithoutInformationSubjectQuoteSConsentDirective: new Coding({
        code: "NORDSCLCDS",
     ...
     */
    v3_ActCode_NoDisclosureWithoutJurisdictionalAuthorization: new Coding({
        code: "NORDSCLW",
     ...
     */
    v3_ActCode_NoRelinking: new Coding({
        code: "NORELINK",
     ...
     */
    v3_ActCode_NoReuseBeyondPurposeOfUse: new Coding({
        code: "NOREUSE",
     ...
     */
    v3_ActCode_NoUnauthorizedVIPDisclosure: new Coding({
        code: "NOVIP",
     ...
     */
    v3_ActCode_ObligationPolicy: new Coding({
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law in addition to this more generic code.
     */
    v3_ActCode_OpioidUseDisorderInformationSensitivity: new Coding({
        code: "OPIOIDUD",
     ...
     */
    v3_ActCode_NoDisclosureWithoutOriginatorAuthorization: new Coding({
        code: "ORCON",
     ...
     */
    v3_ActCode_PatientAdministrationCompartment: new Coding({
        code: "PACOMPT",
     ...
     */
    v3_ObservationValue_PatientAcquaintanceAsserted: new Coding({
        code: "PACQAST",
     ...
     */
    v3_ObservationValue_PatientAcquaintanceReported: new Coding({
        code: "PACQRPT",
     ...
     */
    v3_ActReason_PatientAdministration: new Coding({
        code: "PATADMIN",
     ...
     */
    v3_ObservationValue_PatientAsserted: new Coding({
        code: "PATAST",
     ...
     */
    v3_ObservationValue_PatientReported: new Coding({
        code: "PATRPT",
     ...
     */
    v3_ActReason_PatientRequested: new Coding({
        code: "PATRQT",
     ...
     */
    v3_ActReason_PatientSafety: new Coding({
        code: "PATSFTY",
     ...
     */
    v3_ObservationValue_PayerAsserted: new Coding({
        code: "PAYAST",
     ...
     */
    v3_ObservationValue_PayerReported: new Coding({
        code: "PAYRPT",
     ...
     */
    v3_ActCode_PatientDefaultInformationSensitivity: new Coding({
        code: "PDS",
     ...
     */
    v3_ActReason_PerformanceMeasure: new Coding({
        code: "PERFMSR",
     ...
     */
    v3_ActCode_PersistSecurityLabel: new Coding({
        code: "PERSISTLABEL",
     ...
     */
    v3_ActCode_PhysicianRequestedInformationSensitivity: new Coding({
        code: "PHY",
     ...
     */
    v3_ActReason_PopulationOriginsOrAncestryHealthcareResearch: new Coding({
        code: "POARCH",
     ...
     */
    v3_ActReason_PopulationHealth: new Coding({
        code: "POPHLTH",
     ...
     */
    v3_ActReason_PreclinicalTrialResearch: new Coding({
        code: "PRECLINTRCH",
     ...
     */
    v3_ActCode_PrivacyMark: new Coding({
        code: "PRIVMARK",
     ...
     */
    v3_ObservationValue_ProfessionalAsserted: new Coding({
        code: "PROAST",
     ...
     */
    v3_ObservationValue_ProfessionalReported: new Coding({
        code: "PRORPT",
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_PatientRequestedInformationSensitivity: new Coding({
        code: "PRS",
     ...
     */
    v3_ObservationValue_Pseudonymized: new Coding({
        code: "PSEUDED",
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_PsychiatryDisorderInformationSensitivity: new Coding({
        code: "PSY",
     ...
     */
    v3_ActCode_PsychotherapyNoteInformationSensitivity: new Coding({
        code: "PSYTHPN",
     ...
     */
    v3_ActReason_PublicHealth: new Coding({
        code: "PUBHLTH",
     ...
     */
    v3_ActReason_PurposeOfUse: new Coding({
        code: "PurposeOfUse",
     ...
     */
    v3_ActReason_PowerOfAttorney: new Coding({
        code: "PWATRNY",
     ...
     */
    v3_Confidentiality_Restricted: new Coding({
        code: "R",
        display: "restricted",
        system: "http://terminology.hl7.org/CodeSystem/v3-Confidentiality"
    }),
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_RaceInformationSensitivity: new Coding({
        code: "RACE",
     ...
     */
    v3_ActReason_RecordsManagement: new Coding({
        code: "RECORDMGT",
     ...
     */
    v3_ObservationValue_Redacted: new Coding({
        code: "REDACTED",
        display: "redacted",
        system: "http://terminology.hl7.org/CodeSystem/v3-ObservationValue"
    }),
     ...
     */
    v3_ActCode_RefrainPolicy: new Coding({
        code: "RefrainPolicy",
     ...
     *                            Usage Notes: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_ReligionInformationSensitivity: new Coding({
        code: "REL",
     ...
     */
    v3_ObservationValue_Reliable: new Coding({
        code: "RELIABLE",
        display: "reliable",
        system: "http://terminology.hl7.org/CodeSystem/v3-ObservationValue"
    }),
     ...
     */
    v3_ActReason_RemittanceAdvice: new Coding({
        code: "REMITADV",
     ...
     */
    v3_ActCode_ResearchProjectCompartment: new Coding({
        code: "RESCOMPT",
     ...
     */
    v3_ActCode_RecordsManagementCompartment: new Coding({
        code: "RMGTCOMPT",
     ...
     */
    v3_ActCode_SickleCellAnemiaInformationSensitivity: new Coding({
        code: "SCA",
     ...
     */
    v3_ObservationValue_SubstituteDecisionMakerAsserted: new Coding({
        code: "SDMAST",
     ...
     */
    v3_ObservationValue_SubstituteDecisionMakerReported: new Coding({
        code: "SDMRPT",
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_SexualAssaultAbuseOrDomesticViolenceInformationSensitivity: new Coding({
        code: "SDV",
     ...
     */
    v3_ActCode_SecurityPolicy: new Coding({
        code: "SecurityPolicy",
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_SexualityAndReproductiveHealthInformationSensitivity: new Coding({
        code: "SEX",
     ...
     */
    v3_ActCode_SickleCell: new Coding({
        code: "SICKLE",
        display: "sickle cell",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    }),
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law in addition to this more generic code.
     */
    v3_ActCode_SpeciallyProtectedInformationSensitivity: new Coding({
        code: "SPI",
     ...
     *                            Usage Notes: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_SensitiveServiceProviderInformationSensitivity: new Coding({
        code: "SSP",
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law rather than or in addition to this more generic code.
     */
    v3_ActCode_SexuallyTransmittedDiseaseInformationSensitivity: new Coding({
        code: "STD",
     ...
     */
    v3_ObservationValue_Subsetted: new Coding({
        code: "SUBSETTED",
        display: "subsetted",
        system: "http://terminology.hl7.org/CodeSystem/v3-ObservationValue"
    }),
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law in addition to this more generic code.
     */
    v3_ActCode_SubstanceUseDisorderInformationSensitivity: new Coding({
        code: "SUD",
     ...
     */
    v3_ActReason_SupportNetwork: new Coding({
        code: "SUPNWK",
     ...
     */
    v3_ObservationValue_SyntacticTransform: new Coding({
        code: "SYNTAC",
     ...
     */
    v3_ActReason_SystemDevelopment: new Coding({
        code: "SYSDEV",
     ...
     */
    v3_ActReason_Threat: new Coding({
        code: "THREAT",
        display: "threat",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    }),
     ...
     */
    v3_ActReason_Training: new Coding({
        code: "TRAIN",
        display: "training",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    }),
     ...
     */
    v3_ActReason_TranslationalHealthcareResearch: new Coding({
        code: "TRANSRCH",
     ...
     */
    v3_ActReason_Treatment: new Coding({
        code: "TREAT",
        display: "treatment",
        system: "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    }),
     ...
     */
    v3_ObservationValue_Translated: new Coding({
        code: "TRSLT",
        display: "translated",
        system: "http://terminology.hl7.org/CodeSystem/v3-ObservationValue"
    }),
     ...
     */
    v3_Confidentiality_Unrestricted: new Coding({
        code: "U",
     ...
     */
    v3_ObservationValue_UncertainReliability: new Coding({
        code: "UNCERTREL",
     ...
     */
    v3_ObservationValue_Unreliable: new Coding({
        code: "UNRELIABLE",
        display: "unreliable",
        system: "http://terminology.hl7.org/CodeSystem/v3-ObservationValue"
    }),
     ...
     */
    v3_ActCode_UpgradeSecurityLabel: new Coding({
        code: "UPGRDLABEL",
     ...
     */
    v3_Confidentiality_VeryRestricted: new Coding({
        code: "V",
     ...
     */
    v3_ObservationValue_Versioned: new Coding({
        code: "VERSIONED",
        display: "versioned",
        system: "http://terminology.hl7.org/CodeSystem/v3-ObservationValue"
    }),
     ...
     *                            Usage Note: If there is a jurisdictional mandate, then use the applicable ActPrivacyLaw code system, and specify the law in addition to this more generic code.
     */
    v3_ActCode_ViolenceInformationSensitivity: new Coding({
        code: "VIO",
