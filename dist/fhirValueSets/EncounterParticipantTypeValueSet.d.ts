 ...
 */
export declare const EncounterParticipantTypeValueSet: {
    /**
 ...
 * This value set defines a set of codes that can be used to indicate how an individual participates in an encounter.
 */
export declare type EncounterParticipantTypeValueSetType = typeof EncounterParticipantTypeValueSet;
/**
 * This value set defines a set of codes that can be used to indicate how an individual participates in an encounter.
 */
//# sourceMappingURL=EncounterParticipantTypeValueSet.d.ts.map