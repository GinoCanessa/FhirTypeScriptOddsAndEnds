...
// FHIR ValueSet Enum: http://hl7.org/fhir/ValueSet/contract-publicationstatus|4.0.1
/**
 * This value set contract specific codes for status.
 */
export var ContractPublicationstatusValueSetEnum;
(function (ContractPublicationstatusValueSetEnum) {
    /**
     ...
     */
    ContractPublicationstatusValueSetEnum["Amended"] = "amended";
    /**
     ...
     */
    ContractPublicationstatusValueSetEnum["Appended"] = "appended";
    /**
     ...
     */
    ContractPublicationstatusValueSetEnum["Cancelled"] = "cancelled";
    /**
     ...
     */
    ContractPublicationstatusValueSetEnum["Disputed"] = "disputed";
    /**
     * entered-in-error: Contract was created in error. No Precedence Order.  Status may be applied to a Contract with any status.
     */
    ContractPublicationstatusValueSetEnum["EnteredInError"] = "entered-in-error";
    /**
     ...
     */
    ContractPublicationstatusValueSetEnum["Executable"] = "executable";
    /**
     ...
     */
    ContractPublicationstatusValueSetEnum["Executed"] = "executed";
    /**
     ...
     */
    ContractPublicationstatusValueSetEnum["Negotiable"] = "negotiable";
    /**
     * offered: Contract is a proposal by either the Grantor or the Grantee. Aka - A Contract hard copy or electronic 'template', 'form' or 'application'. E.g., health insurance application; consent directive form. Usage: Beginning of contract negotiation, which may have been completed as a precondition because used for 0..* contracts. Precedence Order = 2. Comparable FHIR and v.3 status codes: requested; new.
     */
    ContractPublicationstatusValueSetEnum["Offered"] = "offered";
    /**
     ...
     */
    ContractPublicationstatusValueSetEnum["Policy"] = "policy";
    /**
     ...
     */
    ContractPublicationstatusValueSetEnum["Rejected"] = "rejected";
    /**
     ...
     */
    ContractPublicationstatusValueSetEnum["Renewed"] = "renewed";
    /**
     ...
     */
    ContractPublicationstatusValueSetEnum["Resolved"] = "resolved";
    /**
     ...
     */
    ContractPublicationstatusValueSetEnum["Revoked"] = "revoked";
    /**
     ...
     */
    ContractPublicationstatusValueSetEnum["Terminated"] = "terminated";
})(ContractPublicationstatusValueSetEnum || (ContractPublicationstatusValueSetEnum = {}));
//# sourceMappingURL=ContractPublicationstatusValueSetEnum.js.map