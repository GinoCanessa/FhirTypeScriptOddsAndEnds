...
export const SupplydeliveryStatusValueSet = {
     ...
     */
    supplydelivery_status_Abandoned: Coding.FromStrict({
        code: "abandoned",
        display: "Abandoned",
     ...
     */
    supplydelivery_status_Delivered: Coding.FromStrict({
        code: "completed",
        display: "Delivered",
        system: "http://hl7.org/fhir/supplydelivery-status"
    }),
     ...
     */
    supplydelivery_status_EnteredInError: Coding.FromStrict({
     ...
     */
    supplydelivery_status_InProgress: Coding.FromStrict({
        code: "in-progress",
        display: "In Progress",
        system: "http://hl7.org/fhir/supplydelivery-status"
    }),
