...
// FHIR ValueSet Enum: http://hl7.org/fhir/ValueSet/medicationdispense-status|4.0.1
/**
 * MedicationDispense Status Codes
 */
export var MedicationdispenseStatusValueSetEnum;
(function (MedicationdispenseStatusValueSetEnum) {
    /**
     * cancelled: The dispensed product was not and will never be picked up by the patient.
     */
    MedicationdispenseStatusValueSetEnum["Cancelled"] = "cancelled";
    /**
     * completed: The dispensed product has been picked up.
     */
    MedicationdispenseStatusValueSetEnum["Completed"] = "completed";
    /**
     * declined: The dispense was declined and not performed.
     */
    MedicationdispenseStatusValueSetEnum["Declined"] = "declined";
    /**
     * entered-in-error: The dispense was entered in error and therefore nullified.
     */
    MedicationdispenseStatusValueSetEnum["EnteredInError"] = "entered-in-error";
    /**
     * in-progress: The dispensed product is ready for pickup.
     */
    MedicationdispenseStatusValueSetEnum["InProgress"] = "in-progress";
    /**
     ...
     */
    MedicationdispenseStatusValueSetEnum["OnHold"] = "on-hold";
    /**
     ...
     */
    MedicationdispenseStatusValueSetEnum["Preparation"] = "preparation";
    /**
     * stopped: Actions implied by the dispense have been permanently halted, before all of them occurred.
     */
    MedicationdispenseStatusValueSetEnum["Stopped"] = "stopped";
    /**
     ...
     */
    MedicationdispenseStatusValueSetEnum["Unknown"] = "unknown";
})(MedicationdispenseStatusValueSetEnum || (MedicationdispenseStatusValueSetEnum = {}));
//# sourceMappingURL=MedicationdispenseStatusValueSetEnum.js.map