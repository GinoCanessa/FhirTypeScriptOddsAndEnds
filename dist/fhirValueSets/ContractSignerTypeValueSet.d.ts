 ...
 */
export declare const ContractSignerTypeValueSet: {
    /**
 ...
 * This value set includes sample Contract Signer Type codes.
 */
export declare type ContractSignerTypeValueSetType = typeof ContractSignerTypeValueSet;
/**
 * This value set includes sample Contract Signer Type codes.
 */
export declare enum ContractSignerTypeValueSetEnum {
    /**
     * AFFL: An entity that has a business or professional relationship with another entity in accordance with an agreement.
     */
    Affiliate = "AFFL",
...
//# sourceMappingURL=ContractSignerTypeValueSet.d.ts.map