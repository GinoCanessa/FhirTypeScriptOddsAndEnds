 ...
 */
export declare const ReferenceHandlingPolicyValueSet: {
    /**
 ...
 * A set of flags that defines how references are supported.
 */
export declare type ReferenceHandlingPolicyValueSetType = typeof ReferenceHandlingPolicyValueSet;
/**
 * A set of flags that defines how references are supported.
 */
//# sourceMappingURL=ReferenceHandlingPolicyValueSet.d.ts.map