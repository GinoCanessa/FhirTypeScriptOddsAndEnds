 ...
 */
export declare const PractitionerRoleValueSet: {
    /**
     * Code: 106289002
     */
     ...
     */
    readonly ICTProfessional: Coding;
    /**
     * nurse: A practitioner with nursing experience that may be qualified/registered
     */
    readonly NurseNurse: Coding;
    /**
     * pharmacist: A qualified/registered/licensed pharmacist
     */
    readonly PharmacistPharmacist: Coding;
    /**
     * researcher: A practitioner that may perform research
     */
    readonly Researcher: Coding;
    /**
     * teacher: Someone who is able to provide educational services
     */
    readonly TeacherEducator: Coding;
};
/**
 * This example value set defines a set of codes that can be used to indicate the role of a Practitioner.
 */
export declare type PractitionerRoleValueSetType = typeof PractitionerRoleValueSet;
/**
 * This example value set defines a set of codes that can be used to indicate the role of a Practitioner.
 */
export declare enum PractitionerRoleValueSetEnum {
    /**
     * Code: 106289002
     */
...
//# sourceMappingURL=PractitionerRoleValueSet.d.ts.map