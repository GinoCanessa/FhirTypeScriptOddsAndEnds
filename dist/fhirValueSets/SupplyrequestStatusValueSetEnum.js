...
// FHIR ValueSet Enum: http://hl7.org/fhir/ValueSet/supplyrequest-status|4.0.1
/**
 * Status of the supply request.
 */
export var SupplyrequestStatusValueSetEnum;
(function (SupplyrequestStatusValueSetEnum) {
    /**
     * active: The request is ready to be acted upon.
     */
    SupplyrequestStatusValueSetEnum["Active"] = "active";
    /**
     ...
     */
    SupplyrequestStatusValueSetEnum["EnteredInError"] = "entered-in-error";
    /**
     * suspended: The authorization/request to act has been temporarily withdrawn but is expected to resume in the future.
     */
    SupplyrequestStatusValueSetEnum["Suspended"] = "suspended";
    /**
     * unknown: The authoring/source system does not know which of the status values currently applies for this observation. Note: This concept is not to be used for "other" - one of the listed statuses is presumed to apply, but the authoring/source system does not know which.
     */
    SupplyrequestStatusValueSetEnum["Unknown"] = "unknown";
})(SupplyrequestStatusValueSetEnum || (SupplyrequestStatusValueSetEnum = {}));
//# sourceMappingURL=SupplyrequestStatusValueSetEnum.js.map