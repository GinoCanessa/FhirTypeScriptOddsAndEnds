 ...
 */
export declare const GoalPriorityValueSet: {
    /**
 ...
 * Indicates the level of importance associated with reaching or sustaining a goal.
 */
export declare type GoalPriorityValueSetType = typeof GoalPriorityValueSet;
/**
 * Indicates the level of importance associated with reaching or sustaining a goal.
 */
export declare enum GoalPriorityValueSetEnum {
    /**
     * high-priority: Indicates that the goal is of considerable importance and should be a primary focus of care delivery.
     */
...
//# sourceMappingURL=GoalPriorityValueSet.d.ts.map