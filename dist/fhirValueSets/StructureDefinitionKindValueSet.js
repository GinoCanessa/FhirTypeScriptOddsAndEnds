...
export const StructureDefinitionKindValueSet = {
     ...
     */
    structure_definition_kind_ComplexDataType: new Coding({
        code: "complex-type",
     ...
     */
    structure_definition_kind_Logical: new Coding({
        code: "logical",
        display: "Logical",
        system: "http://hl7.org/fhir/structure-definition-kind"
    }),
     ...
     */
    structure_definition_kind_PrimitiveDataType: new Coding({
        code: "primitive-type",
     ...
     */
    structure_definition_kind_Resource: new Coding({
        code: "resource",
        display: "Resource",
        system: "http://hl7.org/fhir/structure-definition-kind"
    }),
