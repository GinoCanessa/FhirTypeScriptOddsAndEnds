...
// FHIR ValueSet Enum: http://hl7.org/fhir/ValueSet/care-plan-activity-kind|4.0.1
/**
 * Resource types defined as part of FHIR that can be represented as in-line definitions of a care plan activity.
 */
export var CarePlanActivityKindValueSetEnum;
(function (CarePlanActivityKindValueSetEnum) {
    /**
     ...
     */
    CarePlanActivityKindValueSetEnum["Appointment"] = "Appointment";
    /**
     ...
     */
    CarePlanActivityKindValueSetEnum["CommunicationRequest"] = "CommunicationRequest";
    /**
     ...
     */
    CarePlanActivityKindValueSetEnum["DeviceRequest"] = "DeviceRequest";
    /**
     * MedicationRequest: An order or request for both supply of the medication and the instructions for administration of the medication to a patient. The resource is called "MedicationRequest" rather than "MedicationPrescription" or "MedicationOrder" to generalize the use across inpatient and outpatient settings, including care plans, etc., and to harmonize with workflow patterns.
     */
    CarePlanActivityKindValueSetEnum["MedicationRequest"] = "MedicationRequest";
    /**
     * NutritionOrder: A request to supply a diet, formula feeding (enteral) or oral nutritional supplement to a patient/resident.
     */
    CarePlanActivityKindValueSetEnum["NutritionOrder"] = "NutritionOrder";
    /**
     ...
     */
    CarePlanActivityKindValueSetEnum["ServiceRequest"] = "ServiceRequest";
    /**
     * Task: A task to be performed.
     */
    CarePlanActivityKindValueSetEnum["Task"] = "Task";
    /**
     * VisionPrescription: An authorization for the provision of glasses and/or contact lenses to a patient.
     */
    CarePlanActivityKindValueSetEnum["VisionPrescription"] = "VisionPrescription";
})(CarePlanActivityKindValueSetEnum || (CarePlanActivityKindValueSetEnum = {}));
//# sourceMappingURL=CarePlanActivityKindValueSetEnum.js.map