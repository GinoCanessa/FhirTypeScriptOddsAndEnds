...
export declare const ObservationInterpretationValueSet: {
     ...
     */
    v3_ObservationInterpretation_ObservationInterpretationExceptions: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_ObservationInterpretationNormality: Coding;
    /**
     * Interpretations of anti-microbial susceptibility testing results (microbiology). At most one allowed.
     */
    v3_ObservationInterpretation_ObservationInterpretationSusceptibility: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_OffScaleLow: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_OffScaleHigh: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Abnormal: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_CriticalAbnormal: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Better: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Carrier: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_SignificantChangeDown: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Detected: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Equivocal: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_OutsideThreshold: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Expected: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_High: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_CriticalHigh: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_SignificantlyHigh: Coding;
    /**
     * The observation/test result is interpreted as being outside the inclusion range for a particular protocol within which the result is being reported.
     *
     *                         Example: A positive result on a Hepatitis screening test.
     ...
     */
    v3_ObservationInterpretation_AboveHighThreshold: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Intermediate: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_InsufficientEvidence: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Indeterminate: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Low: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_CriticalLow: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_SignificantlyLow: Coding;
    /**
     ...
     *                            Open Issue: EX, HX, LX: These three concepts do not seem to meet a clear need in the vocabulary, and their use in observation interpretation appears likely to be covered by other existing concepts (e.g., A, H, L).  The only apparent significant difference is their reference to use in protocols for exclusion of study subjects.  These concepts/codes were proposed by RCRIM for use in the CTLaboratory message.  They were submitted and approved in the November 2005 Harmonization cycle in proposal "030103C_VOCAB_RCRIM_l_quade_RCRIM Obs Interp_20051028154455".  However, this proposal was not fully implemented in the vocabulary.  The proposal recommended creation of the x_ClinicalResearchExclusion domain in ObservationInterpretation with a value set including those three concepts/codes, but there is no subdomain of that name or equivalent with a binding to either of the value sets that contain these concepts/codes.  Members of the OO WG have recently attempted to contact members of RCRIM regarding these concepts, both by email and at the recent WGM in Atlanta, without response.  It is felt by OO that the best course of action to take at this time is to add this comprehensive Open Issue rather than deprecate these three concepts at this time, until further discussion is held.
     */
    v3_ObservationInterpretation_BelowLowThreshold: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Normal: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_NoCLSIDefinedBreakpoint: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_NotDetected: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_NonSusceptible: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_ObservationInterpretationDetection: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_ObservationInterpretationExpectation: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Positive: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Resistant: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_ReactivityObservationInterpretation: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Reactive: Coding;
    /**
     ...
     *                         [Note 2: This breakpoint can be altered due to changes in circumstances (e.g., changes in commonly used drug dosages, emergence of new resistance mechanisms).]
     */
    v3_ObservationInterpretation_Susceptible: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_SusceptibleDoseDependent: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_SynergyResistant: Coding;
    /**
     ...
     *                            Open Issue: The print name of the code is very general and the description is very specific to a pair of classes of agents, which may lead to confusion of these concepts in the future should other synergies be found.
     */
    v3_ObservationInterpretation_SynergySusceptible: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_SignificantChangeUp: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_Unexpected: Coding;
    /**
     ...
     *                         [Note: This can be applied to quantitative or qualitative observations.]
     */
    v3_ObservationInterpretation_Worse: Coding;
    /**
     ...
     */
    v3_ObservationInterpretation_WeaklyReactive: Coding;
};
//# sourceMappingURL=ObservationInterpretationValueSet.d.ts.map