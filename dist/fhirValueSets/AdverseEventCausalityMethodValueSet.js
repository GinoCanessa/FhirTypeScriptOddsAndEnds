...
export const AdverseEventCausalityMethodValueSet = {
    adverse_event_causality_method_Bayesian: new Coding({
        code: "Bayesian",
        display: "Bayesian",
        system: "http://terminology.hl7.org/CodeSystem/adverse-event-causality-method"
    }),
    adverse_event_causality_method_Checklist: new Coding({
        code: "Checklist",
        display: "Checklist",
        system: "http://terminology.hl7.org/CodeSystem/adverse-event-causality-method"
    }),
    adverse_event_causality_method_ProbabilityScale: new Coding({
