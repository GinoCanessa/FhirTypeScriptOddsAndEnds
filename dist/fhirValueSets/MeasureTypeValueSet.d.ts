 ...
 */
export declare const MeasureTypeValueSet: {
    /**
 ...
 * The type of measure (includes codes from 2.16.840.1.113883.1.11.20368).
 */
export declare type MeasureTypeValueSetType = typeof MeasureTypeValueSet;
/**
 * The type of measure (includes codes from 2.16.840.1.113883.1.11.20368).
 */
//# sourceMappingURL=MeasureTypeValueSet.d.ts.map