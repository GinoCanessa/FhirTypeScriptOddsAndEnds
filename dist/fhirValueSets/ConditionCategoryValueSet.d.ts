 ...
 */
export declare const ConditionCategoryValueSet: {
    /**
 ...
 * Preferred value set for Condition Categories.
 */
export declare type ConditionCategoryValueSetType = typeof ConditionCategoryValueSet;
/**
 * Preferred value set for Condition Categories.
 */
export declare enum ConditionCategoryValueSetEnum {
    /**
     * encounter-diagnosis: A point in time diagnosis (e.g. from a physician or nurse) in context of an encounter.
     */
...
//# sourceMappingURL=ConditionCategoryValueSet.d.ts.map