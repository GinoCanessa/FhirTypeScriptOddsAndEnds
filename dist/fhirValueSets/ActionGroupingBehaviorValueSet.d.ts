 ...
 */
export declare const ActionGroupingBehaviorValueSet: {
    /**
 ...
 * Defines organization behavior of a group.
 */
export declare type ActionGroupingBehaviorValueSetType = typeof ActionGroupingBehaviorValueSet;
/**
 * Defines organization behavior of a group.
 */
export declare enum ActionGroupingBehaviorValueSetEnum {
    /**
     * logical-group: A group with this behavior logically groups its sub-elements, and may be shown as a visual group to the end user, but it is not required to do so.
     */
...
//# sourceMappingURL=ActionGroupingBehaviorValueSet.d.ts.map