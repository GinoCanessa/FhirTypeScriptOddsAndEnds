...
// FHIR ValueSet Enum: http://hl7.org/fhir/ValueSet/medicationrequest-status-reason|4.0.1
/**
 * MedicationRequest Status Reason Codes
 */
export var MedicationrequestStatusReasonValueSetEnum;
(function (MedicationrequestStatusReasonValueSetEnum) {
    /**
     ...
     */
    MedicationrequestStatusReasonValueSetEnum["TryAnotherTreatmentFirst"] = "altchoice";
    /**
     * clarif: Clarification is required before the order can be acted upon.
     */
    MedicationrequestStatusReasonValueSetEnum["PrescriptionRequiresClarification"] = "clarif";
    /**
     ...
     */
    MedicationrequestStatusReasonValueSetEnum["DrugLevelTooHigh"] = "drughigh";
    /**
     ...
     */
    MedicationrequestStatusReasonValueSetEnum["AdmissionToHospital"] = "hospadm";
    /**
     ...
     */
    MedicationrequestStatusReasonValueSetEnum["LabInterferenceIssues"] = "labint";
    /**
     * non-avail: Patient not available for a period of time due to a scheduled therapy, leave of absence or other reason.
     */
    MedicationrequestStatusReasonValueSetEnum["PatientNotAvailable"] = "non-avail";
    /**
     ...
     */
    MedicationrequestStatusReasonValueSetEnum["ParentIsPregnantBreastFeeding"] = "preg";
    /**
     ...
     */
    MedicationrequestStatusReasonValueSetEnum["Allergy"] = "salg";
    /**
     ...
     */
    MedicationrequestStatusReasonValueSetEnum["DrugInteractsWithAnotherDrug"] = "sddi";
    /**
     ...
     */
    MedicationrequestStatusReasonValueSetEnum["DuplicateTherapy"] = "sdupther";
    /**
     ...
     */
    MedicationrequestStatusReasonValueSetEnum["SuspectedIntolerance"] = "sintol";
    /**
     ...
     */
    MedicationrequestStatusReasonValueSetEnum["PatientScheduledForSurgery"] = "surg";
    /**
     ...
     */
    MedicationrequestStatusReasonValueSetEnum["WaitingForOldDrugToWashOut"] = "washout";
})(MedicationrequestStatusReasonValueSetEnum || (MedicationrequestStatusReasonValueSetEnum = {}));
//# sourceMappingURL=MedicationrequestStatusReasonValueSetEnum.js.map