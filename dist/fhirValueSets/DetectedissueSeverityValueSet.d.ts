 ...
 */
export declare const DetectedissueSeverityValueSet: {
    /**
 ...
 * Indicates the potential degree of impact of the identified issue on the patient.
 */
export declare type DetectedissueSeverityValueSetType = typeof DetectedissueSeverityValueSet;
/**
 * Indicates the potential degree of impact of the identified issue on the patient.
 */
export declare enum DetectedissueSeverityValueSetEnum {
    /**
     * high: Indicates the issue may be life-threatening or has the potential to cause permanent injury.
     */
    High = "high",
...
//# sourceMappingURL=DetectedissueSeverityValueSet.d.ts.map