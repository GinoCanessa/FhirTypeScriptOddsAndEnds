...
export declare const ServicePlaceValueSet: {
     ...
     */
    readonly HomelessShelter: Coding;
    /**
     ...
     */
    readonly IndianHealthServiceFreeStandingFacility: Coding;
    /**
     ...
     */
    readonly IndianHealthServiceProviderBasedFacility: Coding;
    /**
     ...
     */
    readonly Tribal638FreeStandingFacility: Coding;
    /**
     ...
     */
    readonly Tribal638ProviderBasedFacility: Coding;
    /**
     ...
     */
    readonly PrisonCorrectionalFacility: Coding;
    /**
     ...
     */
    readonly AssistedLivingFa: Coding;
    /**
     ...
     */
    readonly OffCampusOutpatientHospital: Coding;
    /**
     ...
     */
    readonly UrgentCareFacility: Coding;
    /**
     ...
     */
    readonly AmbulanceLand: Coding;
};
/**
 * This value set includes a smattering of Service Place codes.
 */
export declare type ServicePlaceValueSetType = typeof ServicePlaceValueSet;
/**
 * This value set includes a smattering of Service Place codes.
 */
export declare enum ServicePlaceValueSetEnum {
    /**
     * 01: A facility or location where drugs and other medically related items and services are sold, dispensed, or otherwise provided directly to patients.
     */
    Pharmacy = "01",
