 ...
 */
export declare class EvidenceVariableCharacteristic extends fhirModels.BackboneElement implements fhirInterfaces.IEvidenceVariableCharacteristic {
    /**
 ...
 */
export declare enum EvidenceVariableCharacteristicGroupMeasureEnum {
    MEAN = "mean",
    MEDIAN = "median",
 ...
 */
export declare class EvidenceVariable extends fhirModels.DomainResource implements fhirInterfaces.IEvidenceVariable {
    /**
     * Resource Type Name
     */
 ...
 */
export declare enum EvidenceVariableStatusEnum {
    DRAFT = "draft",
    ACTIVE = "active",
    RETIRED = "retired",
    UNKNOWN = "unknown"
 ...
 */
export declare enum EvidenceVariableTypeEnum {
