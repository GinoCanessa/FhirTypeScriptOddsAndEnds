...
export declare class MedicationIngredient extends fhirModels.BackboneElement implements fhirInterfaces.IMedicationIngredient {
     ...
     */
    constructor(source: Partial<fhirInterfaces.IMedicationIngredient>);
    /**
     * Factory function to create a MedicationIngredient from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IMedicationIngredient): MedicationIngredient;
    /**
...
export declare class MedicationBatch extends fhirModels.BackboneElement implements fhirInterfaces.IMedicationBatch {
     ...
     */
    constructor(source: Partial<fhirInterfaces.IMedicationBatch>);
    /**
     * Factory function to create a MedicationBatch from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IMedicationBatch): MedicationBatch;
    /**
...
export declare class Medication extends fhirModels.DomainResource implements fhirInterfaces.IMedication {
     ...
     */
    constructor(source: Partial<fhirInterfaces.IMedication>);
    /**
     * Factory function to create a Medication from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IMedication): Medication;
    /**
