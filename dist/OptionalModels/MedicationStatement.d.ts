 ...
 */
export declare class MedicationStatement extends fhirModels.DomainResource implements fhirInterfaces.IMedicationStatement {
    /**
     * Resource Type Name
     */
     ...
     */
    status?: MedicationStatementStatusEnum | undefined;
     ...
     */
    constructor(source: Partial<fhirInterfaces.IMedicationStatement>);
    /**
     * Factory function to create a MedicationStatement from an object that MUST contain all required elements.
     */
    static CreateStrict(source: fhirInterfaces.IMedicationStatement): MedicationStatement;
    /**
