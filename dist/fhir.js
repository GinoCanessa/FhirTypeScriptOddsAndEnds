...
function fhirToJson(obj) {
    ...
    for (const key in obj) {
        ...
        let dKey = key + (obj['__' + key + 'IsChoice'] ? ((_a = obj[key]['__dataType']) !== null && _a !== void 0 ? _a : '') : '');
        if (Array.isArray(obj[key])) {
            ...
            if (obj[key]['__isPrimitive']) {
                ...
                c[eName] = {};
                if (obj[key]['id']) {
                    c[eName]['id'] = obj[key]['id'];
                }
                if (obj[key]['extension']) {
                    c[eName]['extension'] = [];
                    obj[key]['extension'].forEach((e) => {
