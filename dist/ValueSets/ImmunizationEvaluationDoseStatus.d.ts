 ...
 */
export declare const ImmunizationEvaluationDoseStatus: {
    /**
     * The dose does not count toward fulfilling a path to immunity for a patient.
     */
    immunization_evaluation_dose_status_NotValid: Coding;
    /**
     * The dose counts toward fulfilling a path to immunity for a patient, providing protection against the target disease.
     */
    immunization_evaluation_dose_status_Valid: Coding;
};
//# sourceMappingURL=ImmunizationEvaluationDoseStatus.d.ts.map