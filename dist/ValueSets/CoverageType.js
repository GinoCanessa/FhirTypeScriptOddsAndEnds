...
exports.CoverageType = {
     ...
     */
    v3_ActCode_CollisionCoveragePolicy: {
        code: "COL",
     ...
     */
    v3_ActCode_DisabilityInsurancePolicy: {
        code: "DIS",
     ...
     */
    v3_ActCode_DiseaseSpecificPolicy: {
        code: "DISEASE",
     ...
     */
    v3_ActCode_PublicHealthProgram: {
        code: "DISEASEPRG",
     ...
     */
    v3_ActCode_EmployeeAssistanceProgram: {
        code: "EAP",
     ...
     */
    v3_ActCode_FlexibleBenefitPlanPolicy: {
        code: "FLEXP",
     ...
     */
    v3_ActCode_GovernmentEmployeeHealthProgram: {
        code: "GOVEMP",
     ...
     */
    v3_ActCode_HighRiskPoolProgram: {
        code: "HIRISK",
     ...
     */
    v3_ActCode_IndigenousPeoplesHealthProgram: {
        code: "IND",
     ...
     */
    v3_ActCode_LifeInsurancePolicy: {
        code: "LIFE",
     ...
     */
    v3_ActCode_MandatoryHealthProgram: {
        code: "MANDPOL",
     ...
     */
    v3_ActCode_MentalHealthProgram: {
        code: "MENTPRG",
     ...
     */
    v3_ActCode_MilitaryHealthProgram: {
        code: "MILITARY",
     ...
     */
    v3_ActCode_PreferredProviderOrganizationPolicy: {
        code: "PPO",
     ...
     */
    v3_ActCode_SocialServiceProgram: {
        code: "SOCIAL",
     ...
     *                            Example: In the U.S., states receive funding for substance use programs from the Substance Abuse Mental Health Administration (SAMHSA).
     */
    v3_ActCode_SubstanceUseProgram: {
        code: "SUBPRG",
     ...
     */
    v3_ActCode_SubsidizedHealthProgram: {
        code: "SUBSIDIZ",
     ...
     */
    v3_ActCode_SubsidizedSupplementalHealthProgram: {
        code: "SUBSUPP",
     ...
     */
    v3_ActCode_SurplusLineInsurancePolicy: {
        code: "SURPL",
     ...
     */
    v3_ActCode_TermLifeInsurancePolicy: {
        code: "TLIFE",
     ...
     */
    v3_ActCode_UniversalLifeInsurancePolicy: {
        code: "ULIFE",
     ...
     */
    v3_ActCode_UninsuredMotoristPolicy: {
        code: "UNINSMOT",
     ...
     */
    v3_ActCode_VeteranHealthProgram: {
        code: "VET",
