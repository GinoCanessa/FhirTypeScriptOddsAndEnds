...
exports.V3ServiceDeliveryLocationRoleType = {
     ...
     */
    v3_RoleCode_DedicatedClinicalLocationRoleType: {
     ...
     */
    v3_RoleCode_DedicatedNonClinicalLocationRoleType: {
     ...
     */
    v3_RoleCode_DedicatedServiceDeliveryLocationRoleType: {
     ...
     */
    v3_RoleCode_BoneMarrowTransplantClinic: {
        code: "BMTC",
     ...
     */
    v3_RoleCode_ChildAndAdolescentNeurologyClinic: {
        code: "CANC",
     ...
     */
    v3_RoleCode_ChildAndAdolescentPsychiatryClinic: {
        code: "CAPC",
     ...
     */
    v3_RoleCode_CardiacCatheterizationLab: {
        code: "CATH",
     ...
     */
    v3_RoleCode_ChronicCareFacility: {
        code: "CHR",
     ...
     */
    v3_RoleCode_ColonAndRectalSurgeryClinic: {
        code: "CRS",
     ...
     */
    v3_RoleCode_CommunityServiceCenter: {
        code: "CSC",
     ...
     */
    v3_RoleCode_CardiovascularDiagnosticsOrTherapeuticsUnit: {
        code: "CVDX",
     ...
     */
    v3_RoleCode_DiagnosticsOrTherapeuticsUnit: {
        code: "DX",
     ...
     */
    v3_RoleCode_EchocardiographyLab: {
        code: "ECHO",
     ...
     */
    v3_RoleCode_EndocrinologyClinic: {
        code: "ENDO",
     ...
     */
    v3_RoleCode_OtorhinolaryngologyClinic: {
        code: "ENT",
     ...
     */
    v3_RoleCode_EmergencyTraumaUnit: {
        code: "ETU",
     ...
     */
    v3_RoleCode_FamilyMedicineClinic: {
        code: "FMC",
     ...
     * (X12N 282N00000N)
     */
    v3_RoleCode_HospitalsGeneralAcuteCareHospital: {
        code: "GACH",
     ...
     */
    v3_RoleCode_GastroenterologyClinic: {
        code: "GI",
     ...
     */
    v3_RoleCode_GeneralInternalMedicineClinic: {
        code: "GIM",
     ...
     */
    v3_RoleCode_HospitalLaboratory: {
        code: "HLAB",
     ...
     */
    v3_RoleCode_SpecimenCollectionSite: {
        code: "HUSCS",
     ...
     */
    v3_RoleCode_ImpairmentEvaluationCenter: {
        code: "IEC",
     ...
     */
    v3_RoleCode_InfectiousDiseaseClinic: {
        code: "INFD",
     ...
     */
    v3_RoleCode_InpatientLaboratory: {
        code: "INLAB",
     ...
     */
    v3_RoleCode_MedicalGeneticsClinic: {
        code: "MGEN",
     ...
     */
    v3_RoleCode_NeurologyCriticalCareAndStrokeUnit: {
        code: "NCCS",
     ...
     * Outpatient facility
     */
    v3_RoleCode_OutpatientFacility: {
        code: "OF",
     ...
     */
    v3_RoleCode_OralAndMaxillofacialSurgeryClinic: {
        code: "OMS",
     ...
     */
    v3_RoleCode_MedicalOncologyClinic: {
        code: "ONCL",
     ...
     * Opthalmology clinic
     */
    v3_RoleCode_OpthalmologyClinic: {
        code: "OPH",
     ...
     */
    v3_RoleCode_OutpatientLaboratory: {
        code: "OUTLAB",
     ...
     */
    v3_RoleCode_OutpatientPharmacy: {
        code: "OUTPHARM",
     ...
     */
    v3_RoleCode_PediatricCardiologyClinic: {
        code: "PEDCARD",
     ...
     */
    v3_RoleCode_PediatricEndocrinologyClinic: {
        code: "PEDE",
     ...
     */
    v3_RoleCode_PediatricGastroenterologyClinic: {
        code: "PEDGI",
     ...
     */
    v3_RoleCode_PediatricHematologyClinic: {
        code: "PEDHEM",
     ...
     */
    v3_RoleCode_PediatricOncologyClinic: {
        code: "PEDHO",
     ...
     */
    v3_RoleCode_PediatricIntensiveCareUnit: {
        code: "PEDICU",
     ...
     */
    v3_RoleCode_PediatricInfectiousDiseaseClinic: {
        code: "PEDID",
     ...
     */
    v3_RoleCode_PediatricNephrologyClinic: {
        code: "PEDNEPH",
     ...
     */
    v3_RoleCode_PediatricNeonatalIntensiveCareUnit: {
        code: "PEDNICU",
     ...
     */
    v3_RoleCode_PediatricRheumatologyClinic: {
        code: "PEDRHEUM",
     ...
     * (X12N 273R00000N)
     */
    v3_RoleCode_PsychiatricHospitalUnit: {
        code: "PHU",
     ...
     */
    v3_RoleCode_PlasticSurgeryClinic: {
        code: "PLS",
     ...
     */
    v3_RoleCode_PainRehabilitationCenter: {
        code: "PRC",
     ...
     */
    v3_RoleCode_PreventiveMedicineClinic: {
        code: "PREV",
     ...
     */
    v3_RoleCode_ProviderQuoteSOffice: {
        code: "PROFF",
     ...
     */
    v3_RoleCode_ProsthodonticsClinic: {
        code: "PROS",
     ...
     */
    v3_RoleCode_PsychatricCareFacility: {
        code: "PSYCHF",
     ...
     */
    v3_RoleCode_PatientQuoteSResidence: {
        code: "PTRES",
     ...
     */
    v3_RoleCode_RadiologyDiagnosticsOrTherapeuticsUnit: {
        code: "RADDX",
     ...
     * (X12N 261QX0203N)
     */
    v3_RoleCode_RadiationOncologyUnit: {
        code: "RADO",
     ...
     * (X12N 283X00000N)
     */
    v3_RoleCode_RehabilitationHospital: {
        code: "RH",
     ...
     */
    v3_RoleCode_AddictionTreatmentCenter: {
        code: "RHAT",
     ...
     * Rheumatology clinic
     */
    v3_RoleCode_RheumatologyClinic: {
        code: "RHEUM",
     ...
     */
    v3_RoleCode_IntellectualImpairmentCenter: {
        code: "RHII",
     ...
     */
    v3_RoleCode_ParentsWithAdjustmentDifficultiesCenter: {
        code: "RHMAD",
     ...
     */
    v3_RoleCode_PhysicalImpairmentCenter: {
        code: "RHPI",
     ...
     */
    v3_RoleCode_PhysicalImpairmentHearingCenter: {
        code: "RHPIH",
     ...
     */
    v3_RoleCode_PhysicalImpairmentMotorSkillsCenter: {
        code: "RHPIMS",
     ...
     */
    v3_RoleCode_PhysicalImpairmentVisualSkillsCenter: {
        code: "RHPIVS",
     ...
     */
    v3_RoleCode_RehabilitationHospitalUnit: {
        code: "RHU",
     ...
     * Neuroradiology unit
     */
    v3_RoleCode_NeuroradiologyUnit: {
        code: "RNEU",
     ...
     */
    v3_RoleCode_ResidentialTreatmentFacility: {
        code: "RTF",
     ...
     * (X12N 261QA1200N)
     */
    v3_RoleCode_SleepDisordersUnit: {
        code: "SLEEP",
     ...
     * (X12N 314000000N)
     */
    v3_RoleCode_SkilledNursingFacility: {
        code: "SNF",
     ...
     */
    v3_RoleCode_SportsMedicineClinic: {
        code: "SPMED",
     ...
     * (X12N 324500000N)
     */
    v3_RoleCode_SubstanceUseRehabilitationFacility: {
        code: "SURF",
     ...
     */
    v3_RoleCode_TravelAndGeographicMedicineClinic: {
        code: "TRAVEL",
     ...
     */
    v3_RoleCode_UnderageProtectionCenter: {
        code: "UPC",
