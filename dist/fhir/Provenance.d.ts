...
import { ProvenanceEntityRoleValueSetType } from '../fhirValueSets/ProvenanceEntityRoleValueSet.js';
import { ProvenanceEntityRoleValueSetEnum } from '../valueSetEnums.js';
...
export declare class Provenance extends fhir.DomainResource {
     ...
     */
    occurred?: (fhir.Period | fhir.FhirDateTime) | undefined;
    readonly __occurredIsChoice: true;
    /**
     * This can be a little different from the time stamp on the resource if there is a delay between recording the event and updating the provenance and target resource.
     */
