...
import { DoseRateTypeValueSetType } from '../fhirValueSets/DoseRateTypeValueSet.js';
 ...
 * The amount of medication administered.
 */
export declare class DosageDoseAndRate extends fhir.FhirElement implements IDosageDoseAndRate {
    /**
     * The kind of dose or rate specified, for example, ordered or calculated.
     */
 ...
 * Indicates how the medication is/was taken or should be taken by the patient.
 */
export declare class Dosage extends fhir.BackboneElement implements IDosage {
    /**
     * Indicates the order in which the dosage instructions should be applied or interpreted.
     */
    sequence?: number | undefined;
