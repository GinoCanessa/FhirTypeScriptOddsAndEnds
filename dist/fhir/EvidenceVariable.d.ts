 ...
 * Characteristics can be defined flexibly to accommodate different use cases for membership criteria, ranging from simple codes, all the way to using an expression language to express the criteria.
 */
export declare class EvidenceVariableCharacteristic extends fhir.BackboneElement implements fhir.IEvidenceVariableCharacteristic {
    /**
     * Define members of the evidence element using Codes (such as condition, medication, or observation), Expressions ( using an expression language such as FHIRPath or CQL) or DataRequirements (such as Diabetes diagnosis onset in the last year).
     */
 ...
 * The EvidenceVariable resource describes a "PICO" element that knowledge (evidence, assertion, recommendation) is about.
 */
export declare class EvidenceVariable extends fhir.DomainResource implements fhir.IEvidenceVariable {
    /**
     * Resource Type Name
     */
    resourceType: "EvidenceVariable";
