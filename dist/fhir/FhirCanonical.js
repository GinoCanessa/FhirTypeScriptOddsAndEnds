...
export class FhirCanonical extends fhir.FhirPrimitive {
    ...
    */
    ...
    doModelValidation() {
        ...
        if ((this.value) && (!FhirCanonical.__regex.test(this.value))) {
            outcome.issue.push(new fhir.OperationOutcomeIssue({ severity: IssueSeverityValueSetEnum.Error, code: IssueTypeValueSetEnum.InvalidContent, diagnostics: "Invalid value in primitive type canonical", }));
        }
        return outcome;
    }
    /**
