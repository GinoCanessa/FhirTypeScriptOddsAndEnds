...
export class FhirMarkdown extends fhir.FhirPrimitive {
    ...
    */
    ...
    doModelValidation() {
        ...
        if ((this.value) && (!FhirMarkdown.__regex.test(this.value))) {
            outcome.issue.push(new fhir.OperationOutcomeIssue({ severity: IssueSeverityValueSetEnum.Error, code: IssueTypeValueSetEnum.InvalidContent, diagnostics: "Invalid value in primitive type markdown", }));
        }
        return outcome;
    }
    /**
