...
export class FhirDate extends fhir.FhirPrimitive {
    ...
    */
    ...
    doModelValidation() {
        ...
        if ((this.value) && (!FhirDate.__regex.test(this.value))) {
            outcome.issue.push(new fhir.OperationOutcomeIssue({ severity: IssueSeverityValueSetEnum.Error, code: IssueTypeValueSetEnum.InvalidContent, diagnostics: "Invalid value in primitive type date", }));
        }
        return outcome;
    }
    /**
...
FhirDate.__regex = /^([0-9]([0-9]([0-9][1-9]|[1-9]0)|[1-9]00)|[1-9]000)(-(0[1-9]|1[0-2])(-(0[1-9]|[1-2][0-9]|3[0-1]))?)?$/;
//# sourceMappingURL=FhirDate.js.map