...
import { GuidanceResponseStatusValueSetType } from '../fhirValueSets/GuidanceResponseStatusValueSet.js';
import { GuidanceResponseStatusValueSetEnum } from '../valueSetEnums.js';
/**
...
export declare class GuidanceResponse extends fhir.DomainResource {
    ...
    readonly __moduleIsChoice: true;
    /**
     * This element is labeled as a modifier because the status contains codes that mark the resource as not currently valid.
     */
    status: GuidanceResponseStatusValueSetEnum | null;
